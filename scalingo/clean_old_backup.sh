...
# One per week between 1 and 6 months
files_between_6_and_1_months=$(find "$absolute_path_to_backup_directory"/* -type f -ctime -180 -ctime +30)

IFS='
' read -d '' -a files <<< "${files_between_6_and_1_months}"
