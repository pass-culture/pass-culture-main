...
def check_get_venues_params(param: {}) -> []:
    ...
    if param.get('has_validated_offerer', None):
       ...
       # _check_if_bool(param['has_validated_offerer'])
    ...
    if param.get('is_validated', None):
        ...
        # _check_if_bool(param['is_validated'])
...
# def _check_is_virtual_param(is_virtual: str) -> bool:
#     valid_param = ['YES', 'NO']
#     for elem in valid_param:
#         if is_virtual == elem:
#             return True
#     api_errors = ApiErrors()
#     api_errors.addError('is_virtual', 'is_virtual accepte YES ou NO')
#     raise api_errors
...
# def _check_if_bool(param) -> bool:
#     if type(param) == bool:
#        return True
#     api_errors = ApiErrors()
#     api_errors.addError(param.key(), param.key() + 'is a boolean, it accepts True or False')
#     raise api_errors