...
def upgrade():
    ...
    op.add_column('booking', sa.Column('amount', sa.Numeric(precision=10, scale=2), nullable=True))
    ...
    op.execute('UPDATE booking b SET "amount" = (SELECT o.price FROM offer o WHERE b."offerId" = o."id")')
    ...
    op.alter_column('booking', 'amount', existing_type=sa.Numeric(precision=10, scale=2), nullable=False)
...
def downgrade():
    ...
    op.drop_constraint('recommendation_occasionId_fkey', 'recommendation', type_='foreignkey')
    ...
    op.drop_constraint('mediation_occasionId_fkey', 'mediation', type_='foreignkey')
    ...
    op.drop_constraint('event_occurence_occasionId_fkey', 'event_occurence', type_='foreignkey')
