...
def upgrade():
    ...
    op.drop_constraint('venue_provider_price_rule_venueProviderId_fkey',
                       'venue_provider_price_rule')
    op.alter_column('venue_provider_price_rule', 'venueProviderId',
                    new_column_name='allocineVenueProviderId')
    ...
    op.create_foreign_key('allocine_venue_provider_price_rule_allocineVenueProviderId_fkey',
                          'allocine_venue_provider_price_rule', 'allocine_venue_provider',
                          ['allocineVenueProviderId'], ['id'])


def downgrade():
    op.drop_constraint('allocine_venue_provider_price_rule_allocineVenueProviderId_fkey',
                       'allocine_venue_provider_price_rule')
