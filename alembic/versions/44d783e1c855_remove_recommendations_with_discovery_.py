"""remove_recommendations_with_discovery_view_feature_flipping
...
def upgrade():
    new_values = ('WEBAPP_SIGNUP', 'DEGRESSIVE_REIMBURSEMENT_RATE', 'QR_CODE',
                  ...
                  'RECOMMENDATIONS_WITH_DIGITAL_FIRST', 'RECOMMENDATIONS_WITH_GEOLOCATION',
                  'NEW_RIBS_UPLOAD', 'SAVE_SEEN_OFFERS', 'BOOKINGS_V2')
