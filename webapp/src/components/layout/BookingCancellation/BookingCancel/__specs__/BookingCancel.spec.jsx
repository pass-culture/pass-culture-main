...
describe('src | components | layout | BookingCancellation | BookingCancel', () => {
  ...
  describe('when the wallet is still valid', () => {
  ...
  describe('when the wallet is now invalid', () => {
    it('should render BookingCancel component using informations from props', () => {
      // given
      props.isWalletValid = false
      ...
      expect(spans.at(0).text()).toBe('Tu vas recevoir un e-mail de confirmation.')
    })
  })
