...
def send_payment_details_email(csv_attachment: str, recipients: List[str], send_create_email):
...
def send_wallet_balances_email(csv_attachment: str, recipients: List[str], send_create_email):
