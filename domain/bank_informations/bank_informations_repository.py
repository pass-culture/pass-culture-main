...
class BankInformationsRepository(ABC):
    @abstractmethod
    def find_by_offerer(self, offerer_id: int) -> BankInformations:
        pass

    @abstractmethod
    def find_by_venue(self, venue_id: int) -> BankInformations:
        pass

    @abstractmethod
    def get_by_application(self, application_id: int) -> BankInformations:
        pass
