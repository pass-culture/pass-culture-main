...
class BulkImportUsersDataTest:
    def setup_method(self):
        ...
        self.expected_header = "BOOKED_OFFER_CATEGORIES;BOOKED_OFFER_SUBCATEGORIES;BOOKING_COUNT;CREDIT;DATE_CREATED;DATE_OF_BIRTH;DEPARTMENT_CODE;DEPOSIT_ACTIVATION_DATE;DEPOSIT_EXPIRATION_DATE;FIRSTNAME;HAS_COMPLETED_ID_CHECK;INITIAL_CREDIT;IS_BENEFICIARY;IS_ELIGIBLE;IS_EMAIL_VALIDATED;IS_PRO;LASTNAME;LAST_BOOKING_DATE;LAST_FAVORITE_CREATION_DATE;LAST_VISIT_DATE;MARKETING_EMAIL_SUBSCRIPTION;POSTAL_CODE;USER_ID;EMAIL"
        self.eren_expected_file_body = "CINEMA,LIVRE;ABO_LIVRE_NUMERIQUE,CARTE_CINE_ILLIMITE,CINE_PLEIN_AIR;4;480.00;06-02-2021;06-05-2003;12;;;First name;Yes;500;Yes;Yes;Yes;No;Last name;06-05-2021;;;Yes;;1;eren.yeager@shinganshina.paradis"
        self.mikasa_expected_file_body = "CINEMA,LIVRE;ABO_LIVRE_NUMERIQUE,CARTE_CINE_ILLIMITE,CINE_PLEIN_AIR;4;480.00;06-02-2021;06-05-2003;12;;;First name;Yes;500;Yes;Yes;Yes;Yes;Last name;06-05-2021;;;Yes;;2;mikasa.ackerman@shinganshina.paradis"
        self.armin_expected_file_body = "CINEMA,LIVRE;ABO_LIVRE_NUMERIQUE,CARTE_CINE_ILLIMITE,CINE_PLEIN_AIR;4;480.00;06-02-2021;06-05-2003;12;;;First name;Yes;500;Yes;Yes;Yes;No;Last name;06-05-2021;;;Yes;;3;armin.arlert@shinganshina.paradis"
