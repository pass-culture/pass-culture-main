...
class GetApplicationBearerTokenTest:
    @patch("pcapi.settings.SCALINGO_APP_TOKEN", "token123")
    ...
    def test_should_call_scalingo_auth_url_with_application_token(self, mock_post):
        ...
        # Then
        mock_post.assert_called_once_with("https://auth.scalingo.com/v1/tokens/exchange", auth=(None, "token123"))
...
class RunProcessInOneOffContainerTest:
    ...
    def test_should_call_scalingo_api_with_expected_payload(self, mock_get_app_token, mock_post):
        ...
        mock_post.assert_called_once_with(
            "https://api.osc-fr1.scalingo.com/v1/apps/pass-culture-api-app/run",
            json={"command": "command_line", "region": "osc-fr1", "detached": True, "size": "L"},
