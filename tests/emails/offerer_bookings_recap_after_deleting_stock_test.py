...
class RetrieveOffererBookingsRecapEmailDataAfterOffererCancellationTest:
    @patch(
        "pcapi.emails.offerer_bookings_recap_after_deleting_stock.feature_send_mail_to_users_enabled",
        return_value=False,
    )
    def test_should_send_mail_to_pass_culture_dev_when_feature_send_mail_to_users_is_disabled(
    ...
    @patch(
        "pcapi.emails.offerer_bookings_recap_after_deleting_stock.feature_send_mail_to_users_enabled", return_value=True
    )
    ...
    @patch(
        "pcapi.emails.offerer_bookings_recap_after_deleting_stock.format_environment_for_email", return_value="-testing"
    )
    @patch(
        "pcapi.emails.offerer_bookings_recap_after_deleting_stock.build_pc_pro_offer_link",
        return_value="http://pc_pro.com/offer_link",
