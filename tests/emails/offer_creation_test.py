...
class MakeOfferCreationNotificationEmailTest:
    ...
    def setup_class(cls):
        ...
        cls.virtual_offer = create_offer_with_thing_product(
            virtual_venue, thing_type=ThingType.JEUX_VIDEO, thing_name="Les lapins crétins", idx=2
        )
        cls.physical_offer = create_offer_with_thing_product(
            pysical_venue, thing_type=ThingType.AUDIOVISUEL, thing_name="Le vent se lève", idx=1
        )
