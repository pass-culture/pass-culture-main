...
def venue_demarche_simplifiee_application_detail_response_with_siret(siret: str,
                                                                     bic: Optional[str],
                                                                     iban: Optional[str],
                                                                     idx: int = 1,
                                                                     updated_at: str = "2020-01-21T18:55:03.387Z",
...
def venue_demarche_simplifiee_application_detail_response_without_siret(siret: str,
                                                                        bic: Optional[str],
                                                                        iban: Optional[str],
                                                                        idx: int = 1,
                                                                        updated_at: str = "2020-01-21T18:55:03.387Z",
