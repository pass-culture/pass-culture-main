...
class PcUpdateRecommendationsViewTest:
    ...
    def test_should_call_refresh_view_when_recommendation_with_geolocation_is_not_active(
        self, mock_discovery_refresh, mock_feature, app
    ):
        # Given
    ...
    @patch("pcapi.scheduled_tasks.clock.feature_queries.is_active")
    @patch("pcapi.scheduled_tasks.clock.discovery_view_queries.refresh")
    def test_should_not_call_refresh_view_when_recommendation_with_geolocation_is_active(
        self, mock_discovery_refresh, mock_feature, app
    ):
        # Given
...
class PcCleanDiscoveryViewsTest:
    ...
    def test_should_call_discovery_view_v3_clean_when_feature_is_active(
        self, mock_discovery_v3_clean, mock_discovery_clean, mock_feature, app
    ):
        # Given
        mock_feature.side_effect = [True, True]
    ...
    @patch("pcapi.scheduled_tasks.clock.discovery_view_queries.clean")
    @patch("pcapi.scheduled_tasks.clock.discovery_view_v3_queries.clean")
    def test_should_call_discovery_view_v1_clean_when_geoloc_feature_is_not_active(
        self, mock_discovery_v3_clean, mock_discovery_clean, mock_feature, app
    ):
        # Given
        mock_feature.side_effect = [True, False]
