...
class StockProviderTiteLiveRepositoryTest:
    ...
    def should_call_provider_api_stocks_with_expected_arguments(self):
        # When
        self.stock_provider_titelive_repository.stocks_information(
            siret="12345678912345", last_processed_reference="9782070584628", modified_since=datetime(2019, 10, 1)
        )

        # Then
        self.stock_provider_titelive_repository.titelive_api.stocks.assert_called_once_with(
    ...
    def should_call_provider_api_siret_with_expected_siret(self):
        ...
        # Then
        self.stock_provider_titelive_repository.titelive_api.is_siret_registered.assert_called_once_with(
