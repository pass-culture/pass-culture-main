...
class StockProviderFnacRepositoryTest:
    ...
    def should_instanciate_provider_api_with_correct_params(self):
        ...
        # Then
        assert (
            self.stock_provider_fnac_repository.fnac_api.api_url
            == "https://passculture-fr.ws.fnac.com/api/v1/pass-culture/stocks"
        )
    ...
    def should_call_provider_api_stocks_with_expected_arguments(self):
        # When
        self.stock_provider_fnac_repository.stocks_information(
            siret="12345678912345", last_processed_reference="9782070584628", modified_since=datetime(2019, 10, 1)
        )

        # Then
        self.stock_provider_fnac_repository.fnac_api.stocks.assert_called_once_with(
