...
class GetByProIdentifierTest:
    def setup_method(self) -> None:
        self.venue_sql_repository = VenueWithOffererInformationsSQLRepository()
    ...
    def test_returns_all_venues_of_pro_user(self, app: object) -> None:
        ...
        expected_venue_1 = venue_with_offerer_informations_domain_converter.to_domain(venue_1)
        expected_venue_2 = venue_with_offerer_informations_domain_converter.to_domain(venue_2)
        ...
        assert isinstance(found_venues[0], VenueWithOffererInformations)
    ...
    def test_does_not_return_venues_of_non_validated_offerer(self, app: object) -> None:
        ...
        expected_venue = venue_with_offerer_informations_domain_converter.to_domain(venue_of_validated_offerer)
