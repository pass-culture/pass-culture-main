...
def test_get_offers_for_recommendations_search_only_return_available_offers(app):
    ...
    stock_available = create_stock(quantity=5, offer=offer_available, price=12)
    ...
    stock_with_no_available = create_stock_from_event_occurrence(event_occurrence, quantity=0)
    stock_with_one_available = create_stock_from_event_occurrence(event_occurrence, price=0, quantity=1)
    user = create_user()
