...
from repository.dashboard_queries import get_beneficiary_users_details, get_experimentation_sessions, \
    ...
    get_user_date_of_first_bookings, get_date_of_second_bookings, get_date_of_bookings_on_third_product_type, \
    get_last_recommendation_dates, \
    get_number_of_bookings, get_number_of_non_cancelled_bookings, get_first_stock_creation_dates, \
    get_offerer_first_booking_creation_dates, get_offerer_creation_dates, get_number_of_offers, \
...
from tests.test_utils import create_user, create_offerer, create_venue, create_offer_with_thing_product, create_stock, \
    create_booking, create_recommendation, save_all_activities, create_stock_activity
...
class GetDateOfFirstBookingsTest:
    ...
    def test_should_return_the_creation_date_of_the_user_s_first_booking(self, app):
        ...
        # When
        first_booking_dates = get_user_date_of_first_bookings(connection)
...
class GetOffererCreationDatesTest:
    ...
    def test_should_return_offerer_s_creation_date(self, app):
        ...
        # When
        creation_dates = get_offerer_creation_dates(connection)
...
class GetFirstBookingCreationDatesTest:
    ...
    def test_should_return_the_creation_date_of_the_offer_s_first_booking(self, app):
        ...
        # When
        first_booking_dates = get_offerer_first_booking_creation_dates(connection)
