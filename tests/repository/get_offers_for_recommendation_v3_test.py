        ...
        class FiltersTest:
            ...
            def test_filter_should_not_return_activation_thing(self, app):
                ...
                venue_93 = create_venue(
                    offerer, postal_code="93000", departement_code="93", siret=offerer.siren + "33333"
                )
            ...
            def test_filter_should_return_offers_with_stock(self, app):
                ...
                user = create_user()
                venue = create_venue(
                    offerer, postal_code="34000", departement_code="34", longitude=2.295695, latitude=49.894171
                )
        ...
        class WhenUserIsGeolocatedTest:
            ...
            def test_filter_should_return_offer_when_offer_is_national(self, app):
                ...
                offers = get_offers_for_recommendation_v3(
                    user=user, user_iris_id=user_location_iris.id, user_is_geolocated=True
                )
            ...
            def test_filter_should_return_only_national_offers_when_user_is_geolocated_abroad(self, app):
                ...
                digital_offer = create_offer_with_thing_product(
                    virtual_venue, thing_type=ThingType.MUSIQUE, url="https://url.com", is_national=True
                )
