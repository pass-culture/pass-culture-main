...
from repository.iris_venues_queries import find_iris_located_near_venue, insert_venue_in_iris_venues
...
class FindIrisLocatedNearVenueTest:
    @clean_database
    def test_should_return_ids_list_of_iris_located_near_to_given_venue(self, app):
        ...
        # when
        iris_id = find_iris_located_near_venue(venue_in_paris.id)
