from pcapi.domain.types import get_formatted_active_product_types, get_active_product_type_values_from_sublabels
...
class GetFormattedEventOrThingTypesTest:
    ...
    def test_does_not_return_inactive_product_types(self):
        ...
        # then
        assert jeux not in types, 'Les offres avec le type "ThingType.JEUX" ne peuvent plus être créées pour être en phase avec les CGU'
