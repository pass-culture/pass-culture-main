...
class ExpensesTest:
    ...
    class ThingsTest:
        class AudiovisuelTest:
            ...
            def test_offline_offer_increase_physical_expense(self):
                # Given
                bookings = [create_booking_for_thing(amount=50, url=None, product_type=ThingType.AUDIOVISUEL)]
        ...
        class MusiqueTest:
            def test_online_offer_increase_digital_expense(self):
                # Given
                bookings = [create_booking_for_thing(amount=50, url="http://on.line", product_type=ThingType.MUSIQUE)]
            ...
            def test_offline_offer_increase_physical_expense(self):
                # Given
                bookings = [create_booking_for_thing(amount=50, url=None, product_type=ThingType.MUSIQUE)]
        ...
        class OeuvreArtTest:
            def test_offline_offer_increase_physical_expense(self):
                # Given
                bookings = [create_booking_for_thing(amount=50, product_type=ThingType.OEUVRE_ART)]
        ...
        class LivreEditionTest:
            ...
            def test_offline_offer_increase_physical_expense(self):
                # Given
                bookings = [create_booking_for_thing(amount=50, url=None, product_type=ThingType.LIVRE_EDITION)]
        ...
        class JeuxTest:
            def test_offline_offer_increase_physical_expense(self):
                # Given
                bookings = [create_booking_for_thing(amount=50, url=None, product_type=ThingType.JEUX)]
        ...
        class MusiqueAboTest:
            def test_offline_offer_increase_total_expense(self):
                # Given
                bookings = [create_booking_for_thing(amount=50, url=None, product_type=ThingType.MUSIQUE_ABO)]
        ...
        class MuseesPatrimoineAboTest:
            def test_offline_offer_increase_total_expense(self):
                # Given
                bookings = [create_booking_for_thing(amount=50, url=None, product_type=ThingType.MUSEES_PATRIMOINE_ABO)]
        ...
        class CinemaAboTest:
            def test_offline_offer_increase_total_expense(self):
                # Given
                bookings = [create_booking_for_thing(amount=50, url=None, product_type=ThingType.CINEMA_ABO)]
        ...
        class InstrumentTest:
            def test_offline_offer_increase_physical_expense(self):
                # Given
                bookings = [create_booking_for_thing(amount=50, url=None, product_type=ThingType.INSTRUMENT)]
        ...
        class SpectacleVivantAboTest:
            def test_offline_offer_increase_total_expense(self):
                # Given
                bookings = [create_booking_for_thing(amount=50, url=None, product_type=ThingType.SPECTACLE_VIVANT_ABO)]
    ...
    class EventsTest:
        class CinemaTest:
            def test_offline_offer_increase_total_expense(self):
                # Given
                bookings = [create_booking_for_event(amount=50, type=EventType.CINEMA)]
        ...
        class ConferenceDebatDedicaceTest:
            def test_offline_offer_increase_total_expense(self):
                # Given
                bookings = [create_booking_for_event(amount=50, type=EventType.CONFERENCE_DEBAT_DEDICACE)]
        ...
        class JeuxTest:
            def test_offline_offer_increase_total_expense(self):
                # Given
                bookings = [create_booking_for_event(amount=50, type=EventType.JEUX)]
        ...
        class MusiqueTest:
            def test_offline_offer_increase_total_expense(self):
                # Given
                bookings = [create_booking_for_event(amount=50, type=EventType.MUSIQUE)]
        ...
        class MuseesPatrimoineTest:
            def test_offline_offer_increase_total_expense(self):
                # Given
                bookings = [create_booking_for_event(amount=50, type=EventType.MUSEES_PATRIMOINE)]
        ...
        class PratiqueArtistiqueTest:
            def test_offline_offer_increase_total_expense(self):
                # Given
                bookings = [create_booking_for_event(amount=50, type=EventType.PRATIQUE_ARTISTIQUE)]
        ...
        class SpectacleVivantTest:
            def test_offline_offer_increase_total_expense(self):
                # Given
                bookings = [create_booking_for_event(amount=50, type=EventType.SPECTACLE_VIVANT)]
    ...
    class ComputationTest:
        ...
        class PhysicalCapTest:
            def test_max_200_and_actual_50(self):
                ...
                digital_cap_booking = create_booking_for_thing(
                    url="http://test.com", amount=60, product_type=ThingType.AUDIOVISUEL
                )
        ...
        class DigitalCapTest:
            def test_returns_max_200_and_actual_110(self):
                ...
                digital_cap_booking = create_booking_for_thing(
                    url="http://test.com", amount=110, product_type=ThingType.MUSIQUE
                )
