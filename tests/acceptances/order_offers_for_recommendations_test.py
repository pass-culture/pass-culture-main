...
def test_return_ordered_offers_by_digital_and_score_and_dateSeen_criterias_when_feature_is_active(
        mock_feature_save_seen_offers_enabled,
        app):
    # Given
    offerer = create_offerer()
...
@clean_database
def test_updating_offers_order_should_change_order_in_materialized_view(app):
    # Given
    offerer = create_offerer()
    user = create_user()
    venue = create_venue(offerer, postal_code='34000',
