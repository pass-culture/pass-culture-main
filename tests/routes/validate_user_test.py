...
class Patch:
    class Returns204:
        ...
        @pytest.mark.usefixtures("db_session")
        @patch("pcapi.routes.validate.send_ongoing_offerer_attachment_information_email_to_pro", return_value=True)
        ...
        @pytest.mark.usefixtures("db_session")
        @patch("pcapi.routes.validate.send_pro_user_waiting_for_validation_by_admin_email", return_value=True)
        @patch("pcapi.routes.validate.send_raw_email", return_value=True)
        ...
        @patch("pcapi.routes.validate.maybe_send_offerer_validation_email", return_value=True)
        @patch("pcapi.routes.validate.send_raw_email", return_value=True)
