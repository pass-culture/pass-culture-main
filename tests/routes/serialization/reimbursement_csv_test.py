...
class FindReimbursementDetailsTest:
    ...
    def test_find_all_offerer_reimbursement_details(self, app):
        ...
        bank_information1 = create_bank_information(id_at_providers='79387501900056', venue=venue1, application_id=1)
        bank_information2 = create_bank_information(id_at_providers='79387501900057', venue=venue2, application_id=2)
