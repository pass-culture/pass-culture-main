    ...
    class Returns200:
        ...
        def when_offers_have_soft_deleted_stocks(self, app):
            ...
            response = TestClient(app.test_client()).with_auth(user.email) \
                .put(f'{RECOMMENDATION_URL_V3}?longitude={user_longitude}&latitude={user_latitude}', json={})
        ...
        def when_offers_have_no_stocks(self, app):
            ...
            # when
            response = auth_request.put(f'{RECOMMENDATION_URL_V3}?longitude={user_longitude}&latitude={user_latitude}', json={'seenRecommendationIds': []})
        ...
        def test_discovery_recommendations_should_not_include_search_recommendations(self, app):
            ...
            # When
            recommendations_req = auth_request.put(f'{RECOMMENDATION_URL_V3}?longitude={user_longitude}&latitude={user_latitude}&page=1',
                                                   json={})
        ...
        def when_user_has_already_seen_recommendation(self, app):
            ...
            # when
            response = TestClient(app.test_client()).with_auth(user.email) \
                .put(f'{RECOMMENDATION_URL_V3}?longitude={user_longitude}&latitude={user_latitude}', json={'seenRecommendationIds': [humanize(recommendation.id)]})
        ...
        def test_returns_stocks_with_isBookable_property(self, app):
            ...
            # When
            recommendations_req = auth_request.put(f'{RECOMMENDATION_URL_V3}?longitude={user_longitude}&latitude={user_latitude}', json={})
