...
class TiteliveThingsTest:
    @clean_database
    @patch('local_providers.titelive.titelive_things.get_files_to_process_from_titelive_ftp')
    @patch('local_providers.titelive.titelive_things.get_lines_from_thing_file')
