...
def test_find_all_by_offerer_with_event_and_things(app):
    ...
    stock2 = create_stock_with_thing_offer(offerer1, venue1, product=None, price=300)
    stock3 = create_stock_with_thing_offer(offerer2, venue2, product=None, price=400)
...
def test_find_all_bookings_for_stock(app):
    ...
    venue = create_venue(offerer)
    stock_to_search = create_stock_with_thing_offer(offerer, venue, product=None, price=0)
    stock_not_to_search = create_stock_with_thing_offer(offerer, venue, product=None, price=0)
