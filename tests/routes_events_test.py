...
def test_unknown_properties_in_post_event_can_be_found_later_in_get(app):
    # Given
    ...
    create_response = req_with_auth(email='user@test.com', password='azerty123')\
                        .post(API_URL + '/events',
                              json= { 'type': "EventType.CINEMA",
                                      'name': "My event",
                                      'description': "Ze event that rocks",
                                      'durationMinutes': 122,
