...
class WriteDashboardWorksheetTest:
    ...
    def test_initializes_worksheet_within_given_spreadsheet(
        self, initialize_worksheet, write_usage_section, write_diversification_section, write_finance_section
    ):
        # Given
    ...
    @patch("pcapi.scripts.dashboard.write_dashboard._write_usage_section")
    @patch("pcapi.scripts.dashboard.write_dashboard._initialize_worksheet")
    def test_writes_worksheet_title(
        self, initialize_worksheet, write_usage_section, write_diversification_section, write_finance_section
    ):
        # Given
        worksheet = MagicMock()
    ...
    @patch("pcapi.scripts.dashboard.write_dashboard._write_usage_section")
    @patch("pcapi.scripts.dashboard.write_dashboard._initialize_worksheet")
    def test_writes_usage_section_for_departement_starting_on_line_4(
        self, initialize_worksheet, write_usage_section, write_diversification_section, write_finance_section
    ):
        # Given
        worksheet = MagicMock()
    ...
    @patch("pcapi.scripts.dashboard.write_dashboard._write_usage_section")
    @patch("pcapi.scripts.dashboard.write_dashboard._initialize_worksheet")
    def test_writes_diversification_section_for_departement_starting_on_line_5(
        self, initialize_worksheet, write_usage_section, write_diversification_section, write_finance_section
    ):
        # Given
        worksheet = MagicMock()
    ...
    @patch("pcapi.scripts.dashboard.write_dashboard._write_usage_section")
    @patch("pcapi.scripts.dashboard.write_dashboard._initialize_worksheet")
    def test_writes_finance_section_for_departement_starting_on_line_6(
        self, initialize_worksheet, write_usage_section, write_diversification_section, write_finance_section
    ):
        # Given
        worksheet = MagicMock()
