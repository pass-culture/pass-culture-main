...
from pcapi.scripts.clean_activity import populate_cultural_survey_filled_date_from_activity
from pcapi.scripts.clean_activity import populate_stock_date_created_from_activity
