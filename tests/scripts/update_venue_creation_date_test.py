...
class UpdateVenueCreationDateTest:
    ...
    def test_should_update_venue_creation_date_whith_date_from_read_file_when_id_match(
        self, stub_read_venue_date_creation_from_file, mock_logger_info, app
    ):
        # Given
        ...
        stub_read_venue_date_creation_from_file.return_value = [("121", "2018-12-17 11:22:26.690575")]
    ...
    @patch("pcapi.scripts.update_venue_creation_date._read_venue_creation_date_from_file")
    @pytest.mark.usefixtures("db_session")
    def test_should_not_be_stuck_because_of_unexpected_errors_and_print_a_list_of_errored_venues(
        self, stub_read_venue_date_creation_from_file, mock_logger_info, app
    ):
        # Given
