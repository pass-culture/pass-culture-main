...
class GetBookingsCancelledDuringQuarantineWithPaymentTest:
    @clean_database
    def test_should_return_cancelled_booking_with_validated_payment(self, app):
        # Given
    ...
    @clean_database
    def test_should_not_return_non_cancelled_booking_with_validated_payment(self, app):
        # Given
        beneficiary = create_user()
        create_deposit(user=beneficiary)
        offerer = create_offerer()
