...
class GetAllBookingsByProUserTest:
    @patch('pcapi.use_cases.get_all_bookings_by_pro_user.check_is_authorized_to_access_bookings_recap')
    @patch('pcapi.use_cases.get_all_bookings_by_pro_user.user_queries.find_user_by_id')
    @patch('pcapi.use_cases.get_all_bookings_by_pro_user.booking_queries.find_by_pro_user_id')
