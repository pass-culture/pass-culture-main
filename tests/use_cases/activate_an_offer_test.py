...
class ActivateAnOfferTest:
    @patch('pcapi.use_cases.activate_an_offer.repository.save')
    ...
    @patch('pcapi.use_cases.activate_an_offer.repository.save')
    @patch('pcapi.use_cases.activate_an_offer.feature_queries.is_active', return_value=True)
    @patch('pcapi.use_cases.activate_an_offer.redis.add_offer_id')
    ...
    @patch('pcapi.use_cases.activate_an_offer.repository.save')
    @patch('pcapi.use_cases.activate_an_offer.feature_queries.is_active', return_value=False)
    @patch('pcapi.use_cases.activate_an_offer.redis.add_offer_id')
