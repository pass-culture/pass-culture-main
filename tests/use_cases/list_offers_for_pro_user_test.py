...
from pcapi.use_cases.list_offers_for_pro_user import (
    ListOffersForProUser,
    OffersRequestParameters,
)
...
class OffersRequestParametersTest:
    def should_create_object_with_default_values(self):
        ...
        assert (
            offers_request_parameters.offers_per_page
            == OffersRequestParameters.DEFAULT_OFFERS_PER_PAGE
        )
...
class ListOffersForProUserTest:
    def setup_method(self):
        ...
        self.paginated_offers_repository.get_paginated_offers_for_offerer_venue_and_keywords = (
            MagicMock()
        )
