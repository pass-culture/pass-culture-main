...
class CheckDatesAreAllowedOnExistingStockTest:
    ...
    class OfferIsOnEventTest:
        def should_raise_error_with_none_beginning_datetime(self):
            ...
            # Then
            assert e.value.errors["beginningDatetime"] == ["Ce paramètre est obligatoire"]
        ...
        def should_raise_error_with_none_booking_limit_datetime(self):
            ...
            # Then
            assert e.value.errors["bookingLimitDatetime"] == ["Ce paramètre est obligatoire"]
...
class CheckStockIsUpdatableTest:
    ...
    def should_not_raise_an_error_when_event_is_not_expired(self, app):
        ...
        stock = create_stock_with_event_offer(
            offerer=offerer, venue=venue, beginning_datetime=in_three_days, booking_limit_datetime=in_three_days
        )
...
class GetOnlyFieldsWithValueToBeUpdatedTest:
    ...
    def when_new_stock_data_contains_all_fields(self):
        ...
        stock_data = {
            "available": None,
            "bookingLimitDatetime": "2020-02-08T12:30:00Z",
            "id": "AGXA",
            "offerId": "QY",
            "offererId": "A4",
            "price": 25,
