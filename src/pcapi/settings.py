...
DMS_ENROLLMENT_PROCEDURE_ID_v4_FR = ("DEMARCHES_SIMPLIFIEES_ENROLLMENT_PROCEDURE_ID_v4_FR", None)
DMS_ENROLLMENT_PROCEDURE_ID_v4_ET = ("DEMARCHES_SIMPLIFIEES_ENROLLMENT_PROCEDURE_ID_v4_ET", None)
