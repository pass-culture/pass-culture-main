...
DMS_ENROLLMENT_PROCEDURE_ID_v4_FR = int(os.environ.get("DEMARCHES_SIMPLIFIEES_ENROLLMENT_PROCEDURE_ID_v4_FR", None))
DMS_ENROLLMENT_PROCEDURE_ID_v4_ET = int(os.environ.get("DEMARCHES_SIMPLIFIEES_ENROLLMENT_PROCEDURE_ID_v4_ET", None))
