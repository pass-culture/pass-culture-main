...
CRON_INDEXING_VENUES_FREQUENCY = os.environ.get("CRON_INDEXING_VENUES_FREQUENCY", "10")

CRON_INDEXING_VENUES_IN_ERROR_FREQUENCY = os.environ.get("CRON_INDEXING_VENUES_IN_ERROR_FREQUENCY", "10")
...
CLOUD_TASK_RETRY_INITIAL_DELAY = os.environ.get("CLOUD_TASK_RETRY_INITIAL_DELAY", 1.0)
CLOUD_TASK_RETRY_MAXIMUM_DELAY = os.environ.get("CLOUD_TASK_RETRY_MAXIMUM_DELAY", 60.0)
CLOUD_TASK_RETRY_MULTIPLIER = os.environ.get("CLOUD_TASK_RETRY_MULTIPLIER", 2.0)
CLOUD_TASK_RETRY_DEADLINE = os.environ.get("CLOUD_TASK_RETRY_DEADLINE", 60.0 * 2.0)
