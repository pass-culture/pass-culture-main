...
class ProfilePasswordView extends React.PureComponent {
  constructor(props) {
    super(props)
  ...
  handleRequestSuccess = (state, action) => {
    ...
    this.setState(nextstate, () => history.goBack())
  }
  ...
  onFormReset = () => {
    ...
    if (shouldreset) this.onFormSubmit(this.initialValues)
    else history.goBack()
  }
                ...
                >
                  <div className="padded-2x flex-1">
                    <PasswordField
                      ...
                      label="Veuillez saisir votre ancien mot de passe"
                    />
                    <PasswordField
                      className="mb20"
                      name="newPassword"
                      ...
                      labelConfirm="Veuillez confirmer votre nouveau mot de passe"
                    />
                  </div>
                  <FormControls
                    canCancel
