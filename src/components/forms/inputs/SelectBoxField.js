...
class SelectBoxField extends React.PureComponent {
  ...
  renderOption = (object, identifier) => {
  ...
  renderOptionsGroup = (group, groupIndex) => {
      ...
      >
        {group.options &&
          group.options.map((obj, optionIndex) => {
            ...
            return this.renderOption(obj, identifier)
          })}
      </optgroup>
    )
  }
            ...
            >
              ...
              {provider &&
                provider.map((obj, index) => {
                  ...
                  const renderer = isgroup ? this.renderOptionsGroup : this.renderOption
