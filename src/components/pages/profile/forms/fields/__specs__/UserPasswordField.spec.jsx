...
describe('src | components | pages | profile | forms | fields | UserPasswordField', () => {
  ...
  it('should render three UserPasswordField components', () => {
    ...
    expect(passwordFields.at(0).prop('label')).toBe('Mot de passe actuel')
    ...
    expect(passwordFields.at(1).prop('label')).toBe('Nouveau mot de passe')
    ...
    expect(passwordFields.at(2).prop('label')).toBe('Confirmation nouveau mot de passe')
  })
