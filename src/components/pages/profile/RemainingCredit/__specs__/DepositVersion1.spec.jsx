...
describe('depositVersion1', () => {
  ...
  it('should display an empty account when no deposit', () => {
    ...
    // When
    const wrapper = mount(<DepositVersion1 {...props} />)
  ...
  describe('when the user is limited by digital and physical', () => {
    beforeEach(() => {
      props = {
        user: new User({
          deposit_version: 1,
    ...
    it('should fill the gauge with the right values', () => {
      // When
      const wrapper = shallow(<DepositVersion1 {...props} />)
