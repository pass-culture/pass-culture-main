...
import BookingsRecapTableLegacy from '../BookingsRecapTableLegacy'
...
describe('components | BookingsRecapTableLegacy', () => {
  it('should render a TableContainer component with columns and data props', () => {
    ...
    // When
    const wrapper = shallow(<BookingsRecapTableLegacy {...props} />)
  ...
  it('should render the expected table headers', () => {
    ...
    // When
    const wrapper = mount(<BookingsRecapTableLegacy {...props} />)
  ...
  it('should filter bookings on render', () => {
    ...
    // When
    shallow(<BookingsRecapTableLegacy {...props} />)
