...
const Header = ({ currentUser }) => (
  <div className="flex-columns is-relative py16 fs18" id="main-menu-header">
    <div className="column-profile text-center px18">
      <div id="main-menu-header-avatar">
        <img alt="" className="mb3" src="/icons/avatar-default-w-XL.svg" />
      </div>
      <div className="px5 is-hyphens" id="main-menu-header-username">
