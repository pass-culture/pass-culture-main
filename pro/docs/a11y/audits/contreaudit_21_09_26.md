...
P06 → Création offre individuelle (parcours 5) (7 étapes et confirmation)
...
- P06 → Création offre individuelle : Le titre du tableau de données à l'étape "Horaires et stocks"
- P09 → Les offres : Le titre du tableau des offres / réservations est “Tableau de données”
- P10 → Les réservations : Le titre du tableau des offres / réservations est “Tableau de données”
- P13 → Les offres réservables (collectif) : Le titre du tableau des offres / réservations est “Tableau de données”
...
P05 → Création offre réservable (5 étapes et confirmation)
P06 → Création offre réservable (5 étapes et confirmation)
...
- Dans le cas où une recherche présente un tableau vide, c'est le message "Aucune offre trouvée pour votre recherche" qui doit être le message de statut
...
**Tickets** : [PC-42990](https://passculture.atlassian.net/browse/PC-42990) & [PC-42989](https://passculture.atlassian.net/browse/PC-42989)  
**PRs** : [#23997](https://github.com/pass-culture/pass-culture-main/pull/23997) & [#23954](https://github.com/pass-culture/pass-culture-main/pull/23954)
...
- Les textes "Expire aujourd'hui", "Prévu le ...", "publiée", etc. du bloc "'Offres réservables".
- Le texte "Aucun compte bancaire configuré pour percevoir vos remboursements" du bloc "Remboursement"
...
- Le texte "Télécharger vos réservations dans l’onglet “Données d’activité” de votre Espace administration accessible en haut à droite."

P13 → Les offres réservables (collectif)

- Le texte "Télécharger vos offres réservables dans l’onglet “Données d’activité” de votre Espace administration accessible en haut à droite."
...
- Lors de la navigation, le lecteur d’écran annonce un regroupement (« groupe, 3 éléments ») au niveau de la structure globale de la page.

- Ce comportement est lié à la présence de conteneurs <div> génériques englobant les principales zones de la page (en-tête, contenu principal, pied de page), sans structuration ou rôle sémantique explicite.

**Correction** 💡

- Intégrer le lien dans un repère adapté, par exemple le <header> afin qu'il fasse partie de la structure de la page.

- Réduire les conteneurs <div> structurels non nécessaires autour des zones principales de la page.

- S’assurer que la structure repose uniquement sur les éléments sémantiques (<header>, <main>, <footer>) sans encapsulation supplémentaire non qualifiée.
...
- Lorsque l'on zoome à 200%, certains contenus ne sont plus totalement lisibles.
...
**Problème** 😱  
P04 → Inscription structure (3 étapes et validation)
P05 → Création offre réservable (5 étapes et confirmation)
P06 → Création offre individuelle (7 étapes et confirmation)
...
**PRs** : [#23860](https://github.com/pass-culture/pass-culture-main/pull/23860) & [#23908](https://github.com/pass-culture/pass-culture-main/pull/23908)
