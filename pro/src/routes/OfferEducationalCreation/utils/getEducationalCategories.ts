...
export const getEducationalCategories = (
  categories?: Category[],
  ...
  const subCategoriesGrouppedByCategoryId =
    groupSubCategoriesByCategoryId(subCategories)
...
export const getEducationalSubCategories = (
  subCategories?: SubCategory[]
): SubCategory[] => {
  if (!subCategories) {
    return []
