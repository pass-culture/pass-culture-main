...
describe('serializer', () => {
  ...
  it('serializeOfferApiImage', async () => {
    const offerApi = {
      mediations: [
        {
          thumbUrl: 'htt://image.url',
          credit: 'John Do',
    ...
    const imageSerialized: IOfferIndividualImage = {
      url: 'htt://image.url',
      credit: 'John Do',
    }

    expect(serializeOfferApiImage(offerApi)).toEqual(imageSerialized)
  })
  it('serializeOfferApiImage empty', async () => {
    const offerApi = {
      mediations: [],
    } as unknown as GetIndividualOfferResponseModel

    expect(serializeOfferApiImage(offerApi)).toEqual(undefined)
  })
