...
import { IndividualOfferExposure } from './IndividualOfferExposure'

vi.mock('./IndividualOfferExposureScreen', () => ({
  IndividualOfferExposureScreen: () => <div data-testid="exposure-screen" />,
}))
...
describe('<IndividualOfferLocation />', () => {
  ...
  it('should render the location screen within the offer layout when an offer is provided', () => {
    ...
    expect(screen.getByTestId('exposure-screen')).toBeInTheDocument()
  })
})
