...
describe('getValidationSchema', () => {
  ...
  describe('when isDigital is false', () => {
    ...
    it('should transform venueLocation to true when offerLocation is venue id', async () => {
      ...
      expect(result.location?.venueLocation).toBe(true)
    })

    it('should transform venueLocation to false when offerLocation is OTHER_ADDRESS', async () => {
      const values = buildWithAddress({
      ...
      expect(result.location?.venueLocation).toBe(false)
    })
  })
})
