...
import StatusEndedIcon from 'icons/ico-double-check.svg'
import StatusPreBookedIcon from 'icons/ico-hourglass.svg'
import StatusExpiredIcon from 'icons/ico-status-expired.svg'
import StatusInactiveIcon from 'icons/ico-status-inactive.svg'
import StatusPendingIcon from 'icons/ico-status-pending.svg'
import StatusRejectedIcon from 'icons/ico-status-rejected.svg'
