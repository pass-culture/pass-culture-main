...
export const validateCreatedStock = (stock, isEventOffer) => {
  let errors = {}
  ...
  if (stock.price > 300 && !isEventOffer) {
...
export const validateUpdatedStock = (stock, isEventOffer) => {
  let errors = validateCreatedStock(stock, isEventOffer)
