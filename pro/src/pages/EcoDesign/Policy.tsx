  ...
  return (
    <EcoDesignLayout mainHeading="Politique d'écoconception au pass Culture">
      ...
      <p className={styles['paragraph']}>
        ...
        de l'écoconception des services numériques (version 2024).
      </p>
      <p className={styles['paragraph']}>
      ...
      <ol>
        ...
        <li className={styles['list-item']}>
          Promouvoir une démarche de <strong>sobriété environnementale</strong>{' '}
          face aux stratégies de captation de l'attention de l'utilisateur pour
          des usages en ligne avec les objectifs environnementaux internationaux
          ;
        </li>
        <li className={styles['list-item']}>
          <strong>Diminuer les ressources</strong> informatiques mobilisées,
          optimiser le trafic de données et la sollicitation des infrastructures
          numériques ;
        </li>
      ...
      <p className={styles['paragraph']}>
        ...
        Dans ce cadre, la première démarche engagée sera de :
      </p>
      <ul>
        <li className={styles['list-item']}>
      ...
      <p className={styles['paragraph']}>
        En outre, l'hébergement étant un point crucial pour limiter l'impact du
        service, nous avons prévu de migrer nos data center en France
        hexagonale.
      </p>
      <p className={styles['paragraph']}>
      ...
      <ul>
        ...
        <li className={styles['list-item-spaced']}>
          Établir une feuille de route pluriannuelle d'améliorations techniques
          afin de réduire l'empreinte carbone et hydrique des parcours critiques
          de l’espace partenaire en se basant sur les mesures effectuées par
          l’EcoIndex
        </li>
      </ul>
