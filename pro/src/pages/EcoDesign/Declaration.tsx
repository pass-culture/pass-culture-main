...
export const EcoDesignDeclaration = () => {
  ...
  return (
    <EcoDesignLayout mainHeading="Déclaration RGESN">
      ...
      <p className={styles['paragraph']}>
        Le service a été évalué favorablement en termes d’utilité. En effet, le
        service est la mise en œuvre d’une politique publique pour rendre
      ...
      <p className={styles['paragraph']}>
        Afin d’assurer la sécurité des données du service et répondre aux enjeux
        du RGS, des mécanismes cryptographiques sont mis en place.
      </p>
      <p className={styles['paragraph']}>
      ...
      <p className={styles['paragraph']}>
        ...
        fonctionnalités et les besoins utilisateurs : nous recueillons depuis la
        plateforme les besoins et problématiques des utilisateurs et
        utilisatrices pour faire évoluer le service en fonction de leurs
        besoins. Nous supprimons également des fonctionnalités qui ne sont plus
      ...
      <p className={styles['paragraph']}>
        Le développement du backend et frontend du service numérique repose sur
        le(s) framework React, Python et PostgreSQL. Il est donc de la
      ...
      <p className={styles['paragraph']}>
        Le service est designé par une équipe de Product Designers qui utilisent
        diverses méthodologies pour adapter le service aux usages. Nous
        récoltons en continu les avis des usagers pour prévoir les futures
        évolutions du service. Nous utilisons également un outil d’analyse
        quantitative des parcours afin d’identifier des incohérences.
      </p>
      <p className={styles['paragraph']}>
      ...
      <p className={styles['paragraph']}>
        ...
        d’ajouter des vidéos sur leurs offres afin de mieux contextualiser leur
        proposition auprès des jeunes.
      </p>
      <p className={styles['paragraph']}>
      ...
      <p className={styles['paragraph']}>
        ...
        contenu est plébiscité par les jeunes utilisateurs et qu’il leur permet
        de mieux découvrir les contenus culturels.
      </p>
      <p className={styles['paragraph']}>
      ...
      <p className={styles['paragraph']}>
        Le service numérique a mis en place une stratégie de cache, optimisée au
        regard du type de contenu, du contexte d’application et des scénarios
        d’usage. En voici les principaux contours :
      </p>
      <p className={styles['paragraph']}>
      ...
      <p className={styles['paragraph']}>
        ...
        Google LLC, États-Unis. Cet hébergeur est signataire du Code de Conduite
        sur les Datacentres.
      </p>
      <p className={styles['paragraph']}>
      ...
      <p className={styles['paragraph']}>
        Afin de diminuer l’impact environnemental des équipements nécessaires à
        l’hébergement, les actions suivantes ont été entreprises :
      </p>
      <ul>
        <li className={styles['list-item']}>
          Communication sur la durée de vie moyenne de son parc d’équipements :
          Google conçoit ses propres serveurs et équipements et les maintient en
          service pour une durée moyenne de 6 ans (contre 3 à 5 ans dans le
          secteur), avant d’être réutilisés ou recyclés ;
        </li>
        <li className={styles['list-item']}>
          Informations sur l’impact environnemental de l’achat de ces
          équipements : Google travaille à l’intégration de matériaux
          circulaires (matières premières recyclées) dans les serveurs et autres
          produits. L’objectif est de maximiser l’utilisation de matériaux
          recyclés dans les produits et emballages d’ici 2025 ;
        </li>
        <li className={styles['list-item']}>
          Politique d’achat durable : Google privilégie l’achat d’équipements de
          réseau et de stockage conçus pour l’efficacité énergétique et la
          durabilité. L’entreprise travaille avec ses fournisseurs pour réduire
          l’empreinte carbone des produits qu’elle achète ;
        </li>
        <li className={styles['list-item']}>
          ...
          optimiser les charges de travail et le refroidissement. Virtualisation
          : Maximisation de l’utilisation des ressources via la virtualisation
          (GCP) ;
        </li>
        <li className={styles['list-item-spaced']}>
          ...
          service. L’objectif est la réutilisation des composants (disques durs,
          mémoires, processeurs) ou leur recyclage si la réutilisation n’est pas
          possible ;
        </li>
      </ul>
      ...
      <p className={styles['paragraph']}>
        Google ne publie pas le WUE (Water Usage Effectiveness) réel par campus
        individuel, mais seulement la moyenne mondiale (1,34 en 2023). La
        consommation réelle de 1,4 million de m³ d'eau (non potable) en 2023 est
      ...
      <ul>
        <li className={styles['list-item']}>
          Part de PPA sur le réseau français, mais hors site : Google ne publie
          pas la ventilation des PPA par campus/région. On sait que des PPA sont
          signés en Belgique.
        </li>
        <li className={styles['list-item']}>
          Part autoconsommation (potentiellement par PPA ou support complet des
          coûts de capital et autres) : 2,9 GWh/an (selon le gestionnaire de
          réseau local IDEA).
        </li>
        <li className={styles['list-item']}>
        ...
        <li className={styles['list-item']}>
          REF (Renewable Energy Factor) : Google ne publie pas le REF de la même
          manière que la France, mais son indicateur clé, la Carbon-Free Energy
          (CFE), indique que 64 % de l’électricité consommée est sans carbone
          24/7 à l’échelle mondiale.
        </li>
        <li className={styles['list-item-spaced']}>
      ...
      <p className={styles['paragraph']}>
        ...
        réduction des émissions de gaz à effet de serre requise par l’accord de
        Paris. L’hébergement du service a pour objectif d’être déplacé en France
        à horizon 2026.
      </p>
      ...
      <p className={styles['paragraph']}>
        Ce critère est validé car le PUE de l’hébergeur est inférieur ou égal à
        1,2 (1,08)
      </p>
