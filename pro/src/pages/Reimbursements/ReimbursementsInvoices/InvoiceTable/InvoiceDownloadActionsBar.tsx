...
export const InvoiceDownloadActionsBar = ({
  ...
  const invoiceDownLoadDescription =
    description ??
    `${invoiceReferences.length} ${pluralizeFr(invoiceReferences.length, 'justificatif sélectionné', 'justificatifs sélectionnés')}`
