...
describe('app', () => {
  ...
  it('should reset filters', async () => {
    ...
    await select(departmentFilter, '01 - Ain')
    await select(departmentFilter, '59 - Nord')
    await select(studentsFilter, 'Collège - 4e')
    await select(domainsFilter, 'Danse')
    await select(categoriesFilter, 'Cinéma')
