  ...
  return (
    <AccessibilityLayout mainHeading="Déclaration d’accessibilité">
      ...
      <p className={styles['paragraph']}>
        ...
        11 février 2005 et à l’article 16 de la loi n°2023-171 du 9 mars 2023.
      </p>
      <p className={styles['paragraph']}>
      ...
      <ul>
        ...
        <li className={styles['list-item']}>
          [7.5 - RGAA] Un message de statut au moins n'est pas restitué par les
          technologies d’assistance.
        </li>
        <li className={styles['list-item']}>
      ...
      <table className={styles['table']}>
        ...
        <tbody>
          ...
          <tr>
            <td className={styles['td']}>
              Création offre réservable (parcours 3) (5 étapes et confirmation)
            </td>
            <td className={styles['td']}>
              <Link
                color={LinkColor.NEUTRAL}
          ...
          <tr>
            <td className={styles['td']}>Les offres réservables (collectif)</td>
            <td className={styles['td']}>
              <Link
                color={LinkColor.NEUTRAL}
                isExternalLink
      ...
      <p className={styles['paragraph']}>
        ...
        d'une dérogation ou non.
      </p>
      <p className={styles['paragraph']}>
        Le pass Culture invite les personnes qui rencontreraient des difficultés
        à le contacter à l'adresse&nbsp;
        <Link
          color={LinkColor.NEUTRAL}
          isExternalLink
