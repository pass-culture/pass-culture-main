    ...
    <AccessibilityLayout mainHeading="Schéma pluriannuel d’accessibilité 2024 - 2025">
      <div className={styles['page-content']}>
        ...
        <p className={styles['paragraph']}>
          ...
          personnes rend obligatoire à tout service de communication publique en
          ligne d’être accessible à tous.
        </p>
        ...
        <p className={styles['paragraph']}>
          <strong>
            L’accessibilité numérique est indispensable aux personnes en
        ...
        <p className={styles['paragraph']}>
          ...
          tous, sans discrimination, le même accès à l’information et aux
          services en ligne.
        </p>
        <p className={styles['paragraph']}>
          L’accessibilité numérique est un domaine transverse qui concerne
          toutes les personnes impliquées dans la création, la maintenance et
        ...
        <p className={styles['paragraph']}>
          ...
          développement ou à la mise à disposition de sites web ou
          d’applications tant auprès du public que des personnels internes de la
          SAS pass Culture.
        </p>
        <p className={styles['paragraph']}>
          ...
          l’objectif d’accompagner la mise en conformité RGAA (Référentiel
          Général d’Amélioration de l’Accessibilité) et l’amélioration
          progressive des sites web et applications concernés.
        </p>
        <p className={styles['paragraph']}>
          L’élaboration, le suivi et la mise à jour de ce schéma pluriannuel
          sont placés sous la responsabilité du pôle Accessibilité.
        </p>
        <p className={styles['paragraph']}>
        ...
        <ul>
          ...
          <li className={styles['list-item']}>
            assurer la prise en charge des demandes des utilisateurs et de
            manière générale la qualité du service rendu aux utilisateurs en
        ...
        <ul>
          <li className={styles['list-item']}>
            de poursuivre l’adaptation de l’organisation interne de production
            et de gestion des sites web et application concernés ;
          </li>
          <li className={styles['list-item']}>
            de poursuivre l’accompagnement des équipes ;
          </li>
          <li className={styles['list-item']}>
            de veiller à la prise en compte de l’accessibilité dans les
        ...
        <p className={styles['paragraph']}>
          ...
          la SAS pass Culture s’appuiera pour améliorer l’accessibilité
          numérique de l’ensemble de ses sites web et applications.
        </p>
        <p className={styles['paragraph']}>
        ...
        <p className={styles['paragraph']}>
          ...
          formation et de sensibilisation vont être organisées. Elles
          permettront aux personnels intervenant sur les sites, les applications
          mais aussi sur les supports de communication de développer, éditer et
        ...
        <ul>
          ...
          <li className={styles['list-item']}>
            former pour acquérir les bonnes pratiques indispensables pour
            produire des sites et applications accessibles (graphisme,
            ergonomie, développement) et publier des contenus accessibles.
          </li>
        </ul>
        <p className={styles['paragraph']}>
        ...
        <p className={styles['paragraph']}>
          ...
          particulièrement les actions d’audits et de certification des sites
          web et applications concernés.
        </p>
        <p className={styles['paragraph']}>
          <strong>
        ...
        <p className={styles['paragraph']}>
          Les objectifs d’accessibilité et de conformité au RGAA sont inscrits
          et rappelés dès le début des projets dont ils constitueront un axe
          majeur et une exigence de base. De la même manière, ces objectifs et
          ces exigences sont rappelés dans les éventuelles conventions établies
          avec nos partenaires. Comme pour le RGPD, l’accessibilité est citée
          dans la réflexion préalable et nécessaire à l’engagement des projets.
        </p>
        <p className={styles['paragraph']}>
          Pour favoriser la prise en compte de l’accessibilité numérique dans
          les projets, des composants normés, des modèles accessibles et une
          documentation dédiée et évolutive sont mis à la disposition des
          équipes projets.
        </p>
        <p className={styles['paragraph']}>
        ...
        <p className={styles['paragraph']}>
          ...
          d’utilisateurs constitué comprendra dans toute la mesure du possible
          des personnes en situation de handicap. Le Conseil national
          consultatif des personnes handicapées accompagne en particulier le
        ...
        <p className={styles['paragraph']}>
          L’accessibilité numérique et la conformité au RGAA sont prises en
          compte et participent à l’évaluation de la qualité de l’offre d’un
          prestataire lors de la commande de travaux au travers des appels
          d’offres notamment.
        </p>
        <p className={styles['paragraph']}>
        ...
        <p className={styles['paragraph']}>
          ...
          l’intermédiaire de prestataires spécialisés, destinés à
          l’établissement ou la mise à jour des déclarations de conformité
          interviennent en complément des opérations habituelles de recette et
          contrôles intermédiaires qui sont organisées tout au long de la vie
          des projets.
        </p>
        <h2 className={styles['heading2']}>
        ...
        <p className={styles['paragraph']}>
          ...
          décriront en détail les opérations mises en œuvre pour prendre en
          charge l’ensemble des besoins en termes d’accessibilité numérique de
          la SAS pass Culture.
        </p>
        <h2 className={styles['heading2']}>
        ...
        <ul>
          ...
          <li className={styles['list-item']}>
            Organisation d’une journée dédiée à l’accessibilité à destination
            des équipes techniques et produit - Réalisé
          </li>
          <li className={styles['list-item']}>
            Modification de l’ensemble des pages du site pour qu’elles
            s’adaptent à la taille de l’écran (responsivité) - Réalisé
          </li>
          <li className={styles['list-item']}>
          ...
          <li className={styles['list-item']}>
            Reprise de l’ensemble des composants pour les rendre accessibles -
            En cours
          </li>
          <li className={styles['list-item']}>
        ...
        <ul>
          ...
          <li className={styles['list-item']}>
            Donner la possibilité aux acteurs culturels d’indiquer une
