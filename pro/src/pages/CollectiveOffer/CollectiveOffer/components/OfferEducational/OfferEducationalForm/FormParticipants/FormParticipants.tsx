...
export const FormParticipants = ({
  ...
  const collegeGroup = getCheckboxroupForLevel(values, ['Collège'], 'Collège')
  const lyceeGroup = getCheckboxroupForLevel(values, ['Lycée', 'CAP'], 'Lycée')
    ...
    <div className={styles['container']}>
      ...
      >
        <CheckboxGroup
          ...
          error={getFieldMeta('participants').error}
        />
      </FormLayout.Row>
    </div>
  )
