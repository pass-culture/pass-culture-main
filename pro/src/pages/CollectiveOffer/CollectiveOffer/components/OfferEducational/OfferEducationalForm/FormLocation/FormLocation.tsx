          ...
          group={[
            {
              ...
              // reprendre la logique de src/pages/IndividualOffer/IndividualOfferInformations/commons/utils.ts pour le GET
              value: selectedVenue?.address?.id_oa.toString() ?? '', // obligé de remplir toutes les infos du sous objet address puisque dans le cas où on sélectionnera une autre adresse précise on n'aura pas d'id
            },
          ]}
          name={'location.id_oa'}
        />
