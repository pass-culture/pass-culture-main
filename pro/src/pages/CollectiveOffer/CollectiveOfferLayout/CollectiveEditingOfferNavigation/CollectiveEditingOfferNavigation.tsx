...
import styles from './CollectiveEditingOfferNavigation.module.scss'

export interface CollectiveEditingOfferNavigationProps {
...
export const CollectiveEditingOfferNavigation = ({
  activeStep,
  isTemplate = false,
  offerId = 0,
  offer,
}: CollectiveEditingOfferNavigationProps): JSX.Element => {
