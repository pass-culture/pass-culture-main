...
import { CollectiveOfferStep } from '../../CollectiveOfferNavigation/CollectiveOfferNavigation'
import {
  CollectiveEditingOfferNavigation,
  CollectiveEditingOfferNavigationProps,
} from '../CollectiveEditingOfferNavigation'

const renderCollectiveEditingOfferNavigation = (
  props: CollectiveEditingOfferNavigationProps,
  options?: RenderWithProvidersOptions
) =>
  renderWithProviders(<CollectiveEditingOfferNavigation {...props} />, {
    storeOverrides: {
      user: {
...
describe('CollectiveEditingOfferNavigation', () => {
  let offer:
    | GetCollectiveOfferTemplateResponseModel
    | GetCollectiveOfferResponseModel
  let props: CollectiveEditingOfferNavigationProps
  const offerId = 1
