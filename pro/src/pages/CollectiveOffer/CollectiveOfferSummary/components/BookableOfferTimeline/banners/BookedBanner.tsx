...
export const BookedBanner = ({
  ...
  const description = isCancellationLimitDateInPast
    ...
    : `Le chef d’établissement a confirmé la préréservation de l’offre. À partir du ${formatDateTime(
        cancellationLimitDate,
        FORMAT_DD_MM_YYYY,
        departmentCode
  ...
  return (
    <div className={styles['callout']}>
      <Banner
        ...
        size="default"
        closable={false}
        data-testid="banner-booking-booked"
      />
    </div>
  )
}
