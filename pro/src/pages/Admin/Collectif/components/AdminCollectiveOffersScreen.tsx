...
import styles from './AdminCollectiveOffersScreen.module.scss'
import { AdminCollectiveOffersSearchFilters } from './AdminCollectiveOffersSearchFilters'

export type AdminCollectiveOffersScreenProps = {
...
export const AdminCollectiveOffersScreen = ({
  currentPageNumber,
  isLoading,
  offererId,
  ...
  urlSearchFilters,
  offers,
}: AdminCollectiveOffersScreenProps): JSX.Element => {
  ...
  return (
    <div>
      ...
      <AdminCollectiveOffersSearchFilters
