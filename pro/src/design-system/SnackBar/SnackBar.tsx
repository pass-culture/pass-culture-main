...
const ANIMATION_DURATION = 300 // should have the same value as `&.show transition` in `SnackBar.module.scss`
...
export const SnackBar = ({
  ...
  return (
    <div
      ...
      style={{ '--snackbar-duration': `${duration}ms` } as React.CSSProperties}
