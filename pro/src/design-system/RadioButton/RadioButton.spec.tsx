...
describe('<RadioButton />', () => {
  ...
  it('renders childrenOnChecked only if checked', () => {
  ...
  it('checks the aria-describedby attribute', () => {
    ...
    const input = getByRole('radio', { name: /Label/ })
    expect(input.getAttribute('aria-describedby')).toMatch(/foo/)
  })
