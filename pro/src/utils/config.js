...
const {
  ...
  REACT_APP_ENV_WORDING,
  REACT_APP_SENTRY_SAMPLE_RATE,
  REACT_APP_SENTRY_SERVER_URL,
  REACT_APP_URL_FOR_MAINTENANCE,
  REACT_APP_DEMARCHES_SIMPLIFIEES_OFFERER_RIB_UPLOAD_PROCEDURE_URL,
  REACT_APP_DEMARCHES_SIMPLIFIEES_VENUE_RIB_UPLOAD_PROCEDURE_URL,
...
export const ENVIRONMENT_NAME = REACT_APP_ENVIRONMENT_NAME
export const ENV_WORDING = REACT_APP_ENV_WORDING
export const SENTRY_SAMPLE_RATE = REACT_APP_SENTRY_SAMPLE_RATE
export const SENTRY_SERVER_URL = REACT_APP_SENTRY_SERVER_URL
export const URL_FOR_MAINTENANCE = REACT_APP_URL_FOR_MAINTENANCE
...
export const DEMARCHES_SIMPLIFIEES_BUSINESS_UNIT_RIB_UPLOAD_PROCEDURE_URL =
  REACT_APP_DEMARCHES_SIMPLIFIEES_BUSINESS_UNIT_RIB_UPLOAD_PROCEDURE_URL
export const ASSETS_URL = REACT_APP_ASSETS_URL
export const RECAPTCHA_SITE_KEY = REACT_APP_RECAPTCHA_SITE_KEY
export const WEBAPP_URL = REACT_APP_WEBAPP_URL
