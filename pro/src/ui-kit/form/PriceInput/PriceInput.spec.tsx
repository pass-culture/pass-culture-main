...
const renderPriceInput = (
  props: Partial<PriceInputProps>,
  initialPrice: number | string = ''
) => {
  return render(
    <Formik initialValues={{ price: initialPrice }} onSubmit={() => {}}>
      <PriceInput
        {...props}
        name="price"
        label="Prix"
...
describe('PriceInput', () => {
  ...
  describe('when "Gratuit" checkbox display is enabled', () => {
    ...
    it('should check the checkbox initially when the input value is 0', () => {
      renderPriceInput({ showFreeCheckbox: true }, 0)
    ...
    it('should check the checkbox when the input value changes to 0', async () => {
      renderPriceInput({ showFreeCheckbox: true }, 1)
