...
describe('SelectedValuesTags', () => {
  ...
  it('should display the ellipsis tag if there are more than 10 selected options', () => {
    const extendedProps = {
      ...defaultProps,
      selectedOptions: Array.from({ length: 12 }, (_, index) =>
        String(index + 1)
      ),
    }
  ...
  it('should not display the ellipsis tag if there are 10 or fewer selected options', () => {
    render(<SelectedValuesTags {...defaultProps} />)
