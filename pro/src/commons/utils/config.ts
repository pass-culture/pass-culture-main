...
export const ALGOLIA_INDIVIDUAL_OFFERS_ARTISTS_INDEX =
  import.meta.env.VITE_ALGOLIA_INDIVIDUAL_OFFERS_ARTISTS_INDEX ?? ''
...
export const DS_NEW_CALEDONIA_BANK_ACCOUNT_PROCEDURE_ID = import.meta.env
  .VITE_DEMARCHES_SIMPLIFIEES_NEW_CALEDONIA_BANK_ACCOUNT_PROCEDURE_ID
