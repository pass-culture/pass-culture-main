...
import type { OffererState } from '@/commons/store/offerer/reducer'
...
export const currentOffererFactory = (
  ...
  offererNamesAttached: [...(customOfferer.offererNamesAttached ?? [])],
  currentOfferer: {
    id: 1,
    isOnboarded: true,
    ...customOfferer.currentOfferer,
  },
  combinedOffererNames: [...(customOfferer.combinedOffererNames ?? [])],
