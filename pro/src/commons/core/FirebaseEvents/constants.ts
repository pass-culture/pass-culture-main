...
export const Events = {
  ...
  CLICKED_SEE_LATER_FROM_SUCCESS_VENUE_CREATION_MODAL:
    'hasClickedSeeLaterFromSuccessVenueCreationModal',
  CLICKED_SEE_LATER_FROM_SUCCESS_OFFER_CREATION_MODAL:
  ...
  CLICKED_PARTNER_BLOCK_PREVIEW_VENUE_LINK:
    'hasClickedPartnerBlockPreviewVenueLink',
  CLICKED_PARTNER_BLOCK_COPY_VENUE_LINK: 'hasClickedPartnerBlockCopyVenueLink',
  CLICKED_PARTNER_BLOCK_DMS_APPLICATION_LINK:
    'hasClickedPartnerBlockDmsApplicationLink',
  CLICKED_PARTNER_BLOCK_COLLECTIVE_HELP_LINK:
    'hasClickedPartnerBlockCollectiveHelpLink',
  ...
  CLICKED_SAVE_DRAFT_AND_EXIT_COLLECTIVE_OFFER:
    'hasClickedSaveDraftAndExitCollectiveOffer',
...
export type Events = EnumType<typeof Events>
...
// eslint-disable-next-line no-redeclare
export type VenueEvents = EnumType<typeof VenueEvents>

export const CollectiveBookingsEvents = {
  CLICKED_EXPAND_COLLECTIVE_BOOKING_DETAILS:
    'hasClickedExpandCollectiveBookingDetails',
...
// eslint-disable-next-line no-redeclare
export type CollectiveBookingsEvents = EnumType<typeof CollectiveBookingsEvents>

export const OFFER_FORM_NAVIGATION_MEDIUM = {
  OFFERS_TRASH_ICON: 'OffersTrashicon',
} as const
// eslint-disable-next-line no-redeclare, @typescript-eslint/naming-convention
type OFFER_FORM_NAVIGATION_MEDIUM = EnumType<
  typeof OFFER_FORM_NAVIGATION_MEDIUM
>

export const OFFER_FORM_NAVIGATION_IN = {
  HOME: 'Home',
  OFFERS: 'Offers',
} as const
// eslint-disable-next-line no-redeclare, @typescript-eslint/naming-convention
type OFFER_FORM_NAVIGATION_IN = EnumType<typeof OFFER_FORM_NAVIGATION_IN>

export const COLLECTIVE_OFFER_DUPLICATION_ENTRIES = {
  OFFERS_MODAL: 'OffersListModal',
  OFFERS: 'OffersList',
  OFFER_RECAP: 'OfferRecap',
} as const
// eslint-disable-next-line no-redeclare, @typescript-eslint/naming-convention
export type COLLECTIVE_OFFER_DUPLICATION_ENTRIES = EnumType<
  typeof COLLECTIVE_OFFER_DUPLICATION_ENTRIES
>
...
// eslint-disable-next-line no-redeclare
export type SynchronizationEvents = EnumType<typeof SynchronizationEvents>

export const OffererLinkEvents = {
...
// eslint-disable-next-line no-redeclare
export type OffererLinkEvents = EnumType<typeof OffererLinkEvents>
...
export const BankAccountEvents = {
  ...
  CLICKED__BANK_ACCOUNT_HAS_PENDING_CORRECTIONS:
    'HasClickedHasBankAccountWithPendingCorrections',
...
// eslint-disable-next-line no-redeclare
export type BankAccountEvents = EnumType<typeof BankAccountEvents>
