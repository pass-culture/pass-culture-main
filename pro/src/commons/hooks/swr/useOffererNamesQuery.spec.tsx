...
describe('useOffererNamesQuery', () => {
  ...
  it('should invoke API and dispatch if no data is present in the store', async () => {
    const mockOffererNames = [
      { id: 1, name: 'Offerer 1', allowedOnAdage: false, isCaledonian: false },
      { id: 2, name: 'Offerer 2', allowedOnAdage: true, isCaledonian: false },
    ]
  ...
  it('should not invoke API and dispatch if data is present in the store', async () => {
    const mockOffererNames = [
      { id: 3, name: 'Offerer 3', allowedOnAdage: true, isCaledonian: false },
      { id: 4, name: 'Offerer 4', allowedOnAdage: false, isCaledonian: false },
    ]
