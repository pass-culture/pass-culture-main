...
describe('LegalEntitySelect', () => {
  ...
  it('should not render when there are no offerers', () => {
  ...
  it('should not render when there is only one offerer', () => {
    const singleOfferer = getOffererNameFactory({ id: 1, name: 'Offerer 1' })
    const fullOfferer = {
      ...defaultGetOffererResponseModel,
      id: 1,
      name: 'Offerer 1',
  ...
  it('should not render when offererNames is null', () => {
    renderLegalEntitySelect({
      storeOverrides: {
        offerer: {
          offererNames: null,
