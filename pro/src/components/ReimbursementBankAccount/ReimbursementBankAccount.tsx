...
export const ReimbursementBankAccount = forwardRef(
  (
    {
      bankAccount,
      onUpdateButtonClick,
          ...
          >
            <SvgIcon
              ...
              className={cn(styles['status-icon'], {
                [styles['error-icon']]:
                  bankAccount.status ===
                  BankAccountApplicationStatus.A_CORRIGER,
              })}
            />
            <div>
              Statut du dossier :{' '}
...
ReimbursementBankAccount.displayName = 'ReimbursementBankAccount'
