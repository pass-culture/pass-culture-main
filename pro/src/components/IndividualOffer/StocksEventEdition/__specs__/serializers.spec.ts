...
describe('serializeBookingLimitDatetime', () => {
  it('should serialize booking limit datetime when beginningDatetime and bookingLimitDatetime are on the same date', () => {
    const serializedBookingLimitDatetime = serializeBookingLimitDatetime(
      '2022-10-11',
      '13:00',
      '2022-10-11T14:00:00',
      '75'
...
describe('buildDateTime', () => {
  it('should raise error', () => {
    expect(() => buildDateTime('2022-10-11', '13')).toThrowError(
      'La date ou l’heure est invalide'
    )
    expect(() => buildDateTime('2022-1011', '13:00')).toThrowError(
      'La date ou l’heure est invalide'
    )
  })

  it('should build datetime', () => {
    expect(buildDateTime('2022-10-11', '13:00')).toEqual(
      new Date(2022, 9, 11, 13, 0)
    )
  })
})
