...
import { PRICE_CATEGORY_PRICE_MAX, PRICE_MAX_FRANC } from '../PriceCategoriesScreen/form/constants'
  ...
  return yup.object().shape({
    price: yup.number().when([], (_, schema) => {
      ...
      return schema
        ...
        .max(
          isCaledonian ? PRICE_MAX_FRANC : PRICE_CATEGORY_PRICE_MAX,
          isCaledonian
            ? `Veuillez renseigner un prix inférieur à ${PRICE_MAX_FRANC}F`
