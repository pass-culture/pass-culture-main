...
import {
  type OnboardingActivityOpenToPublic,
...
export const Validation = (): JSX.Element | undefined => {
  ...
  const activityLabel =
    offerer?.isOpenToPublic === 'true'
      ? getActivityLabel(activity.venueTypeCode as OnboardingActivityOpenToPublic) // TODO (jclery, 2025-11-27): This is TEMPORARY as we currently use the "venueTypeCode" field to store either the actual venueTypeCode, or the new activity ID. But they will be dissociated very soon and this comment will be removed.
      : venueTypes.find(
        ...
        ...(offerer?.isOpenToPublic === 'true'
          ? {
              activity:
                ...
                activity.venueTypeCode as OnboardingActivityOpenToPublic, // TODO (jclery, 2025-11-27): Also TEMPORARY (see above)
            }
          : {
              venueTypeCode:
                /* istanbul ignore next: should not have empty or null venueTypeCode at this step */
