...
const updateLatitudeLongitude = form => location => {
...
const updateAddress = form => location => {
          ...
          <div className="field-value flex-columns items-center">
            ...
            >
              <LocationViewer
                ...
                id={id}
                name={name}
                onMarkerDragend={updateLatitudeLongitude(form)}
                onSuggestionSelect={updateLatitudeLongitude(form)}
                onTextChange={updateAddress(form)}
