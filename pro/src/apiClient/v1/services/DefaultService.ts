...
export class DefaultService {
  ...
  public getCollectiveOffers(
    ...
    status?:
      | (Array<CollectiveOfferDisplayedStatus> | CollectiveOfferDisplayedStatus)
      | null,
    venueId?: number | null,
   ...
   * @throws ApiError
   */
  public deleteOfferTemplateImage(offerId: number): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'DELETE',
   ...
   * @throws ApiError
   */
  public deleteOfferImage(offerId: number): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'DELETE',
   ...
   * @throws ApiError
   */
  public deleteApiKey(apiKeyPrefix: string): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'DELETE',
   ...
   * @throws ApiError
   */
  public deleteThumbnail(offerId: number): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'DELETE',
   ...
   * @throws ApiError
   */
  public getSirenInfo(siren: string): CancelablePromise<SirenInfo> {
    return this.httpRequest.request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public getSiretInfo(siret: string): CancelablePromise<SiretInfo> {
    return this.httpRequest.request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public deleteStock(stockId: number): CancelablePromise<StockIdResponseModel> {
    return this.httpRequest.request({
      method: 'DELETE',
      url: '/stocks/{stock_id}',
      path: {
   ...
   * @throws ApiError
   */
  public connectAs(token: string): CancelablePromise<any> {
    return this.httpRequest.request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public checkActivationTokenExists(token: string): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'GET',
   ...
   * @throws ApiError
   */
  public validateUser(token: string): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'PATCH',
   ...
   * @throws ApiError
   */
  public deleteVenueProvider(venueProviderId: number): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'DELETE',
   ...
   * @throws ApiError
   */
  public getVenue(venueId: number): CancelablePromise<GetVenueResponseModel> {
    return this.httpRequest.request({
      method: 'GET',
      url: '/venues/{venue_id}',
      path: {
   ...
   * @throws ApiError
   */
  public deleteVenueBanner(venueId: number): CancelablePromise<void> {
    return this.httpRequest.request({
      method: 'DELETE',
