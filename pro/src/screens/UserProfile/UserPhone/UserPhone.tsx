...
import { formatPhoneNumber } from 'deprecatedPages/Home/ProfileAndSupport/ProfileAndSupport'
import patchPhoneAdapter from 'deprecatedPages/User/adapters/patchPhoneAdapter'
