...
for f in src/apiClient/v1/new/sdk.gen.ts src/apiClient/adage/new/sdk.gen.ts; do
...
for f in src/apiClient/v1/new/client/types.gen.ts src/apiClient/adage/new/client/types.gen.ts; do
...
cat >> src/apiClient/v1/new/index.ts << 'EOF'
...
cat >> src/apiClient/adage/new/index.ts << 'EOF'
...
for dir in src/apiClient/v1/new/core src/apiClient/adage/new/core; do
