...
docker run --rm -v ${PWD}:/local swaggerapi/swagger-codegen-cli-v3 generate \
        ...
        -i https://backend.passculture-testing.beta.gouv.fr/pro/openapi.json `# schema location` \
        ...
        -o /local/src/api/swagger-codegen/v1/gen `# output directory`
...
docker run --rm -v ${PWD}:/local swaggerapi/swagger-codegen-cli-v3 generate \
        ...
        -c /local/swagger_codegen/swagger_codegen_config.json `# swagger codegen config` \
        -t /local/swagger_codegen/gen_templates `# templates directory` \
        -o /local/src/api/swagger-codegen/v2/gen `# output directory`
