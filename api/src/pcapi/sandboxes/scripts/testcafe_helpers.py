...
def get_testcafe_helpers(module_name: str) -> dict:
    module = getattr(getters, module_name)
    items = [
...
def print_dumped_object(obj: typing.Any) -> None:
    print(json.dumps(obj, ensure_ascii=False, indent=2, sort_keys=True))


def get_all_getters() -> dict:
