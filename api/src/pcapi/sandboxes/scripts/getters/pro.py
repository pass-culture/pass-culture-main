...
def create_pro_user_with_individual_offers() -> dict:
    ...
    return {
        ...
        "offerName1": offer1.name,
        "offerName2": offer2.name,
        "offerName3": offer3.name,
        "offerName4": offer4.name,
        "offerName5": offer5.name,
        "offerName6": offer6.name,
        "offerName7": offer7.name,
    }
