...
def create_artists() -> None:
    ...
    artist_1 = artist_factories.ArtistFactory(
        ...
        image_liscence_url="https://creativecommons.org/licenses/by-sa/3.0",
    )
    for _ in range(10):
    ...
    artist_2 = artist_factories.ArtistFactory(
        ...
        image_liscence_url="https://creativecommons.org/licenses/by/2.0",
    )
    for _ in range(10):
    ...
    artist_3 = artist_factories.ArtistFactory(
        ...
        image_liscence_url="https://creativecommons.org/licenses/by-sa/2.0",
    )
    for _ in range(10):
