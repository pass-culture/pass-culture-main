...
def create_industrial_offerer_confidence_rules() -> None:
    ...
    offers_factories.ThingStockFactory.create(
    ...
    rule2 = offerers_factories.WhitelistedOffererConfidenceRuleFactory.create(
        offerer__name="Structure de confiance",
    )
    venue2 = offerers_factories.VenueFactory.create(
        managingOfferer=rule2.offerer, name="Lieu de la structure de confiance"
    )
    offers_factories.ThingStockFactory.create(
    ...
    offerer = offerers_factories.OffererFactory.create(name="Structure avec des règles de fraude sur les lieux")
    rule3 = offerers_factories.ManualReviewVenueConfidenceRuleFactory.create(
    ...
    rule4 = offerers_factories.WhitelistedVenueConfidenceRuleFactory.create(
        venue__managingOfferer=offerer,
