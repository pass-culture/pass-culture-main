...
def create_industrial_gdpr_users() -> None:
    ...
    iris_for_default_address = geography_factories.IrisFranceFactory.create(
    ...
    fraud_factories.BeneficiaryFraudCheckFactory.create(user=user)
    fraud_factories.BeneficiaryFraudReviewFactory.create(user=user, review=fraud_models.FraudReviewStatus.KO)
    ...
    user = _create_gdpr_user(
        ...
        city="Paris",
        departementCode="75",
        irisFrance=geography_factories.IrisFranceFactory.create(
