...
def create_venues(offerer_list: list[offerers_models.Offerer]) -> None:
    ...
    create_venue(
        ...
        reimbursement=True,
        adageId="123546",
        adageInscriptionDate=datetime.now() - timedelta(days=3),
    ...
    create_venue(
        ...
        adageId="10837",
        adageInscriptionDate=datetime.now() - timedelta(days=5),
        reimbursement=True,
        venueEducationalStatusId=next(educational_status_iterator),
        collectiveInterventionArea=ALL_INTERVENTION_AREA,
        departementCode="91",
    ...
    pending_reimbursement_venue = offerers_factories.VenueFactory(
        ...
        adageId="789456",
        adageInscriptionDate=datetime.now() - timedelta(days=30),
        venueEducationalStatusId=next(educational_status_iterator),
        collectiveInterventionArea=ALL_INTERVENTION_AREA,
    ...
    create_venue(
        ...
        name=f"real_venue 1 {offerer.name}",
        adageId="698748",
        adageInscriptionDate=datetime.now() - timedelta(days=13),
        venueEducationalStatusId=next(educational_status_iterator),
        collectiveInterventionArea=ALL_INTERVENTION_AREA,
    ...
    venue = create_venue(
        ...
        adageId="98763",
        adageInscriptionDate=datetime.now(),
    )
    educational_factories.CollectiveDmsApplicationFactory(
        venue=venue,
        application=next(application_id_generator),
