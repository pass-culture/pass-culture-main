...
def create_venues(offerer_list: list[offerers_models.Offerer]) -> None:
    ...
    create_venue(
        ...
        reimbursement=True,
        adageId="123546",
        adageInscriptionDate=datetime.datetime.now(datetime.timezone.utc) - datetime.timedelta(days=3),
    ...
    create_venue(
        ...
        adageId="10837",
        adageInscriptionDate=datetime.datetime.now(datetime.timezone.utc) - datetime.timedelta(days=5),
        reimbursement=True,
        venueEducationalStatusId=next(educational_status_iterator),
        collectiveInterventionArea=ALL_INTERVENTION_AREA,
        departementCode="91",
    ...
    pending_reimbursement_venue = offerers_factories.VenueFactory(
        ...
        adageId="789456",
        adageInscriptionDate=datetime.datetime.now(datetime.timezone.utc) - datetime.timedelta(days=30),
        venueEducationalStatusId=next(educational_status_iterator),
        collectiveInterventionArea=ALL_INTERVENTION_AREA,
    ...
    create_venue(
        ...
        name=f"real_venue 1 {offerer.name}",
        adageId="698748",
        adageInscriptionDate=datetime.datetime.now(datetime.timezone.utc) - datetime.timedelta(days=13),
        venueEducationalStatusId=next(educational_status_iterator),
        collectiveInterventionArea=ALL_INTERVENTION_AREA,
    ...
    educational_factories.CollectiveDmsApplicationFactory(
        ...
        procedure=57189,
        lastChangeDate=datetime.datetime.fromisoformat("2023-03-26T16:08:35+01:00"),
        depositDate=datetime.datetime.fromisoformat("2024-03-23T16:08:33+01:00"),
        expirationDate=datetime.datetime.fromisoformat("2025-03-23T16:08:33+01:00"),
        buildDate=datetime.datetime.fromisoformat("2023-03-23T16:08:35+01:00"),
        instructionDate=datetime.datetime.fromisoformat("2025-03-24T16:08:33+01:00"),
        processingDate=datetime.datetime.fromisoformat("2025-03-25T16:08:33+01:00"),
        state="accepte",
    )
    # eac_sans_suite
    offerer = next(offerer_iterator)
    ...
    educational_factories.CollectiveDmsApplicationFactory(
        ...
        application=next(application_id_generator),
        procedure=57189,
        lastChangeDate=datetime.datetime.fromisoformat("2022-11-08 14:09:33+00:00"),
        ...
        processingDate=datetime.datetime.fromisoformat("2022-11-08 14:09:31+00:00"),
        state="accepte",
    )
    # eac_complete_30-d
    offerer = next(offerer_iterator)
    venue = create_venue(
        ...
        adageId="98763",
        adageInscriptionDate=datetime.datetime.now(datetime.timezone.utc),
    )
    educational_factories.CollectiveDmsApplicationFactory(
        venue=venue,
        application=next(application_id_generator),
        procedure=57189,
        lastChangeDate=datetime.datetime.now(datetime.timezone.utc),
        depositDate=datetime.datetime.fromisoformat("2022-05-17 14:43:22+00:00"),
        expirationDate=datetime.datetime.fromisoformat("2025-11-08 14:09:31+00:00"),
        buildDate=datetime.datetime.fromisoformat("2022-05-17 14:43:22+00:00"),
        instructionDate=datetime.datetime.fromisoformat("2022-10-25 12:40:41+00:00"),
        processingDate=datetime.datetime.now(datetime.timezone.utc),
        state="accepte",
    )
