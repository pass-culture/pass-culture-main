...
def create_e2e_invoices() -> None:
    logger.info("create_e2e_invoices")
...
def create_specific_invoice() -> None:
    ...
    special_user = users_factories.BeneficiaryGrant18Factory(
        ...
        deposit__source="create_specific_invoice() in e2e sandbox",
    )
    ...
    booking_with_total_incident = bookings_factories.ReimbursedBookingFactory(
        ...
        quantity=1,
        amount=30,
        user__deposit__source="create_specific_invoice() in e2e sandbox",
    )
