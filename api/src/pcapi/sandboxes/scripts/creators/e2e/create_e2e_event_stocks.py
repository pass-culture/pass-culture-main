...
from pcapi.sandboxes.scripts.creators.e2e.create_e2e_event_occurrences import EventOccurrence
...
def create_e2e_event_stocks(event_occurrences_by_name: dict[str, EventOccurrence]) -> None:
    logger.info("create_e2e_event_stocks")
