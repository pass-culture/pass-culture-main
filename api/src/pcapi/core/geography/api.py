# This script is commented out because it uses Fiona, and it's the only place where Fiona is used and Fiona is big.
# It's rarely run. If you need to use it, install the Fiona dependency and then run the script.
