...
class Booking(PcObject, Base, Model):
    ...
    finance_events: list["finance_models.FinanceEvent"] = relationship("FinanceEvent", back_populates="booking")
    pricings: list["Pricing"] = relationship("Pricing", back_populates="booking")
    payments: list["Payment"] = relationship("Payment", back_populates="booking")
    incidents: list["BookingFinanceIncident"] = relationship("BookingFinanceIncident", back_populates="booking")
    externalBookings: list["ExternalBooking"] = relationship("ExternalBooking", back_populates="booking")
