...
class Permissions(enum.Enum):
    ...
    PRO_FRAUD_ACTIONS = "actions exclusives à l'équipe Fraude PRO"
    BENEFICIARY_FRAUD_ACTIONS = "actions exclusives à l'équipe Fraude jeunes"
    ...
    MOVE_COLLECTIVE_OFFER = "support pro avancé : déplacer une offre collective"
    ...
    REOPEN_VENUE = "rouvrir un partenaire culturel"
