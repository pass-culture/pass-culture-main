...
class ProductMediation(PcObject, Base, Model):
    ...
    imageType: sa_orm.Mapped[offers_models.ImageType] = sa.Column(sa.Enum(offers_models.ImageType), nullable=False)
...
class Product(PcObject, Base, Model, HasThumbMixin):
    ...
    extraData: sa_orm.Mapped[offers_models.OfferExtraData | None] = sa.Column(
