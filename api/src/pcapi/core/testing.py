...
def assert_no_duplicated_queries() -> collections.abc.Generator[None, None, None]:
    ...
    flask.g.pcapi_query_logger = []  # type: ignore [attr-defined]
    yield
    queries = flask.g.pcapi_query_logger  # type: ignore [attr-defined]
...
def assert_num_queries(expected_n_queries: int) -> collections.abc.Generator[None, None, None]:
    ...
    del flask.g.pcapi_query_logger  # type: ignore [attr-defined]
...
def _record_end_of_query(statement: str, parameters: dict, **kwargs: dict) -> None:
    ...
    if not hasattr(flask.g, "pcapi_query_logger"):
        return
    flask.g.pcapi_query_logger.append(
        {
            "statement": statement,
