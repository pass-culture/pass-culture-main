...
from . import models
from . import tasks
from .titelive_utils_csr import generate_titelive_csr_from_file
...
@blueprint.cli.command("update_csr")
@click.option(
    "-f",
    "--file",
    required=True,
    help="CSV extract of 'Correspondance CSRversGTL.xlsx' with tab as separator",
    type=str,
)
def update_csr(file: str) -> None:
    generate_titelive_csr_from_file(file)
