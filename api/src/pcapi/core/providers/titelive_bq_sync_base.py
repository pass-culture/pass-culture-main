...
BigQueryTiteliveProductModelType = typing.TypeVar("BigQueryTiteliveProductModelType", bound=BigQueryTiteliveProductBase)


class BigQuerySyncTemplate(abc.ABC, typing.Generic[BigQueryTiteliveProductModelType]):
