    ...
    with open(file_path, newline="", encoding="utf-8") as csv_file:
        ...
        for index, eans_in_page in enumerate(pages):
            ...
            for product in products:
                product.extraData[EXTRA_DATA_KEYS["ean"]] = extra_data[EXTRA_DATA_KEYS["ean"]]
                product.extraData[EXTRA_DATA_KEYS["code_gtl"]] = extra_data[EXTRA_DATA_KEYS["code_gtl"]]
                product.extraData[EXTRA_DATA_KEYS["code_clil"]] = extra_data[EXTRA_DATA_KEYS["code_clil"]]
                product.extraData[EXTRA_DATA_KEYS["code_csr"]] = extra_data[EXTRA_DATA_KEYS["code_csr"]]
                product.extraData[EXTRA_DATA_KEYS["rayon"]] = (
                    extra_data[EXTRA_DATA_KEYS["rayon"]] or product.extraData[EXTRA_DATA_KEYS["rayon"]]
