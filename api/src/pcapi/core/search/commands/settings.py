...
# def _get_index_client(index_type: IndexTypes) -> SearchClient:
...
# def _get_settings(index: SearchClient, dry: bool = False) -> list[str]:
#     outputs = []
...
# def _set_settings(index: SearchClient, path: str, dry: bool = True) -> list[str]:
#     outputs = []
