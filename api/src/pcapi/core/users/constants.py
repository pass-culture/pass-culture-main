...
UNDERAGE_BROAD_OPENING_DATETIME = datetime.datetime(2022, 1, 31)
UNDERAGE_EARLY_OPENING_DATETIME = datetime.datetime(2022, 1, 3)
UNDERAGE_OPENING_DATETIMES_BY_AGE = {
    15: UNDERAGE_BROAD_OPENING_DATETIME,
