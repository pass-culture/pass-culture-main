...
class ActionType(enum.Enum):
    ...
    # Non payment notices
    NON_PAYMENT_NOTICE_CREATED = "NON_PAYMENT_NOTICE_CREATED"
    ...
    VENUE_SOFT_DELETED = "VENUE_SOFT_DELETED"
...
class ActionHistory(PcObject, Model):
    ...
    actionType: sa_orm.Mapped[ActionType] = sa.orm.mapped_column(db_utils.MagicEnum(ActionType), nullable=False)
    ...
    actionDate = sa.orm.mapped_column(
    ...
    authorUserId: sa_orm.Mapped[int | None] = sa.orm.mapped_column(
    ...
    extraData: sa_orm.Mapped[dict | None] = sa.orm.mapped_column(
    ...
    userId: sa_orm.Mapped[int | None] = sa.orm.mapped_column(
    ...
    offererId: sa_orm.Mapped[int | None] = sa.orm.mapped_column(
    ...
    venueId: sa_orm.Mapped[int | None] = sa.orm.mapped_column(
    ...
    financeIncidentId: sa_orm.Mapped[int | None] = sa.orm.mapped_column(
    ...
    bankAccountId: sa_orm.Mapped[int | None] = sa.orm.mapped_column(
    ...
    ruleId: sa_orm.Mapped[int | None] = sa.orm.mapped_column(
    ...
    chronicleId: sa_orm.Mapped[int | None] = sa.orm.mapped_column(
    ...
    comment = sa.orm.mapped_column(sa.Text(), nullable=True)
