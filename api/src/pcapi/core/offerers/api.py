...
def update_venue(
    ...
    *,
    ...
    if opening_hours:
        old = opening_hours_api.old_opening_hours(venue)
        updates = opening_hours_api.upsert_opening_hours(venue, opening_hours=opening_hours, full_replace=False)
        changes = opening_hours_api.compute_upsert_changes(old, updates)
