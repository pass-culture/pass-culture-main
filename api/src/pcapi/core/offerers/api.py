...
def create_offerer_address_from_address_api(address: offerers_schemas.LocationBodyModel) -> geography_models.Address:
    try:
        insee_code = (
            address.inseeCode
...
def get_offer_location_from_address(
    offerer_id: int, address: offerers_schemas.LocationBodyModel
...
def find_ban_address_from_insee_address(
    ...
    try:
        ...
        return (
            ...
            else offerers_schemas.LocationBodyModel(
