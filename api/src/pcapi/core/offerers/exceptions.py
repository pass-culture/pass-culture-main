...
class CannotDeleteOffererWithActiveOrFutureCustomReimbursementRule(ClientError):
    def __init__(self) -> None:
        super().__init__(
            ...
            "Entité juridique non supprimable car elle est soumise à une règle de remboursement active ou future",
        )
...
class CannotDeleteVenueWithActiveOrFutureCustomReimbursementRule(ClientError):
    def __init__(self) -> None:
        super().__init__(
            ...
            "Partenaire culturel non supprimable car il est soumis à une règle de remboursement active ou future",
        )
