...
def venues_have_collective_offers(*venues: models.Venue) -> bool:
    ...
    collective_offer_query = educational_repository._filter_collective_offers_by_statuses(
...
def get_number_of_bookable_collective_offers_for_offerer(offerer_id: int) -> int:
    ...
    collective_offers_query = educational_repository._filter_collective_offers_by_statuses(
