...
class CriterionCategoryMapping(PcObject, Model):
    ...
    criterionId: sa_orm.Mapped[int] = sa.orm.mapped_column(
...
class Criterion(PcObject, Model):
    ...
    startDateTime = sa.orm.mapped_column(sa.DateTime, nullable=True)
    endDateTime = sa.orm.mapped_column(sa.DateTime, nullable=True)
...
class CriterionCategory(PcObject, Model):
    ...
    label: sa_orm.Mapped[str] = sa.orm.mapped_column(sa.String(140), nullable=False, unique=True)
