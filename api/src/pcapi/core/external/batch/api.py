...
def update_user_attributes(user_id: int, attribute_values: dict, can_be_asynchronously_retried: bool = False) -> None:
...
def send_transactional_notification(
    notification_data: serialization.TransactionalNotificationData, can_be_asynchronously_retried: bool = False
) -> None:
...
def track_event_bulk(
    track_event_data: list[serialization.TrackBatchEventRequest], can_be_asynchronously_retried: bool = False
) -> None:
