...
"""Reminder:
 _get_sent_pricings > /reimbursements/csv PRO
_get_X_booking_reimbursement_data / _get_X_booking_reimbursement_data > <int:bank_account_id>/reimbursement-details BACKOFFICE"""
