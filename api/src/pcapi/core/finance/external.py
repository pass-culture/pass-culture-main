            ...
            for settlement_data in bill_settlements:
                ...
                if settlement_data["RefLot"] and settlement_data["RefLot"]["value"]:
                    settlement_batch = (
                        ...
                        .filter(
                            finance_models.SettlementBatch.name == (settlement_data["RefLot"]["value"]),
                        )
                        .one_or_none()
                    )
                ...
                if settlement:
                    ...
                    settlement = finance_models.Settlement(
                        settlementDate=datetime.date.fromisoformat(settlement_data["Date"]["value"].split("T")[0]),
                        cegidSettlementId=settlement_data["adjgRefNbr"]["value"],
