...
def update_ubble_workflow(
    ...
    override_scores = (not settings.IS_PROD) and user.email.endswith("@ubble.test")

    content = ubble.get_content(fraud_check.thirdPartyId, override_scores=override_scores)
