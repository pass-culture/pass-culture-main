...
DMS_ERROR_MESSAGE_USER_NOT_FOUND = """Bonjour,
                ...
                Ensuite, je t’invite à patienter le temps que ton dossier déposé sur Démarche Numérique soit accepté.
...
def build_field_errors_user_message(field_errors: list[dms_schemas.DmsFieldErrorDetails]) -> str:
    ...
    general_help_article_link = '<a href="https://aide.passculture.app/hc/fr/articles/4411999116433--Jeunes-Où-puis-je-trouver-de-l-aide-concernant-mon-dossier-d-inscription-sur-Démarches-Simplifiées-">Où puis-je trouver de l’aide concernant mon dossier d’inscription sur Démarche Numérique ?</a>'
...
def build_dms_error_message_user_not_eligible(formatted_birth_date: str) -> str:
    return (
        "Bonjour,\n"
        "\n"
        f"Nous avons bien reçu ton dossier, mais la date de naissance que tu as renseignée ({formatted_birth_date}) indique que tu n’as pas l’âge requis pour profiter du pass Culture (tu dois avoir entre 17 et 18 ans).\n"
