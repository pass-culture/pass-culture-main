...
Typology = Literal["digital", "activity", "unselectable"]
...
def is_digital(model: type[Base]) -> bool:
    return "digital" in model._typology.default


def is_activity(model: type[Base]) -> bool:
    return "activity" in model._typology.default


def cannot_be_created(model: type[Base]) -> bool:
    return "unselectable" in model._typology.default


def get_typology(model: type[Base]) -> set[Typology]:
    return model._typology.default
