...
from pcapi.core.offers.defs.models import base
...
def build_schemas(models: typing.Collection[type[base.Base]]) -> typing.Collection[types.ModelSchema]:
    schemas = []
    base_model = parse_api.build_model_fields(base.Base)
...
def format_model_to_schema(base_model: set[base_types.Field], model: type[base.Base]) -> types.ModelSchema:
    ...
    return types.ModelSchema(
        ...
        properties=types.Properties(
            ...
            typology=base.get_typology(model),
        ),
    )
