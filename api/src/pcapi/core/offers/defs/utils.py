...
def extract_subcategory(model: type[base_models.Base]) -> subcategories.Subcategory:
...
def _fetch_models() -> dict[str, type[base_models.Base]]:
    def import_pkg(module_name: str) -> typing.Any:
        return import_module("." + module_name, "pcapi.core.offers.defs.models")  # nosemgrep
    ...
    for module in modules:
        for item in dir(module):
            ...
            if getattr(obj, "__module__", None) != module.__name__:
                # obj is a model but it is not defined inside this
                # module, but imported by it
                continue
