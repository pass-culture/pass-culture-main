...
def build_model_and_subcategory_fields_diff_status(
    model: type[base_models.Base], subcategory: subcategories.Subcategory
) -> types.DiffStatus:
...
def build_typology_diff(subcategory: subcategories.Subcategory, model: type[base_models.Base]) -> types.TypologyDiff:
