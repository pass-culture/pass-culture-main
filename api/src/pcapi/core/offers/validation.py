...
from pcapi.core.offerers.utils import get_currency
from pcapi.core.offers import exceptions
from pcapi.core.offers import models
from pcapi.core.offers import repository
from pcapi.core.offers.constants import PRICE_TABLE_ENTRY_MAX_PRICE_BY_CURRENCY
...
def check_stock_price(
    ...
    currency = get_currency(offer.venue)
    price_in_currency = finance_utils.euros_to_currency(price, currency)
    max_price = PRICE_TABLE_ENTRY_MAX_PRICE_BY_CURRENCY[currency]
    currency_name = finance_utils.to_currency_name(currency)
