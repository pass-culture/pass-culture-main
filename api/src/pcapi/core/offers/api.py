...
def _deactivate_any_offer(offer: AnyOffer) -> None:
...
def _activate_any_offer(offer: AnyOffer) -> None:
    # do not active an offer because this would mean setting the
    # `publicationDatetime`. Let the main caller handle it (this auxiliary
    # function might override the expected value to now).
    if not isinstance(offer, models.Offer):
        offer.isActive = True
