...
def check_can_move_offer(offer: models.Offer, only_event: bool = True) -> list[offerers_models.Venue]:
    if only_event and not offer.isEvent:
...
def move_offer(
    ...
    venue_choices = check_can_move_offer(offer, only_event=only_event)
