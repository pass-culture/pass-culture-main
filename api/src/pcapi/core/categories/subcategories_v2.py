...
VOD = Subcategory(
    ...
    is_event=False,
    conditional_fields={
        ExtraDataFieldEnum.OFFER_URL.value: FieldCondition(is_required_in_external_form=True),
    },
    can_expire=False,
    can_be_duo=False,
    can_be_educational=False,
...
ABO_PLATEFORME_VIDEO = Subcategory(
    ...
    homepage_label_name=HomepageLabels.FILMS.name,
    is_event=False,
    conditional_fields={ExtraDataFieldEnum.OFFER_URL.value: FieldCondition(is_required_in_external_form=True)},
    can_expire=False,
    can_be_duo=False,
    can_be_educational=False,
    online_offline_platform=OnlineOfflinePlatformChoices.ONLINE.value,
...
RENCONTRE_EN_LIGNE = Subcategory(
    ...
    is_event=True,
    conditional_fields={
        ExtraDataFieldEnum.SPEAKER.value: FieldCondition(),
        ExtraDataFieldEnum.OFFER_URL.value: FieldCondition(is_required_in_external_form=True),
    },
    can_expire=False,
    can_be_duo=False,
...
ACTIVATION_EVENT = Subcategory(
    ...
    is_event=True,
    conditional_fields={
        ExtraDataFieldEnum.OFFER_URL.value: FieldCondition(is_required_in_external_form=False),
    },
    can_expire=False,
    can_be_duo=False,
    can_be_educational=False,
