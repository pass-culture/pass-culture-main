...
class SearchNode:
    def __init__(
        ...
        self.label = label
        self.technical_name = technical_name or self.id
        self.gtls = gtls
...
class NativeCategory(SearchNode):
    ...
    def __new__(cls, *args, **kwargs) -> "NativeCategory":  # type: ignore[no-untyped-def]
        obj = super().__new__(cls)
        if "instances" not in cls.__dict__:
            cls.instances = []
...
def book_nodes() -> list[BookGenre]:
    ...
    for book_type in book_types:
        parent = BookGenre(
            ...
            parents=[NativeCategory_LIVRES_PAPIER.id],
...
def movie_nodes() -> list[MovieGenre]:
    return [
        MovieGenre(
            ...
            parents=[NativeCategory_SEANCES_DE_CINEMA.id],
        )
        for movie_type in movie_types
    ]


def music_nodes() -> list[MusicGenre]:
    nodes = []
...
NativeCategory_PRATIQUE_ARTISTIQUE_EN_LIGNE = NativeCategory(
...
BOOK_GENRES: list[BookGenre] = book_nodes()
MOVIE_GENRES: list[MovieGenre] = movie_nodes()
MUSIC_GENRES: list[MusicGenre] = music_nodes()
SHOW_GENRES: list[ShowGenre] = show_nodes()
...
class Subcategory:
    ...
    def __post_init__(self) -> None:
        if self.search_group_name not in [s.technical_name for s in SEARCH_GROUPS]:
    ...
    def native_category_id(self) -> str:
        return self.native_category.technical_name
...
SUPPORT_PHYSIQUE_FILM = Subcategory(
    ...
    native_category=NativeCategory_DVD_BLU_RAY,
    pro_label="Support physique (DVD, Blu-ray...)",
    app_label="Support physique (DVD, Blu-ray...)",
    search_group_name=SearchGroup_FILMS_SERIES_CINEMA.technical_name,
...
ABO_MEDIATHEQUE = Subcategory(
    id="ABO_MEDIATHEQUE",
    category=categories.FILM,
    native_category=NativeCategory_BIBLIOTHEQUE_MEDIATHEQUE,
    pro_label="Abonnement médiathèque",
    app_label="Abonnement médiathèque",
    search_group_name=SearchGroup_LIVRES.technical_name,
    homepage_label_name=HomepageLabels.FILMS.name,
    is_event=False,
    conditional_fields={},
    can_expire=True,
...
VOD = Subcategory(
    id="VOD",
    category=categories.FILM,
    native_category=NativeCategory_FILMS_SERIES_EN_LIGNE,
...
CARTE_CINE_MULTISEANCES = Subcategory(
    ...
    native_category=NativeCategory_CARTES_CINEMA,
...
SEANCE_CINE = Subcategory(
    id="SEANCE_CINE",
    category=categories.CINEMA,
    native_category=NativeCategory_SEANCES_DE_CINEMA,
...
EVENEMENT_CINE = Subcategory(
    id="EVENEMENT_CINE",
    category=categories.CINEMA,
    native_category=NativeCategory_EVENEMENTS_CINEMA,
...
CONFERENCE = Subcategory(
    ...
    native_category=NativeCategory_CONFERENCES,
    pro_label="Conférence",
    app_label="Conférence",
    search_group_name=SearchGroup_RENCONTRES_CONFERENCES.technical_name,
...
RENCONTRE = Subcategory(
    id="RENCONTRE",
    category=categories.CONFERENCE_RENCONTRE,
    native_category=NativeCategory_RENCONTRES,
    pro_label="Rencontre",
    app_label="Rencontre",
    search_group_name=SearchGroup_RENCONTRES_CONFERENCES.technical_name,
    homepage_label_name=HomepageLabels.RENCONTRES.name,
...
DECOUVERTE_METIERS = Subcategory(
    ...
    category=categories.CONFERENCE_RENCONTRE,
    native_category=NativeCategory_SALONS_ET_METIERS,
...
RENCONTRE_EN_LIGNE = Subcategory(
    ...
    category=categories.CONFERENCE_RENCONTRE,
    native_category=NativeCategory_RENCONTRES_EN_LIGNE,
...
CONCOURS = Subcategory(
    ...
    native_category=NativeCategory_CONCOURS,
    pro_label="Concours - jeux",
    app_label="Concours - jeux",
    search_group_name=SearchGroup_JEUX_JEUX_VIDEOS.technical_name,
...
RENCONTRE_JEU = Subcategory(
    id="RENCONTRE_JEU",
    category=categories.JEU,
    native_category=NativeCategory_RENCONTRES_EVENEMENTS,
...
ESCAPE_GAME = Subcategory(
    id="ESCAPE_GAME",
    category=categories.JEU,
    native_category=NativeCategory_ESCAPE_GAMES,
...
JEU_EN_LIGNE = Subcategory(
    id="JEU_EN_LIGNE",
    category=categories.JEU,
    native_category=NativeCategory_JEUX_EN_LIGNE,
...
ABO_LUDOTHEQUE = Subcategory(
    id="ABO_LUDOTHEQUE",
    category=categories.JEU,
    native_category=NativeCategory_LUDOTHEQUE,
...
LIVRE_PAPIER = Subcategory(
    ...
    native_category=NativeCategory_LIVRES_PAPIER,
...
LIVRE_NUMERIQUE = Subcategory(
    id="LIVRE_NUMERIQUE",
    category=categories.LIVRE,
    native_category=NativeCategory_LIVRES_NUMERIQUE_ET_AUDIO,
...
LIVRE_AUDIO_PHYSIQUE = Subcategory(
    ...
    category=categories.LIVRE,
    native_category=NativeCategory_LIVRES_AUDIO_PHYSIQUES,
...
FESTIVAL_LIVRE = Subcategory(
    id="FESTIVAL_LIVRE",
    category=categories.LIVRE,
    native_category=NativeCategory_FESTIVAL_DU_LIVRE,
...
CARTE_JEUNES = Subcategory(
    ...
    native_category=NativeCategory_CARTES_JEUNES,
    pro_label="Carte jeunes",
    app_label="Carte jeunes",
    search_group_name=SearchGroup_CARTES_JEUNES.technical_name,
...
CARTE_MUSEE = Subcategory(
    ...
    native_category=NativeCategory_ABONNEMENTS_MUSEE,
    pro_label="Abonnement musée, carte ou pass",
    app_label="Abonnement musée, carte ou pass",
    search_group_name=SearchGroup_MUSEES_VISITES_CULTURELLES.technical_name,
...
VISITE = Subcategory(
    id="VISITE",
    category=categories.MUSEE,
    native_category=NativeCategory_VISITES_CULTURELLES,
    pro_label="Visite",
    app_label="Visite",
    search_group_name=SearchGroup_MUSEES_VISITES_CULTURELLES.technical_name,
...
EVENEMENT_PATRIMOINE = Subcategory(
    ...
    category=categories.MUSEE,
    native_category=NativeCategory_EVENEMENTS_PATRIMOINE,
...
VISITE_VIRTUELLE = Subcategory(
    id="VISITE_VIRTUELLE",
    category=categories.MUSEE,
    native_category=NativeCategory_VISITES_CULTURELLES_EN_LIGNE,
...
FESTIVAL_ART_VISUEL = Subcategory(
    ...
    category=categories.MUSEE,
    native_category=NativeCategory_ARTS_VISUELS,
...
CONCERT = Subcategory(
    ...
    native_category=NativeCategory_CONCERTS_EVENEMENTS,
    pro_label="Concert",
    app_label="Concert",
    search_group_name=SearchGroup_CONCERTS_FESTIVALS.technical_name,
...
LIVESTREAM_MUSIQUE = Subcategory(
    ...
    category=categories.MUSIQUE_LIVE,
    native_category=NativeCategory_CONCERTS_EN_LIGNE,
    pro_label="Livestream musical",
    app_label="Livestream musical",
    search_group_name=SearchGroup_EVENEMENTS_EN_LIGNE.technical_name,
...
FESTIVAL_MUSIQUE = Subcategory(
    id="FESTIVAL_MUSIQUE",
    category=categories.MUSIQUE_LIVE,
    native_category=NativeCategory_FESTIVALS,
...
SUPPORT_PHYSIQUE_MUSIQUE_CD = Subcategory(
    ...
    native_category=NativeCategory_CD,
    pro_label="CD",
    app_label="CD",
    search_group_name=SearchGroup_CD_VINYLE_MUSIQUE_EN_LIGNE.technical_name,
    homepage_label_name=HomepageLabels.MUSIQUE.name,
    is_event=False,
    conditional_fields={
        ExtraDataFieldEnum.AUTHOR.value: FieldCondition(),
...
SUPPORT_PHYSIQUE_MUSIQUE_VINYLE = Subcategory(
    ...
    category=categories.MUSIQUE_ENREGISTREE,
    native_category=NativeCategory_VINYLES,
...
TELECHARGEMENT_MUSIQUE = Subcategory(
    ...
    category=categories.MUSIQUE_ENREGISTREE,
    native_category=NativeCategory_MUSIQUE_EN_LIGNE,
...
CAPTATION_MUSIQUE = Subcategory(
    ...
    category=categories.MUSIQUE_ENREGISTREE,
    native_category=NativeCategory_PRATIQUES_ET_ATELIERS_ARTISTIQUES,
    pro_label="Captation musicale",
    app_label="Captation musicale",
    search_group_name=SearchGroup_ARTS_LOISIRS_CREATIFS.technical_name,
    homepage_label_name=HomepageLabels.MUSIQUE.name,
    is_event=False,
    conditional_fields={
        ExtraDataFieldEnum.AUTHOR.value: FieldCondition(),
...
PRATIQUE_ART_VENTE_DISTANCE = Subcategory(
    ...
    category=categories.PRATIQUE_ART,
    native_category=NativeCategory_PRATIQUE_ARTISTIQUE_EN_LIGNE,
...
ABO_PRESSE_EN_LIGNE = Subcategory(
    ...
    native_category=NativeCategory_PRESSE_EN_LIGNE,
    pro_label="Abonnement presse en ligne",
    app_label="Abonnement presse en ligne",
    search_group_name=SearchGroup_MEDIA_PRESSE.technical_name,
...
PODCAST = Subcategory(
    id="PODCAST",
    category=categories.MEDIA,
    native_category=NativeCategory_PODCAST,
    pro_label="Podcast",
    app_label="Podcast",
    search_group_name=SearchGroup_MEDIA_PRESSE.technical_name,
    homepage_label_name=HomepageLabels.MEDIAS.name,
...
APP_CULTURELLE = Subcategory(
    id="APP_CULTURELLE",
    category=categories.MEDIA,
    native_category=NativeCategory_AUTRES_MEDIAS,
...
SPECTACLE_REPRESENTATION = Subcategory(
    ...
    native_category=NativeCategory_SPECTACLES_REPRESENTATIONS,
    pro_label="Spectacle, représentation",
    app_label="Spectacle, représentation",
    search_group_name=SearchGroup_SPECTACLES.technical_name,
...
SPECTACLE_ENREGISTRE = Subcategory(
    ...
    category=categories.SPECTACLE,
    native_category=NativeCategory_SPECTACLES_ENREGISTRES,
...
ABO_SPECTACLE = Subcategory(
    id="ABO_SPECTACLE",
    category=categories.SPECTACLE,
    native_category=NativeCategory_ABONNEMENTS_SPECTACLE,
...
ACHAT_INSTRUMENT = Subcategory(
    ...
    native_category=NativeCategory_ACHAT_LOCATION_INSTRUMENT,
    pro_label="Achat instrument",
    app_label="Achat instrument",
    search_group_name=SearchGroup_INSTRUMENTS.technical_name,
...
PARTITION = Subcategory(
    id="PARTITION",
    category=categories.INSTRUMENT,
    native_category=NativeCategory_PARTITIONS_DE_MUSIQUE,
    pro_label="Partition",
    app_label="Partition",
    search_group_name=SearchGroup_INSTRUMENTS.technical_name,
    homepage_label_name=HomepageLabels.INSTRUMENT.name,
...
MATERIEL_ART_CREATIF = Subcategory(
    ...
    native_category=NativeCategory_MATERIELS_CREATIFS,
...
ACTIVATION_EVENT = Subcategory(
    ...
    search_group_name=SearchGroup_NONE.technical_name,
    ...
    is_selectable=False,
    is_bookable_by_underage_when_not_free=False,
    native_category=NativeCategory_DEPRECIEE,
)
...
JEU_SUPPORT_PHYSIQUE = Subcategory(
    ...
    category=categories.TECHNIQUE,
    native_category=NativeCategory_JEUX_PHYSIQUES,
...
SearchGroupNameEnumv2 = Enum(  # type: ignore[misc]
    ...
    {search_group_name: search_group_name for search_group_name in [c.technical_name for c in SEARCH_GROUPS]},
)
...
NativeCategoryIdEnumv2 = Enum(  # type: ignore[misc]
    ...
    {native_category.technical_name: native_category.technical_name for native_category in NativeCategory.instances},
)
