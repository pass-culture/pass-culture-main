...
class Subcategory:
    ...
    native_categories: list[NativeCategory]
    pro_label: str
    app_label: str
    ...
    def __post_init__(self) -> None:
        if self.search_groups not in [s.id for s in SEARCH_GROUPS]:
    ...
    def native_category_id(self) -> str:
        return self.native_categories.id
...
SUPPORT_PHYSIQUE_FILM = Subcategory(
    ...
    native_categories=[NATIVE_CATEGORY_DVD_BLU_RAY],
    pro_label="Support physique (DVD, Blu-ray...)",
    app_label="Support physique (DVD, Blu-ray...)",
    search_groups=[SEARCH_GROUP_FILMS_SERIES_CINEMA, SEARCH_GROUP_FILMS_DOCUMENTAIRES_SERIES],
...
ABO_MEDIATHEQUE = Subcategory(
    id="ABO_MEDIATHEQUE",
    category=categories.FILM,
    native_categories=[NATIVE_CATEGORY_BIBLIOTHEQUE_MEDIATHEQUE],
    pro_label="Abonnement médiathèque",
    app_label="Abonnement médiathèque",
    search_groups=[SEARCH_GROUP_LIVRES],
    homepage_label_name=HomepageLabels.FILMS.name,
    is_event=False,
    conditional_fields={},
    can_expire=True,
...
VOD = Subcategory(
    id="VOD",
    category=categories.FILM,
    native_categories=[NATIVE_CATEGORY_VIDEOS_ET_DOCUMENTAIRES],
...
ABO_PLATEFORME_VIDEO = Subcategory(
    ...
    category=categories.FILM,
    native_categories=[NATIVE_CATEGORY_ABO_PLATEFORME_VIDEO],
...
CARTE_CINE_MULTISEANCES = Subcategory(
    ...
    native_categories=[NATIVE_CATEGORY_CARTES_CINEMA],
    pro_label="Carte cinéma multi-séances",
    app_label="Carte cinéma multi-séances",
    search_groups=[SEARCH_GROUP_FILMS_SERIES_CINEMA, SEARCH_GROUP_CINEMA],
...
SEANCE_CINE = Subcategory(
    id="SEANCE_CINE",
    category=categories.CINEMA,
    native_categories=[NATIVE_CATEGORY_SEANCES_DE_CINEMA],
...
EVENEMENT_CINE = Subcategory(
    id="EVENEMENT_CINE",
    category=categories.CINEMA,
    native_categories=[NATIVE_CATEGORY_EVENEMENTS_CINEMA],
...
CONFERENCE = Subcategory(
    ...
    native_categories=[NATIVE_CATEGORY_CONFERENCES],
    pro_label="Conférence",
    app_label="Conférence",
    search_groups=[SEARCH_GROUP_RENCONTRES_CONFERENCES],
...
RENCONTRE = Subcategory(
    id="RENCONTRE",
    category=categories.CONFERENCE_RENCONTRE,
    native_categories=[NATIVE_CATEGORY_RENCONTRES],
    pro_label="Rencontre",
    app_label="Rencontre",
    search_groups=[SEARCH_GROUP_RENCONTRES_CONFERENCES],
    homepage_label_name=HomepageLabels.RENCONTRES.name,
...
DECOUVERTE_METIERS = Subcategory(
    ...
    category=categories.CONFERENCE_RENCONTRE,
    native_categories=[NATIVE_CATEGORY_SALONS_ET_METIERS],
...
RENCONTRE_EN_LIGNE = Subcategory(
    ...
    category=categories.CONFERENCE_RENCONTRE,
    native_categories=[NATIVE_CATEGORY_RENCONTRES_EN_LIGNE],
...
CONCOURS = Subcategory(
    ...
    native_categories=[NATIVE_CATEGORY_CONCOURS],
    pro_label="Concours - jeux",
    app_label="Concours - jeux",
    search_groups=[SEARCH_GROUP_JEUX_JEUX_VIDEOS],
...
RENCONTRE_JEU = Subcategory(
    id="RENCONTRE_JEU",
    category=categories.JEU,
    native_categories=[NATIVE_CATEGORY_RENCONTRES_EVENEMENTS],
...
ESCAPE_GAME = Subcategory(
    id="ESCAPE_GAME",
    category=categories.JEU,
    native_categories=[NATIVE_CATEGORY_ESCAPE_GAMES],
...
JEU_EN_LIGNE = Subcategory(
    id="JEU_EN_LIGNE",
    category=categories.JEU,
    native_categories=[NATIVE_CATEGORY_JEUX_EN_LIGNE],
...
ABO_LUDOTHEQUE = Subcategory(
    id="ABO_LUDOTHEQUE",
    category=categories.JEU,
    native_categories=[NATIVE_CATEGORY_LUDOTHEQUE],
...
LIVRE_PAPIER = Subcategory(
    ...
    native_categories=[NATIVE_CATEGORY_LIVRES_PAPIER],
...
LIVRE_NUMERIQUE = Subcategory(
    id="LIVRE_NUMERIQUE",
    category=categories.LIVRE,
    native_categories=[NATIVE_CATEGORY_LIVRES_NUMERIQUE_ET_AUDIO],
...
LIVRE_AUDIO_PHYSIQUE = Subcategory(
    ...
    category=categories.LIVRE,
    native_categories=[NATIVE_CATEGORY_LIVRES_AUDIO_PHYSIQUES],
...
FESTIVAL_LIVRE = Subcategory(
    id="FESTIVAL_LIVRE",
    category=categories.LIVRE,
    native_categories=[NATIVE_CATEGORY_FESTIVAL_DU_LIVRE],
...
CARTE_JEUNES = Subcategory(
    ...
    search_groups=[SEARCH_GROUP_CARTES_JEUNES],
...
CARTE_MUSEE = Subcategory(
    ...
    native_categories=[NATIVE_CATEGORY_ABONNEMENTS_MUSEE],
    pro_label="Abonnement musée, carte ou pass",
    app_label="Abonnement musée, carte ou pass",
    search_groups=[SEARCH_GROUP_MUSEES_VISITES_CULTURELLES],
...
VISITE = Subcategory(
    id="VISITE",
    category=categories.MUSEE,
    native_categories=[NATIVE_CATEGORY_VISITES_CULTURELLES],
    pro_label="Visite",
    app_label="Visite",
    search_groups=[SEARCH_GROUP_MUSEES_VISITES_CULTURELLES],
...
EVENEMENT_PATRIMOINE = Subcategory(
    ...
    category=categories.MUSEE,
    native_categories=[NATIVE_CATEGORY_EVENEMENTS_PATRIMOINE],
...
VISITE_VIRTUELLE = Subcategory(
    id="VISITE_VIRTUELLE",
    category=categories.MUSEE,
    native_categories=[NATIVE_CATEGORY_VISITES_CULTURELLES_EN_LIGNE],
...
FESTIVAL_ART_VISUEL = Subcategory(
    ...
    category=categories.MUSEE,
    native_categories=[NATIVE_CATEGORY_ARTS_VISUELS],
...
CONCERT = Subcategory(
    ...
    native_categories=[NATIVE_CATEGORY_CONCERTS_EVENEMENTS],
    pro_label="Concert",
    app_label="Concert",
    search_groups=[SEARCH_GROUP_CONCERTS_FESTIVALS, SEARCH_GROUP_MUSIQUE],
...
LIVESTREAM_MUSIQUE = Subcategory(
    ...
    category=categories.MUSIQUE_LIVE,
    native_categories=[NATIVE_CATEGORY_CONCERTS_EN_LIGNE],
    pro_label="Livestream musical",
    app_label="Livestream musical",
    search_groups=[SEARCH_GROUP_EVENEMENTS_EN_LIGNE],
...
FESTIVAL_MUSIQUE = Subcategory(
    id="FESTIVAL_MUSIQUE",
    category=categories.MUSIQUE_LIVE,
    native_categories=[NATIVE_CATEGORY_FESTIVALS],
...
SUPPORT_PHYSIQUE_MUSIQUE_CD = Subcategory(
    ...
    native_categories=[NATIVE_CATEGORY_CD],
    pro_label="CD",
    app_label="CD",
    search_groups=[SEARCH_GROUP_CD_VINYLE_MUSIQUE_EN_LIGNE, SEARCH_GROUP_MUSIQUE],
    homepage_label_name=HomepageLabels.MUSIQUE.name,
    is_event=False,
    conditional_fields={
        ExtraDataFieldEnum.AUTHOR.value: FieldCondition(),
...
SUPPORT_PHYSIQUE_MUSIQUE_VINYLE = Subcategory(
    ...
    category=categories.MUSIQUE_ENREGISTREE,
    native_categories=[NATIVE_CATEGORY_VINYLES],
...
TELECHARGEMENT_MUSIQUE = Subcategory(
    ...
    category=categories.MUSIQUE_ENREGISTREE,
    native_categories=[NATIVE_CATEGORY_MUSIQUE_EN_LIGNE],
...
CAPTATION_MUSIQUE = Subcategory(
    ...
    category=categories.MUSIQUE_ENREGISTREE,
    native_categories=[NATIVE_CATEGORY_PRATIQUES_ET_ATELIERS_ARTISTIQUES],
    pro_label="Captation musicale",
    app_label="Captation musicale",
    search_groups=[SEARCH_GROUP_ARTS_LOISIRS_CREATIFS],
    homepage_label_name=HomepageLabels.MUSIQUE.name,
    is_event=False,
    conditional_fields={
        ExtraDataFieldEnum.AUTHOR.value: FieldCondition(),
...
PRATIQUE_ART_VENTE_DISTANCE = Subcategory(
    ...
    category=categories.PRATIQUE_ART,
    native_categories=[NATIVE_CATEGORY_PRATIQUE_ARTISTIQUE_EN_LIGNE],
...
ABO_PRESSE_EN_LIGNE = Subcategory(
    ...
    native_categories=[NATIVE_CATEGORY_PRESSE_EN_LIGNE],
    pro_label="Abonnement presse en ligne",
    app_label="Abonnement presse en ligne",
    search_groups=[SEARCH_GROUP_MEDIA_PRESSE],
...
PODCAST = Subcategory(
    id="PODCAST",
    category=categories.MEDIA,
    native_categories=[NATIVE_CATEGORY_PODCAST],
    pro_label="Podcast",
    app_label="Podcast",
    search_groups=[SEARCH_GROUP_MEDIA_PRESSE],
    homepage_label_name=HomepageLabels.MEDIAS.name,
...
APP_CULTURELLE = Subcategory(
    id="APP_CULTURELLE",
    category=categories.MEDIA,
    native_categories=[NATIVE_CATEGORY_AUTRES_MEDIAS],
...
SPECTACLE_REPRESENTATION = Subcategory(
    ...
    native_categories=[NATIVE_CATEGORY_SPECTACLES_REPRESENTATIONS],
    pro_label="Spectacle, représentation",
    app_label="Spectacle, représentation",
    search_groups=[SEARCH_GROUP_SPECTACLES],
...
SPECTACLE_ENREGISTRE = Subcategory(
    ...
    category=categories.SPECTACLE,
    native_categories=[NATIVE_CATEGORY_SPECTACLES_ENREGISTRES],
...
ABO_SPECTACLE = Subcategory(
    id="ABO_SPECTACLE",
    category=categories.SPECTACLE,
    native_categories=[NATIVE_CATEGORY_ABONNEMENTS_SPECTACLE],
...
ACHAT_INSTRUMENT = Subcategory(
    ...
    native_categories=[NATIVE_CATEGORY_ACHAT_LOCATION_INSTRUMENT],
    pro_label="Achat instrument",
    app_label="Achat instrument",
    search_groups=[SEARCH_GROUP_INSTRUMENTS, SEARCH_GROUP_MUSIQUE],
...
PARTITION = Subcategory(
    id="PARTITION",
    category=categories.INSTRUMENT,
    native_categories=[NATIVE_CATEGORY_PARTITIONS_DE_MUSIQUE],
    pro_label="Partition",
    app_label="Partition",
    search_groups=[SEARCH_GROUP_INSTRUMENTS, SEARCH_GROUP_MUSIQUE],
    homepage_label_name=HomepageLabels.INSTRUMENT.name,
...
MATERIEL_ART_CREATIF = Subcategory(
    ...
    native_categories=[NATIVE_CATEGORY_MATERIELS_CREATIFS],
...
ACTIVATION_EVENT = Subcategory(
    ...
    is_selectable=False,
    is_bookable_by_underage_when_not_free=False,
    native_categories=[NATIVE_CATEGORY_DEPRECIEE],
)
...
JEU_SUPPORT_PHYSIQUE = Subcategory(
    ...
    category=categories.TECHNIQUE,
    native_categories=[NATIVE_CATEGORY_JEUX_PHYSIQUES],
