...
def get_venue_street(booking: Booking) -> str | None:
    return booking.stock.offer.venue.offererAddress.address.street if booking.stock.offer.venue.offererAddress else None
