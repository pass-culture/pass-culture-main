...
def get_booking_confirmation_to_beneficiary_email_data(
    ...
    department_code = (
        venue.offererAddress.address.departmentCode if not offer.isDigital else beneficiary.departementCode
    )
    ...
    return models.TransactionalEmailData(
        ...
        params={
            ...
            "VENUE_POSTAL_CODE": venue.offererAddress.address.postalCode if venue.offererAddress else None,
            "VENUE_CITY": venue.offererAddress.address.city if venue.offererAddress else None,
