...
class TransactionalEmail(Enum):
    ...
    BONIFICATION_GRANTED = models.Template(id_prod=1669, id_not_prod=1669, send_to_ehp=True)
    BONIFICATION_DECLINED = models.Template(id_prod=1670, id_not_prod=1670, send_to_ehp=True)
