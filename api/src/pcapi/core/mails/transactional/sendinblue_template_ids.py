...
class TransactionalEmail(Enum):
    ...
    NON_PAYMENT_NOTICE_WITHOUT_CONTINUATION = models.TemplatePro(id_prod=0, id_not_prod=0)  # TODO ids
    NON_PAYMENT_NOTICE_CLOSED = models.TemplatePro(id_prod=0, id_not_prod=0)  # TODO ids
