...
class TransactionalEmail(Enum):
    ...
    EAC_ONE_DAY_AFTER_EVENT = models.TemplatePro(id_prod=24, id_not_prod=25)
    EAC_ONE_DAY_BEFORE_EVENT = models.TemplatePro(id_prod=23, id_not_prod=23)
    ...
    EDUCATIONAL_BOOKING_CANCELLATION = models.TemplatePro(id_prod=17, id_not_prod=17)
