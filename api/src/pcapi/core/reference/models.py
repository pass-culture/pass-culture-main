...
class ReferenceScheme(Model):
    ...
    name: sa_orm.Mapped[str] = sa.orm.mapped_column(sa.Text, nullable=False)
    prefix: sa_orm.Mapped[str] = sa.orm.mapped_column(sa.Text, nullable=False)
    year = sa.orm.mapped_column(sa.Integer)
    nextNumber = sa.orm.mapped_column(sa.Integer, default=1)
    numberPadding = sa.orm.mapped_column(sa.Integer, default=7)
