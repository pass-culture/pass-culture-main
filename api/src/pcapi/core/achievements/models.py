...
class AchievementType(enum.Enum):
    FIRST_ADD_FAVORITE = "FIRST_ADD_FAVORITE"
    SECOND_ADD_FAVORITE = "SECOND_ADD_FAVORITE"
    THIRD_ADD_FAVORITE = "THIRD_ADD_FAVORITE"
    FIRST_WATCH_MOVIE = "FIRST_WATCH_MOVIE"
    SECOND_WATCH_MOVIE = "SECOND_WATCH_MOVIE"
    THIRD_WATCH_MOVIE = "THIRD_WATCH_MOVIE"
