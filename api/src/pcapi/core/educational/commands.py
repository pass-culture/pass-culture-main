...
@click.option(
    ...
    help="""
        ...
        - EDUCATIONAL_YEAR: period = full educational year
        - FIRST_CIVIL_YEAR: period = educational year first civil year (september start -> december end)
        - SECOND_CIVIL_YEAR: period = educational year second civil year (january start -> august end)
    """,
)
