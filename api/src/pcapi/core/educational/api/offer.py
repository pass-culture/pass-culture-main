...
def _update_collective_offer(
    ...
    if edit_domains or edit_national_program:
        domains_to_check = new_values["domains"] if edit_domains else offer.domains
        program_id_to_check = national_program_id if edit_national_program else offer.nationalProgramId
