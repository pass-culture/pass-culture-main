...
def check_can_move_collective_offer_venue(
    ...
    venues_choices = offerers_repository.get_offerers_venues_with_pricing_point(
        ...
        check_pricing_points=not with_restrictions,
...
def move_collective_offer_venue(
    ...
    for collective_booking in collective_bookings:
        ...
        if with_restrictions:
            finance_events = collective_booking.finance_events[:1] if collective_booking.finance_events else None
        else:
            finance_events = collective_booking.finance_events if collective_booking.finance_events else None
