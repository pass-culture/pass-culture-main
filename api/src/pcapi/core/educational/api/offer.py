...
def list_collective_offers_for_pro_user(
    ...
    if offer_type is None or offer_type == collective_offers_serialize.CollectiveOfferType.offer:
        offers = repository.get_collective_offers_for_filters(filters=filters, offers_limit=OFFERS_RECAP_LIMIT)
        all_offers.extend(offers)

    if offer_type is None or offer_type == collective_offers_serialize.CollectiveOfferType.template:
