...
def synchronize_adage_ids_on_venues(timestamp: int | None = None) -> None:
    ...
    with atomic():
        ...
        for venue in venues:
            ...
            venue.adageId = venue_to_adage_id[venue.id]
        ...
        address_api.unlink_deactivated_venue_addresses(deactivated_adage_venues_ids)
