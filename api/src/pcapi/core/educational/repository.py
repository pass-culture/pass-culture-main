...
def _get_collective_offer_template_address_joinedload() -> tuple[sa_orm.strategy_options._AbstractLoad, ...]:
    """
...
def _get_collective_offer_address_joinedload() -> tuple[sa_orm.interfaces.LoaderOption, ...]:
    """
