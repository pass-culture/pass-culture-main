...
class CollectiveOffer(
    ...
    @classmethod
    def is_expired_expression(cls) -> sa_elements.UnaryExpression:
...
class CollectiveStock(PcObject, models.Model):
    ...
    @classmethod
    def hasBookingLimitDatetimePassedExpression(cls) -> sa_elements.BinaryExpression:
    ...
    @hasStartDatetimePassed.inplace.expression
    @classmethod
    def hasStartDatetimePassedExpression(cls) -> sa_elements.BinaryExpression:
    ...
    @hasEndDatetimePassed.inplace.expression
    @classmethod
    def hasEndDatetimePassedExpression(cls) -> sa_elements.BinaryExpression:
    ...
    @classmethod
    def isEventExpiredExpression(cls):
        return cls.startDatetime <= sa.func.now()
...
class EducationalYear(PcObject, models.Model):
    ...
    @classmethod
    def displayed_year_expression(cls) -> str:
        return (
...
class CollectiveBooking(PcObject, models.Model):
    ...
    @classmethod
    def isConfirmedExpression(cls) -> sa_elements.BinaryExpression:
    ...
    @classmethod
    def is_used_or_reimbursed_expression(cls) -> sa_elements.BinaryExpression:
    ...
    @classmethod
    def isReimbursedExpression(cls) -> sa_elements.BinaryExpression:
    ...
    @classmethod
    def isCancelledExpression(cls) -> sa_elements.BinaryExpression:
    ...
    @classmethod
    def validated_incident_id_expression(cls) -> int | None:
        return (
...
class CollectiveDmsApplication(PcObject, models.Model):
    ...
    @classmethod
    def siren_expression(cls) -> sa.String:
...
class CollectiveOfferRequest(PcObject, models.Model):
    ...
    @classmethod
    def phoneNumberExpression(cls) -> str | None:
