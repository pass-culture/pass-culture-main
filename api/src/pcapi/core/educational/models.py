...
class CollectiveOfferRejectionReasons(enum.Enum):
...
class CollectiveOffer(
    ...
    rejectionReason: CollectiveOfferRejectionReasons | None = sa.Column(
        MagicEnum(CollectiveOfferRejectionReasons), default=None
    )
