...
def update_all_venue_offers_accessibility_job(venue: Venue, accessibility: dict[str, bool]) -> None:
    ...
    educational_offer_api.batch_update_collective_offers(collective_offer_query, accessibility)
    educational_offer_api.batch_update_collective_offers_template(collective_offer_template_query, accessibility)
