...
DMS_VENUE_PROCEDURE_ID_V2 = os.environ.get("DEMARCHES_SIMPLIFIEES_RIB_VENUE_PROCEDURE_ID_V2", 0)
DMS_VENUE_PROCEDURE_ID_V3 = os.environ.get("DEMARCHES_SIMPLIFIEES_RIB_VENUE_PROCEDURE_ID_V3", 0)
...
DS_MARK_WITHOUT_CONTINUATION_INSTRUCTOR_ID = os.environ.get("DS_MARK_WITHOUT_CONTINUATION_INSTRUCTOR_ID", "")
