...
from routes.pro.signup_keys.passwordless_token_keys import PASSWORDLESS_PRIVATE_KEY_TEST
from routes.pro.signup_keys.passwordless_token_keys import PASSWORDLESS_PUBLIC_KEY_TEST
...
# Passwordless signup
PASSWORDLESS_LOGIN_PRIVATE_KEY = secrets_utils.get("PASSWORDLESS_LOGIN_PRIVATE_KEY", PASSWORDLESS_PRIVATE_KEY_TEST)
PASSWORDLESS_LOGIN_PUBLIC_KEY = os.environ.get("PASSWORDLESS_LOGIN_PUBLIC_KEY", PASSWORDLESS_PUBLIC_KEY_TEST)
