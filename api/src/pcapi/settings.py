...
SENDINBLUE_PRO_SUBACCOUNT_INACTIVE_90_DAYS_ID = int(os.environ.get("SENDINBLUE_PRO_SUBACCOUNT_INACTIVE_90_DAYS_ID", 5))
SENDINBLUE_PRO_NO_ACTIVE_OFFERS_40_DAYS_ID = int(os.environ.get("SENDINBLUE_PRO_NO_ACTIVE_OFFERS_40_DAYS_ID", 40))
SENDINBLUE_PRO_SUBACCOUNT_NO_ACTIVE_OFFERS_40_DAYS_ID = int(
    os.environ.get("SENDINBLUE_PRO_SUBACCOUNT_NO_ACTIVE_OFFERS_40_DAYS_ID", 4)
)
SENDINBLUE_PRO_NO_BOOKINGS_40_DAYS_ID = int(os.environ.get("SENDINBLUE_PRO_NO_BOOKINGS_40_DAYS_ID", 41))
SENDINBLUE_PRO_SUBACCOUNT_NO_BOOKINGS_40_DAYS_ID = int(
    os.environ.get("SENDINBLUE_PRO_SUBACCOUNT_NO_BOOKINGS_40_DAYS_ID", 3)
)
SENDINBLUE_PRO_MARKETING_LIVE_SHOW_EMAIL_CHURNED_40_DAYS_AGO = int(
    os.environ.get("SENDINBLUE_PRO_MARKETING_LIVE_SHOW_EMAIL_CHURNED_40_DAYS_AGO", 170)
)
SENDINBLUE_PRO_SUBACCOUNT_MARKETING_LIVE_SHOW_EMAIL_CHURNED_40_DAYS_AGO = int(
    os.environ.get("SENDINBLUE_PRO_SUBACCOUNT_MARKETING_LIVE_SHOW_EMAIL_CHURNED_40_DAYS_AGO", 12)
)
SENDINBLUE_PRO_MARKETING_LIVE_SHOW_EMAIL_LAST_BOOKING_40_DAYS_AGO = int(
    os.environ.get("SENDINBLUE_PRO_MARKETING_LIVE_SHOW_EMAIL_LAST_BOOKING_40_DAYS_AGO", 171)
)
SENDINBLUE_PRO_SUBACCOUNT_MARKETING_LIVE_SHOW_EMAIL_LAST_BOOKING_40_DAYS_AGO = int(
    os.environ.get("SENDINBLUE_PRO_SUBACCOUNT_MARKETING_LIVE_SHOW_EMAIL_LAST_BOOKING_40_DAYS_AGO", 11)
)
...
DS_MARK_WITHOUT_CONTINUATION_APPLICATION_DEADLINE = int(
    os.environ.get("DS_MARK_WITHOUT_CONTINUATION_APPLICATION_DEADLINE", "90")
)
DS_MARK_WITHOUT_CONTINUATION_ANNOTATION_DEADLINE = int(
    os.environ.get("DS_MARK_WITHOUT_CONTINUATION_ANNOTATION_DEADLINE", "180")
)
