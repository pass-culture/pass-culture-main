...
USE_GOOGLE_CREDENTIALS = bool(int(os.environ.get("USE_GOOGLE_CREDENTIALS", 1)))
...
# BACKOFFICE
BACKOFFICE_ENABLE_ADDING_STAGING_PERMISSIONS = bool(int(os.environ.get("BACKOFFICE_ENABLE_ADDING_STAGING_PERMISSIONS", 1)))
