...
ALGOLIA_LAST_30_DAYS_BOOKINGS_LOW_THRESHOLD = int(os.environ.get("ALGOLIA_LAST_30_DAYS_BOOKINGS_LOW_THRESHOLD", 0))
ALGOLIA_LAST_30_DAYS_BOOKINGS_MEDIUM_THRESHOLD = int(
    os.environ.get("ALGOLIA_LAST_30_DAYS_BOOKINGS_MEDIUM_THRESHOLD", 5)
)
ALGOLIA_LAST_30_DAYS_BOOKINGS_HIGH_THRESHOLD = int(os.environ.get("ALGOLIA_LAST_30_DAYS_BOOKINGS_HIGH_THRESHOLD", 20))
