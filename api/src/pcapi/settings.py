...
# SENTRY
SENTRY_DSN = os.environ.get("SENTRY_DSN", "https://0470142cf8d44893be88ecded2a14e42@sentry.internal-passculture.app/5")
...
DMS_INSTRUCTOR_ID = os.environ.get("DMS_INSTRUCTOR_ID")
...
GCP_SENDINBLUE_TRANSACTIONAL_EMAILS_QUEUE_NAME = os.environ.get("GCP_SENDINBLUE_TRANSACTIONAL_EMAILS_QUEUE_NAME")
