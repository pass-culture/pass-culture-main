...
CHECK_OFFERER_RATE_LIMIT_THRESHOLD = int(os.environ.get("CHECK_OFFERER_RATE_LIMIT_THRESHOLD", 1))
CHECK_OFFERER_RATE_LIMIT_TIME_WINDOW_SECONDS = int(os.environ.get("CHECK_OFFERER_RATE_LIMIT_TIME_WINDOW_SECONDS", 10))
