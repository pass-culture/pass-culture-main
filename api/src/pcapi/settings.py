...
# SENTRY
SENTRY_ENABLED = bool(int(os.environ.get("SENTRY_ENABLED", 1)))
...
ENABLE_USER_CREATION_OR_UPDATE = bool(int(os.environ.get("SEND_TRANSACTIONNAL_EMAIL", 1)))

# YESWEHACK
YESWEHACK_RECIPIENTS_ENABLED = bool(int(os.environ.get("YESWEHACK_RECIPIENTS_ENABLED", 0)))
...
WHITELISTED_EMAIL_RECIPIENTS_ENABLED = bool(int(os.environ.get("WHITELISTED_EMAIL_RECIPIENTS_ENABLED", 0)))
...
ENABLE_UNINDEXING_ALL = bool(int(os.environ.get("ENABLE_UNINDEXING_ALL", 1)))
...
SENDINBLUE_IN_PROD = bool(int(os.environ.get("SENDINBLUE_IN_PROD", 0)))
...
# TITELIVE
ENABLE_TITELIVE_GENERATION = bool(int(os.environ.get("ENABLE_TITELIVE_GENERATION", 1)))
...
UBBLE_TEST_EMAIL_ENABLED = bool(int(os.environ.get("UBBLE_TEST_EMAIL_ENABLED", 1)))
...
EXPIRED_BOOKINGS_LOGGER_INFO = bool(int(os.environ.get("EXPIRED_BOOKINGS_LOGGER_INFO", 0)))
...
# BACKOFFICE
BACKOFFICE_ENABLE_ADDING_STAGING_PERMISSIONS = bool(
    int(os.environ.get("BACKOFFICE_ENABLE_ADDING_STAGING_PERMISSIONS", 1))
)
...
BACKOFFICE_GRANT_USER_PERMISSION = bool(int(os.environ.get("BACKOFFICE_GRANT_USER_PERMISSION", 0)))
