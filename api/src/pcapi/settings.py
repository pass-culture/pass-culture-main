...
JWT_ATERNATIVE_ADAGE_PUBLIC_KEY = os.environ.get("JWT_ATERNATIVE_ADAGE_PUBLIC_KEY")
JWT_ATERNATIVE_ADAGE_PRIVATE_KEY = os.environ.get("JWT_ATERNATIVE_ADAGE_PRIVATE_KEY")
