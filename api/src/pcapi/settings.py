...
# INDIVIDUAL OFFERS API SETTINGS
ENABLE_OFFER_CREATION_API_V1 = bool(int(os.environ.get("ENABLE_OFFER_CREATION_API_V1", 1)))
...
SENDINBLUE_LOCAL = bool(int(os.environ.get("SENDINBLUE_LOCAL", 0)))
...
DMS_LOGGER_ERROR = bool(int(os.environ.get("DMS_LOGGER_ERROR", 0)))
...
CLOUD_TASK_CALL_INTERNAL_API_ENDPOIT = bool(int(os.environ.get("CLOUD_TASK_CALL_INTERNAL_API_ENDPOIT", 0)))
...
BACKOFFICE_USE_LOCAL_ADMIN = bool(int(os.environ.get("BACKOFFICE_USE_LOCAL_ADMIN", 0)))
