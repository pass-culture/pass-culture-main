...
ALGOLIA_EUROPEAN_OFFERS_INDEX_NAME = os.environ.get("ALGOLIA_EUROPEAN_OFFERS_INDEX_NAME")
...
WIP_ENABLE_RECOMMENDATION_INSECURE_CALLS = bool(int(os.environ.get("WIP_ENABLE_RECOMMENDATION_INSECURE_CALLS", 1)))
