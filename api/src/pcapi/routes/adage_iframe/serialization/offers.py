...
class CollectiveOfferResponseModel(CollectiveOfferBaseReponseModel):
    ...
    def build(
        ...
        offer_venue_oa = offerVenue.offererAddress if offerVenue else None
        ...
        return cls(
            ...
            offerVenue=CollectiveOfferOfferVenue(
                ...
                address=offer_venue_oa.address.street if offer_venue_oa else None,
                postalCode=offer_venue_oa.address.postalCode if offer_venue_oa else None,
                city=offer_venue_oa.address.city if offer_venue_oa else None,
                distance=None,
