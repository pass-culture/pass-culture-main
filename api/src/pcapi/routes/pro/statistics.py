...
from pcapi.connectors.clickhouse.queries import AggregatedCollectiveRevenueModel
from pcapi.connectors.clickhouse.queries import AggregatedIndividualRevenueModel
from pcapi.connectors.clickhouse.queries import AggregatedTotalRevenueModel
...
def get_statistics(query: StatisticsQueryModel) -> StatisticsModel:
    ...
    results: (
        list[AggregatedCollectiveRevenueModel]
        | list[AggregatedIndividualRevenueModel]
        | list[AggregatedTotalRevenueModel]
    ) = []
