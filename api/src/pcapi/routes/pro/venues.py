...
def get_venues(query: venues_serialize.VenueListQueryModel) -> venues_serialize.GetVenueListResponseModel:
    ...
    venues_with_non_free_offers = offerers_repository.venues_have_non_free_offers(venue_ids)
    return venues_serialize.GetVenueListResponseModel(
        venues=[
            venues_serialize.VenueListItemResponseModel.from_orm(
                venue, ids_of_venues_with_offers, venues_with_non_free_offers
            )
