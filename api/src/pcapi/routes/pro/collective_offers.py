...
def patch_collective_offers_archive(
    ...
    offers_api.batch_update_collective_offers(collective_query, {"dateArchived": datetime.now()})
...
def patch_collective_offers_template_archive(
    ...
    offers_api.batch_update_collective_offers_template(collective_template_query, {"dateArchived": datetime.now()})
