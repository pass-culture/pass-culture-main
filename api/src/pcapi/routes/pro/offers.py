...
def patch_draft_offer(
    offer_id: int, body: offers_schemas.deprecated.PatchDraftOfferBodyModel
) -> offers_serialize.GetIndividualOfferWithAddressResponseModel:
...
def _get_offer_for_price_categories_upsert(offer_id: int,) -> models.Offer | None:
    return (
        ...
        .outerjoin(models.Offer.priceCategories)
...
def post_price_categories(
    ...
    offer = _get_offer_for_price_categories_upsert(offer_id)
    if not offer:
