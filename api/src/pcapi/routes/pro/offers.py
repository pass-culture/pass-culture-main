...
def _format_offer_opening_hours(
    ...
    # for weekday_opening_hours in opening_hours or []:
    ...
    # def _format_numeric_ranges(ranges: list[NumericRange]) -> OpeningHoursTimespans:
    # timespans = []
    # for ts in ranges:
    # lower = int(ts.lower)
    # upper = int(ts.upper)
    ...
    # timespans.append(offers_schemas.OpeningHours([start, end]))
    # return offers_schemas.OpeningHoursTimespans(timespans)
    ...
    return offers_schemas.WeekdayOpeningHoursTimespans(**formatted)
