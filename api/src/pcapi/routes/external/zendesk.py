...
from pcapi.routes.external.authentication import require_zendesk_webhook_api_key
...
@external_blueprint.route("/zendesk/ticket_notification", methods=["POST"])
@require_zendesk_webhook_api_key
