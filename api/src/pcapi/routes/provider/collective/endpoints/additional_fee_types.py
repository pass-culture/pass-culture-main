...
from pcapi.routes.provider.collective.serialization import additional_fee_types
...
@blueprints.provider_blueprint.route("/v2/collective/additional-fee-types", methods=["GET"])
@atomic()
@api_key_required
@spectree_serialize(
