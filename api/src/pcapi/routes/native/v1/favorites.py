...
def get_favorites_for(user: User, favorite_id: int | None = None) -> list[serializers.FavoriteData]:
    ...
    query = (
        ...
        .options(
            ...
            .options(
                sa_orm.joinedload(Offer.stocks).load_only(
    ...
    for (
        ...
        is_expired = active_count and not non_expired_count
        date = min_beginning_datetime if min_beginning_datetime == max_beginning_datetime else None
        start_date = min_beginning_datetime if not date else None
        price = min_price if min_price == max_price else None
        start_price = min_price if not price else None
