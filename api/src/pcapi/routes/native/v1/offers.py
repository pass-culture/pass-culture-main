...
def get_categories() -> subcategories_v2_serializers.CategoryTree:
    return subcategories_v2_serializers.CategoryTree(categoryNodes=subcategories_v2.SEARCH_NODES)
