...
def get_reminders(user: users_models.User) -> serialization.GetRemindersResponse:
    ...
    reminders_reponse = [{"id": _reminder.id, "offer": _reminder.futureOffer.offer} for _reminder in reminders]

    return serialization.GetRemindersResponse(reminders=reminders_reponse)  # type: ignore[arg-type]
