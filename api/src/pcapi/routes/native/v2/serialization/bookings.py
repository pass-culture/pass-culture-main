...
class BookingVenueResponseV2(BaseModel):
    id: int
    name: str
    publicName: str | None
    timezone: str
...
class BookingOfferExtraDataV2(BaseModel):
    ean: str | None


class BookingOfferResponseAddressV2(BaseModel):
    street: str | None
    postalCode: str
    city: str
    label: str | None
...
class BookingOfferResponseV2(BaseModel):
    id: int
    address: BookingOfferResponseAddressV2 | None
    bookingContact: str | None
    name: str
    extraData: BookingOfferExtraDataV2 | None
...
class BookingStockResponseV2(BaseModel):
    id: int
...
class ExternalBookingDataResponseV2(BaseModel):
    barcode: str
    seat: str | None
...
class ExternalBookingResponseV2(BaseModel):
    isVisible: bool
...
class TicketResponse(BaseModel):
    ...
    externalBooking: ExternalBookingResponseV2 | None
...
class BookingsResponseV2(BaseModel):
