...
class VenueContact(HttpBodyModel):
    ...
    social_medias: dict[SocialMedia, pydantic.HttpUrl] | None
    website: str | None
...
class VenueResponse(HttpBodyModel):
    ...
    banner_credit: str | None
    banner_is_from_google: bool
    banner_url: pydantic.HttpUrl | None
    contact: VenueContact | None
    city: str | None
    description: str | None
    accessibility_data: AccessibilityData | None
    ...
    @classmethod
    def pre_populate_from_orm(cls, data: typing.Any) -> typing.Any:
        if isinstance(data, dict):
            return data

        venue: offerers_models.Venue = data
        model_dict: dict[str, typing.Any] = {}
        model_dict["id"] = venue.id
        model_dict["accessibility_data"] = None
        model_dict["accessibility_url"] = None
        ...
        model_dict["banner_credit"] = None
        model_dict["banner_is_from_google"] = False
        if venue.bannerMeta:
