...
class CallToActionMessageV3(HttpBodyModel):
...
class SubscriptionMessageV3(HttpBodyModel):
    user_message: str
    message_summary: str | None = None
    call_to_action: CallToActionMessageV3 | None = None
...
class SubscriptionStepDetailsResponseV3(HttpBodyModel):
...
class SubscriptionStepperResponseV3(HttpBodyModel):
    subscription_steps_to_display: list[SubscriptionStepDetailsResponseV3]
    ...
    title: str
    subtitle: str | None = None
    subscription_message: SubscriptionMessageV3 | None = None
