...
@blueprint.backoffice_v3_web.route("/admin/feature-flipping", methods=["GET"])
...
@blueprint.backoffice_v3_web.route("/admin/feature-flipping/<int:feature_flag_id>/disable", methods=["POST"])
@utils.permission_required(perm_models.Permissions.FEATURE_FLIPPING)
