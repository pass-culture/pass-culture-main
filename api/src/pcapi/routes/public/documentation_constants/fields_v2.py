...
class _FIELDS_V2:
    ...
    LATITUDE_NOT_REQUIRED = Field(description="Latitude coordinate", examples=[48.86696], default=None)
    LONGITUDE = Field(description="Longitude coordinate", examples=[2.31014])
    LONGITUDE_NOT_REQUIRED = Field(description="Longitude coordinate", examples=[2.31014], default=None)
    ...
    ADDRESS_LABEL = Field(description="Address label", examples=["Zénith Paris"])
    ADDRESS_LABEL_WITH_DEFAULT = Field(description="Address label", examples=["Zénith Paris"], default=None)

    # Booking fields
    BOOKING_ID = Field(description="Booking id", examples=[12346])
    BOOKING_QUANTITY = Field(description="Booking quantity (can be either 1 or 2)", examples=[1])
    ...
    OFFER_ID_NOT_REQUIRED = Field(description="Offer id", examples=[12345], default=None)
    ...
    OFFER_ADDRESS_NOT_REQUIRED = Field(description="Offer address", examples=["4 rue des dames"], default=None)
    OFFER_DEPARTEMENT_CODE_NOT_REQUIRED = Field(description="Offer departement code", examples=["63"], default=None)
    ...
    PRICE_CATEGORY_ID_NOT_REQUIRED = Field(description="Price category id", examples=[12], default=None)
    PRICE_CATEGORY_LABEL = Field(description="Price category label", examples=["Carré or"])
    PRICE_CATEGORY_LABEL_NOT_REQUIRED = Field(description="Price category label", examples=["Carré or"], default=None)
    ...
    PRICE_CATEGORIES_WITH_MAX_ITEMS = Field(
        ...
        max_length=Offer.MAX_PRICE_CATEGORIES_PER_OFFER,
    )
    ...
    EVENT_DURATION = Field(description="Event duration in minutes", examples=[60])
    EVENT_STOCKS = Field(
        ...
        max_length=Offer.MAX_STOCKS_PER_OFFER,
    )
    ...
    EVENT_CATEGORY_ID = Field(description="Category id", examples=["CONCERT"])
    EVENT_CATEGORY_LABEL = Field(description="Category label", examples=["Concert"])
    ...
    BOOKING_STATUS_NOT_REQUIRED = Field(
        description=descriptions.BOOKING_STATUS_DESCRIPTION, examples=["CONFIRMED"], default=None
    )
    ...
    STOCK_ID_NOT_REQUIRED = Field(description="Stock id", examples=[45], default=None)
    QUANTITY = Field(
    ...
    PROVIDER_LOGO_URL_NOT_REQUIRED = Field(
        ...
        examples=["https://ultimate-ticketing-solution.com/logo.png"],
        default=None,
    )
    ...
    # User Fields
    USER_EMAIL = Field(description="Beneficiary email", examples=["michel.martin@somemail.fr"])
    USER_PHONE_NUMBER_NOT_REQUIRED = Field(
        description="Beneficiary phone number", examples=["0612345678"], default=None
    )
    USER_FIRST_NAME_NOT_REQUIRED = Field(description="Beneficiary first name", examples=["Michel"], default=None)
    USER_LAST_NAME_NOT_REQUIRED = Field(description="Beneficiary last name", examples=["Martin"], default=None)
    ...
    USER_POSTAL_CODE_NOT_REQUIRED = Field(description="Beneficiary postal code", examples=["75017"], default=None)
