...
**(⚠ COMING SOON, not yet implemented)** The date and time when the offer becomes bookable in the beneficiary application. If not set, the offer will be bookable as soon as it is published.
