...
preferences_blueprint = backoffice_blueprint.child_backoffice_blueprint(
    "preferences",
    __name__,
...
def edit_preferences() -> response_utils.BackofficeResponse:
...
def save_preferences() -> response_utils.BackofficeResponse:
