...
class BaseBookingListForm(FlaskForm):
    ...
    event_from_date = fields.PCOptDateField("Évènement du")
    event_to_date = fields.PCOptDateField("Évènement jusqu'au")
...
class GetIndividualBookingListForm(BaseBookingListForm):
    ...
    def __init__(self, *args: typing.Any, **kwargs: typing.Any) -> None:
        super().__init__(*args, **kwargs)
        self.q.label.text = "Code contremarque ou liste, nom d'offre, email ou ID (offre, jeune, résa ou stock)"
