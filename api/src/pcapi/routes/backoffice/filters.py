...
def chronicle_product_identifier_type(chronicle_type: chronicles_models.ChronicleProductIdentifierType) -> str:
...
def install_template_filters(app: Flask) -> None:
    ...
    app.jinja_env.filters["chronicle_product_identifier_type"] = chronicle_product_identifier_type
