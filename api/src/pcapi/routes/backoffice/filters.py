...
_SUBSCRIPTION_STATUS_TO_ICON = {
    ...
    subscription_schemas.SubscriptionItemStatus.NOT_APPLICABLE.value: "slash-circle",  # TODO
    subscription_schemas.SubscriptionItemStatus.NOT_ENABLED.value: "slash-circle",  # TODO
    ...
    subscription_schemas.SubscriptionItemStatus.SKIPPED.value: "exclamation-circle",  # TODO
    subscription_schemas.SubscriptionItemStatus.SUSPICIOUS.value: "exclamation-circle",
    subscription_schemas.SubscriptionItemStatus.TODO.value: "exclamation-circle",  # TODO
    subscription_schemas.SubscriptionItemStatus.VOID.value: "question-circle",  # TODO
    "canceled": "bi-trash3",
}
