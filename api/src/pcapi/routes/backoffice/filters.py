...
ACTION_TYPE_TO_STRING = {
    ...
    history_models.ActionType.VENUE_REOPENED: "Réouverture du partenaire culturel",
    ...
    match reason:
        ...
        case (
            ...
            if author:
                ...
                return (
                    f"Annulée depuis le backoffice par {author.full_name} pour modification des informations de l'offre"
                )
...
def format_booking_status(
    ...
    return format_badge("Réservée", "info") if with_badge else "Réservée"
...
def format_invoice_status(status: finance_models.InvoiceStatus) -> str:
    match status:
...
ACTIVITY_MAPPING = {
    ...
    offerers_models.Activity.ARTISTIC_PRACTICE: "Pratique ou enseignement artistique",
    offerers_models.Activity.ARTS_CENTRE: "Centre d’arts ou FRAC",
    ...
    offerers_models.Activity.CULTURAL_CENTRE: "Lieu culturel pluridisciplinaire (tiers-lieu, friche, etc…)",
    ...
    offerers_models.Activity.HERITAGE_SITE: "Activité patrimoniale, historique ou touristique",
    offerers_models.Activity.HIGHER_EDUCATION_INSTITUTION: "Enseignement supérieur (arts, architecture, etc…)",
    offerers_models.Activity.LIBRARY: "Bibliothèque ou médiathèque",
    offerers_models.Activity.MUNICIPALITY_CULTURAL_DEPARTMENT: "Service culturel de collectivité",
    ...
    offerers_models.Activity.PUBLISHING_HOUSE: "Maison d’édition",
    ...
    offerers_models.Activity.SCIENTIFIC_CULTURE: "Culture scientifique",
