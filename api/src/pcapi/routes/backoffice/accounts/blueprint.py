...
ADVANCED_SEARCH_FIELDS_DEFINITION: dict[str, dict[str, typing.Any]] = {
    ...
    "CREDITS": {
        ...
        "custom_filters_inner_joins": {"IN": {"deposit"}},
    },
...
def _get_user_ids_query(advanced_form: account_forms.GetAccountsSearchForm, base_query: sa_orm.Query) -> sa_orm.Query:
...
def _search_users(advanced_form: account_forms.GetAccountsSearchForm) -> list[users_models.User]:
...
def _get_public_account_link(
    user_id: int, form: account_forms.GetAccountsSearchForm | None = None, **kwargs: typing.Any
) -> str:
