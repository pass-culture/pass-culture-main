...
artist_form_field_configuration = {
    "ID": {"field": "string", "operator": ["CONTAINS", "NO_CONTAINS", "EQUALS", "NOT_EQUALS"]},
    "NAME": {"field": "string", "operator": ["NAME_EQUALS", "NAME_NOT_EQUALS", "CONTAINS", "NO_CONTAINS"]},
    "IS_VISIBLE": {"field": "boolean", "operator": ["EQUALS"]},
    "CREATION_DATE": {"field": "date", "operator": ["DATE_FROM", "DATE_TO", "DATE_EQUALS"]},
    "ALIAS_NAME": {"field": "string", "operator": ["CONTAINS", "NO_CONTAINS", "EQUALS", "NOT_EQUALS"]},
...
class GetArtistsBaseFields(forms_utils.PCForm):
    sort = wtforms.HiddenField(
        "sort", validators=(wtforms.validators.Optional(), wtforms.validators.AnyOf(("id", "name", "date_created")))
    )
...
class ConfirmAssociationForm(FlaskForm):
    ...
    artist_type = fields.PCSelectField(
        ...
        choices=forms_utils.choices_from_enum(artist_models.ArtistType),
