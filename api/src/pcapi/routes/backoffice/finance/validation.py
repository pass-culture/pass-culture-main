...
class Valid:
    ...
    def __and__(self, other: "Valid") -> "Valid":
        ...
        new_valid.messages = [msg for msg in (self.messages + other.messages) if msg is not None]
        return new_valid
    ...
    def __or__(self, other: "Valid") -> "Valid":
        ...
        new_valid.messages = [msg for msg in self.messages if msg is not None and not self.is_valid] + [
            msg for msg in other.messages if msg is not None and not other.is_valid
        ]
        return new_valid
