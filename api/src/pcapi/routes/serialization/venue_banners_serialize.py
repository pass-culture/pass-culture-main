...
# TODO bdalbianco 24/03/2026 Can't be switched yet because route use GetVenueResponseModel
class VenueBannerContentModelv2(HttpBodyModel):
    ...
    @classmethod
    def from_request(cls, request: typing.Any) -> "VenueBannerContentModelv2":
        """
        ...
        return VenueBannerContentModelv2(
