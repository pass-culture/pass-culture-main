...
class AbstractSaveBankInformations:
    def __init__(
        self,
    ...
    def execute(self, application_details: ApplicationDetail) -> BankInformations | None:
...
class SaveVenueBankInformationsV2(AbstractSaveBankInformations):
    def __init__(
        self,
        venue_repository: VenueWithBasicInformationRepository,
        bank_informations_repository: BankInformationsRepository,
...
class SaveVenueBankInformationsV4(AbstractSaveBankInformations):
    def __init__(
        self,
        venue_repository: VenueWithBasicInformationRepository,
        bank_informations_repository: BankInformationsRepository,
