...
gh workflow run on_dispatch_pcapi_console_job.yml \
  ...
  -f NAMESPACE=import_caledonian_users \
  -f SCRIPT_ARGUMENTS="";

Script which imports Caledonian pro accounts from a CSV file.
"""
...
def main(filename: str, not_dry: bool) -> None:
    ...
    for i, row in enumerate(rows):
        ...
        create_pro(user_row=user_row, offerer=offerer, row_number=i + 1, counters=counters, comment=filename)
