...
gh workflow run on_dispatch_pcapi_console_job.yaml \
  ...
  -f RESOURCES="512Mi/.5" \
  -f BRANCH_NAME=pc-40451-script-recreate-bookings-support-pro \
...
def recreate_booking(
    ...
    if original_is_canceled:
        ...
        comment = (
            f"PC-40451 - Suite à l'annulation de la réservation {original_booking_token} pour un trop-perçu car retirée "
        ...
        comment = (
            f"PC-40451 - Suite au remboursement de la réservation {original_booking_token} retirée dans une autre "
...
def recredit_beneficiary(beneficiary: users_models.User, amount: decimal.Decimal, token: str) -> None:
    ...
    db.session.add(
        finance_models.Recredit(
            ...
            comment=(
                "PC-40451 - Recrédit exceptionnel suite au retrait d'une réservation dans une autre structure afin "
