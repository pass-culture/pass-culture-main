...
https://github.com/pass-culture/pass-culture-main/blob/pc-38038-import-caledonian-offerers/api/src/pcapi/scripts/import_caledonian_offerers/main.py

Script d'import des offerers calédoniens depuis un fichier CSV - Lot 2.
...
CSV_COLUMN_MAPPING = {
    ...
    "booking_email": "Adresse mail (bookingemail)",
}
...
def create_offerer_and_venue(data: dict, not_dry: bool, counters: ImportCounters) -> offerers_models.Offerer:
    ...
    if existing_offerer:
        ...
        history_api.add_action(
            ...
            author=None,
            offerer=offerer,
            comment="Création des acteurs culturels calédoniens par script - Lot 2 - PC-38038",
        )
