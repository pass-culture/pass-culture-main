...
def main(not_dry: bool) -> None:
    ...
    for log in logs:
        ...
        # Pour chaque transfert, il y a un log de type "Transfer done for venue 1248 to venue 92618"
        # permettant de récupérer la liste des venues de destination.
        # Toutes ces venues ont donc un ActionHistory associé, vrai ou faux, indiquant le passage en permanent.
        # Pour savoir quels sont les vrais passage en permanent,
        # on regarde les log du type "Destination venue 19702 updated to permanent"
    ...
    for origin_and_destination_venue_id in origin_and_destination_venues_ids:
        ...
        ).update({"extraData": None}, synchronize_session="evaluate")
        logger.info(
            "Action history for venue %d wrongly modified to permanent from transfer of venue %d updated",
