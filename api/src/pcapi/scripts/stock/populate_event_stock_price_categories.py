...
def get_event_offers() -> typing.Generator[offers_models.Offer, None, None]:
...
def _get_or_create_price_category(
    ...
    price_category = offers_models.PriceCategory.query.filter_by(price=price, offer=offer).one_or_none()
...
def populate_event_stock_price_categories() -> None:
    event_offers_query = get_event_offers()
