...
gh workflow run on_dispatch_pcapi_console_job.yml \
  ...
  -f RESOURCES="512Mi/.5" \
  -f BRANCH_NAME=pc-38656-import-caledonian-offerers \
  -f NAMESPACE=import_caledonian_pro_users \
  -f SCRIPT_ARGUMENTS="";

Script d'import des comptes pro calédoniens depuis un fichier CSV - Lot 3
Identique au script du lot 2, au commentaire près.
"""
...
def create_pro(user_row: UserRow, offerer: offerers_models.Offerer, row_number: int, counters: ImportCounter) -> None:
    ...
    if pro_user is not None:
        ...
        history_api.add_action(
            ...
            author=None,
            offerer=offerer,
            comment="Création des acteurs culturels calédoniens par script - Lot 3 - PC-38656",
        )
