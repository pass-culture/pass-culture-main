...
https://github.com/pass-culture/pass-culture-main/blob/pc-38039-import-caledonian-pro-users/api/src/pcapi/scripts/import_nc_users/main.py

Script d'import des comptes pro calédoniens depuis un fichier CSV - Lot 2
Adapté en reprenant le script d'import du lot 1.
"""
...
def create_pro(user_row: UserRow, offerer: offerers_models.Offerer, row_number: int, counters: ImportCounter) -> None:
    ...
    if pro_user is not None:
        ...
        history_api.add_action(
            history_models.ActionType.USER_CREATED,
            author=None,
            offerer=offerer,
            comment="Création des acteurs culturels calédoniens par script - Lot 2 - PC-38039",
        )
