...
gh workflow run on_dispatch_pcapi_console_job.yaml \
  ...
  -f RESOURCES="512Mi/.5" \
  -f BRANCH_NAME=PC-42766-extend-credits-after-festival-cancellation \
  -f NAMESPACE=extend_user_credits \
  -f SCRIPT_ARGUMENTS="";
...
def main(user_ids: list[int]) -> list[users_models.User]:
    ...
    for user in users:
        ...
        history_api.add_action(
            ...
            comment="PC-42766 : Crédit étendu de 3 mois après annulation du festival",
        )
