...
def main(not_dry: bool) -> None:
    ...
    db.session.query(offers_models.Offer).filter(offers_models.Offer.id.in_offer_ids).update(
        {offers_models.Offer.offererAddressId: None}, synchronize_session=False
    )
