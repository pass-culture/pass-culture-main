...
gh workflow run on_dispatch_pcapi_console_job.yml   -f ENVIRONMENT=testing   -f BRANCH_NAME=bdalbianco/PC-38127_venueActivity_specific_cases   -f NAMESPACE=set_venue_activity_community_centre   -f SCRIPT_ARGUMENTS="";
...
def process_file(file_rows: typing.Iterator[dict[str, str]]) -> None:
    ...
    logger.info(
        "Set venue.activity to COMMUNITY_CENTRE: %i Venues updated out of %i Venues to update",
