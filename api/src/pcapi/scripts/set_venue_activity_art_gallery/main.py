...
gh workflow run on_dispatch_pcapi_console_job.yml   -f ENVIRONMENT=testing   -f BRANCH_NAME=bdalbianco/PC-38127_venueActivity_specific_cases   -f NAMESPACE=set_venue_activity_art_gallery   -f SCRIPT_ARGUMENTS="";
...
FILENAME = "venue_activity_art_gallery.csv"
HEADER = "Venue ID"
...
def process_file(file_rows: typing.Iterator[dict[str, str]]) -> None:
    ...
    logger.info(
        "Set venue.activity to ART_GALLERY: %i Venues updated out of %i Venues to update",
