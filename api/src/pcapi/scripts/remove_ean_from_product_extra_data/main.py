...
def _get_eta(end: int, current: int, elapsed_per_batch: list[int], batch_size: int) -> str:
    ...
    eta = date_utils.get_naive_utc_now() + datetime.timedelta(seconds=seconds_eta)
...
if __name__ == "__main__":
    ...
    copy_ean(args.starting_id, args.ending_id, args.batch_size, args.not_dry)
