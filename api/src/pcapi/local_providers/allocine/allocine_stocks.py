...
class AllocineStocks(LocalProvider):
    ...
    def update_from_movie_information(
        ...
        for field in (
            ...
            if field in movie_information:
                ...
                obj.extraData[field] = movie_information[field]  # type: ignore [literal-required, index, unused-ignore]
    ...
    def fill_offer_attributes(self, allocine_offer: offers_models.Offer) -> None:
        ...
        allocine_offer.extraData["theater"] = {  # type: ignore [index, unused-ignore]
        ...
        if self.movie_information and "visa" in self.movie_information:
            allocine_offer.extraData["visa"] = self.movie_information["visa"]  # type: ignore [index, unused-ignore]
        if self.movie_information and "stageDirector" in self.movie_information:
            allocine_offer.extraData["stageDirector"] = self.movie_information["stageDirector"]  # type: ignore [index, unused-ignore]
        ...
        allocine_offer.extraData["diffusionVersion"] = movie_version  # type: ignore [index, unused-ignore]
