...
from pcapi.core.booking_providers.api import get_venue_movies
...
class CDSStocks(LocalProvider):
    ...
    def __init__(self, venue_provider: VenueProvider):
        ...
        self.isDuo = venue_provider.isDuo
        self.movies: Iterator[Movie] = iter(get_venue_movies(self.venue.id))
    ...
    def fill_offer_attributes(self, cds_offer: Offer) -> None:
        ...
        cds_offer.name = f"{self.movie_information.title}"
