...
@dataclass
class BookType(SearchNode):
    instances: list["BookType"] = []

    def __post_init__(self) -> None:
        self.instances.append(self)


BookType_ROMANS_LITTERATURE = BookType(
    position=1,
...
BookType_XXX = BookType(
    parent=BookType_ROMANS_LITTERATURE,
    position=1,
    label="Romances",
    gtls=[
...
BookType_XXX = BookType(
    ...
    gtls=[
        ...
        BookType(position=1, label="Shonen", gtls=[GTL(code="03040500", label="Shonen", level=3)]),
        BookType(position=2, label="Seinen", gtls=[GTL(code="03040600", label="Seinen", level=3)]),
        BookType(position=3, label="Shôjo", gtls=[GTL(code="03040400", label="Shôjo", level=3)]),
        BookType(position=4, label="Yaoi", gtls=[GTL(code="03040800", label="Yaoi", level=3)]),
        BookType(position=5, label="Kodomo", gtls=[GTL(code="03040300", label="Kodomo", level=3)]),
        BookType(position=6, label="Josei", gtls=[GTL(code="03040700", label="Josei", level=3)]),
        BookType(position=7, label="Yuri", gtls=[GTL(code="03040900", label="Yuri", level=3)]),
    ],
),
BookType_XXX = BookType(
    position=3,
    ...
    gtls=[GTL(code="03020000", label="Bandes dessinées", level=2), GTL(code="03030000", label="Comics", level=2)],
        ...
        BookType(position=11, label="Super héros", gtls=[GTL(code="03030400", label="Super Héros", level=3)]),
        BookType(position=12, label="Strip", gtls=[GTL(code="03030300", label="Strip", level=3)]),
    ],
),
BookType_XXX = BookType(
    position=4,
    ...
    gtls=[GTL(code="04000000", label="Vie pratique & Loisirs", level=1)],
        ...
        BookType(
            position=3, label="Activités manuelles", gtls=[GTL(code="04050000", label="Hobbies", level=2)]
        ),
        BookType(position=4, label="Jeux", gtls=[GTL(code="04050500", label="Jeux", level=3)]),
        BookType(position=5, label="Sports", gtls=[GTL(code="04070000", label="Sports", level=2)]),
        BookType(position=6, label="Animaux", gtls=[GTL(code="04020000", label="Animaux", level=2)]),
        BookType(
            position=7,
        ...
        BookType(position=9, label="Transports", gtls=[GTL(code="04050700", label="Transports", level=3)]),
    ],
),
BookType_XXX = BookType(
    position=5,
    ...
    gtls=[
        ...
        BookType(position=1, label="Philosophie", gtls=[GTL(code="09080000", label="Philosophie", level=2)]),
        BookType(
            position=2,
...
BookType_XXX = BookType(
    ...
    gtls=[
        ...
        BookType(position=1, label="Théâtre", gtls=[GTL(code="01080000", label="Théâtre", level=2)]),
        BookType(position=2, label="Poésie", gtls=[GTL(code="01090000", label="Poésie", level=2)]),
        BookType(
            position=3,
            label="Essais littéraires",
            gtls=[GTL(code="01070000", label="Littérature argumentative", level=2)],
        ),
        BookType(position=4, label="Récit", gtls=[GTL(code="01050000", label="Récit", level=2)]),
    ],
),
BookType_XXX = BookType(
    position=7,
    ...
    gtls=[
        ...
        BookType(position=1, label="Droit", gtls=[GTL(code="08030000", label="Droit", level=2)]),
        BookType(position=2, label="Médecine", gtls=[GTL(code="10080000", label="Médecine", level=2)]),
        BookType(
            position=3,
            label="Entreprise",
...
BookType_XXX = BookType(
    ...
    gtls=[GTL(code="06000000", label="Arts et spectacles", level=1)],
        ...
        BookType(position=5, label="Musique", gtls=[GTL(code="06030000", label="Musique", level=2)]),
    ],
),
BookType_XXX = BookType(
    position=9,
