...
class FeatureToggle(enum.Enum):
    ...
    WIP_ENABLE_PRO_NOTIFICATION_BEFORE_ANONYMIZATION = (
        "Activer le mail de notification au pro un mois avant son anonymisation automatique"
    )
...
FEATURES_DISABLED_BY_DEFAULT: tuple[FeatureToggle, ...] = (
    ...
    FeatureToggle.WIP_ENABLE_PRO_NOTIFICATION_BEFORE_ANONYMIZATION,
