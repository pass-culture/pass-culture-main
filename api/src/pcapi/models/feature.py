...
class FeatureToggle(enum.Enum):
    ...
    ENABLE_API_PARTICULIER_MOCK = "Activer la simulation des appels à l'API Particulier"
...
if settings.IS_PROD:
    FEATURES_DISABLED_BY_DEFAULT += (FeatureToggle.ENABLE_API_PARTICULIER_MOCK,)
