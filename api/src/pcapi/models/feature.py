...
class FeatureToggle(enum.Enum):
    ...
    WIP_ENABLE_BO_OFFER_TABLE_PERSONALISATION = (
        "Activer la personalisation tu tableau des offres individuelles dans le BO"
    )
...
FEATURES_DISABLED_BY_DEFAULT: tuple[FeatureToggle, ...] = (
    ...
    FeatureToggle.WIP_ENABLE_BO_OFFER_TABLE_PERSONALISATION,
