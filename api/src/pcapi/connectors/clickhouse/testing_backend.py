...
class TestingBackend(BaseBackend):
    ...
    def run_query(self, query: str, params: dict) -> list:
        ...
        if query == queries.CountIndividualBookingQuery().raw_query:
            return query_mock.COUNT_INDIVIDUAL_BOOKINGS
        if query == queries.CountCollectiveBookingQuery().raw_query:
            return query_mock.COUNT_COLLECTIVE_BOOKINGS
