...
class ArtistModel(pydantic.BaseModel):
    id: str
    name: str | None
...
class ArtistProductLinkModel(pydantic.BaseModel):
    artist_id: str
    product_id: str
    artist_type: str | None


class ArtistAliasModel(pydantic.BaseModel):
    artist_id: str | None
...
"SELECT artist_id as id, artist_name as name, artist_description as description, wikidata_image_file_url as image, wikidata_image_author as author, wikidata_image_license as license, wikidata_image_license_url as license_url FROM passculture-data-prod.backend_prod.artist"
