...
class BigQueryTiteliveProductBase(TiteliveArticle):
    ean: str
    titre: str
    recto_uuid: str | None
    verso_uuid: str | None
...
class BigQueryTiteliveBookProductModel(BigQueryTiteliveProductBase, TiteLiveBookArticle):
...
class BigQueryTiteliveMusicProductModel(BigQueryTiteliveProductBase, TiteliveMusicArticle):
    pass
