...
class _Address(pydantic.BaseModel):
    street: typing.Annotated[str, pydantic.constr(strip_whitespace=True)]
    postal_code: typing.Annotated[str, pydantic.constr(strip_whitespace=True)]
    city: typing.Annotated[str, pydantic.constr(strip_whitespace=True)]


class SirenInfo(pydantic.BaseModel):
    siren: typing.Annotated[str, pydantic.constr(strip_whitespace=True, min_length=9, max_length=9)]
    name: str
    head_office_siret: typing.Annotated[str, pydantic.constr(strip_whitespace=True, min_length=14, max_length=14)]
    ape_code: str
...
class SiretInfo(pydantic.BaseModel):
    siret: typing.Annotated[str, pydantic.constr(strip_whitespace=True, min_length=14, max_length=14)]
    active: bool
    name: str
    address: _Address
