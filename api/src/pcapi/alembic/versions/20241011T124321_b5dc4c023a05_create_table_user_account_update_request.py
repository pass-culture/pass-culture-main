"""Create table: user_account_update_request
"""
...
revision = "b5dc4c023a05"
down_revision = "d3a9473e2704"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("automationComment", sa.Text(), nullable=True),
...
def downgrade() -> None:
    op.drop_index(op.f("ix_user_account_update_request_dsApplicationId"), table_name="user_account_update_request")
