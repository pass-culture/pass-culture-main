...
def upgrade() -> None:
    op.create_table(
        ...
        sa.UniqueConstraint("offerId", "chronicleId", name="unique_offer_chronicle_contraint"),
    )
    op.create_index(op.f("ix_offer_chronicle_chronicleId"), "offer_chronicle", ["chronicleId"], unique=False)
    op.create_index(op.f("ix_offer_chronicle_offerId"), "offer_chronicle", ["offerId"], unique=False)
