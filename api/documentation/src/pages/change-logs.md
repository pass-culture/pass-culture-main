...
- The response of the following endpoints now includes 2 new fields, "offerAddress" and "offerDepartmentCode", that replace respectively "venueAddress" and "venueDepartementCode":
