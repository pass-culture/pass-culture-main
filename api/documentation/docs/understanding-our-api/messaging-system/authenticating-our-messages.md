...
def _verify_signature(data: str, signature: str) -> str:
    # check that the signature of the body is matching the signature sent in the header
    public_key = serialization.load_pem_public_key(PASS_CULTURE_PEM_PUBLIC KEY.encode('utf-8'))
    try:
        public_key.verify(
...
MCowBQYDK2VwAyEAH97XDu/IcXBKEevfeuHy+i6wEez6S6hMl2JHdAbcPEc=
...
```
-----BEGIN PUBLIC KEY-----
MCowBQYDK2VwAyEAfJnDM9Jmht/75jwO/FekUe2brIIU5GvQPx1D7+emeE4=
-----END PUBLIC KEY-----
```
</TabItem>
