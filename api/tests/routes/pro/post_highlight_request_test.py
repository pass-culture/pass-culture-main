...
class Returns200Test:
    ...
    def test_remove_highlight_request_except_for_unavailable_highlight_with_empty_list(self, client):
        user_offerer = offerers_factories.UserOffererFactory(user__email="user@example.com")
        venue = offerers_factories.VenueFactory(managingOfferer=user_offerer.offerer)
        offer = offers_factories.EventOfferFactory(venue=venue)
...
class Returns400Test:
    ...
    def test_highlight_request_fail_if_one_highlight_is_not_known(self, client):
        user_offerer = offerers_factories.UserOffererFactory(user__email="user@example.com")
        venue = offerers_factories.VenueFactory(managingOfferer=user_offerer.offerer)
        offer = offers_factories.EventOfferFactory(venue=venue)
    ...
    def test_highlight_request_fail_if_offer_is_not_event(self, client):
        user_offerer = offerers_factories.UserOffererFactory(user__email="user@example.com")
        venue = offerers_factories.VenueFactory(managingOfferer=user_offerer.offerer)
