...
@pytest.mark.usefixtures("db_session")
class GetOfferOpeningHoursTest(conftest.SharedOfferOpeningHoursErrors):
    endpoint = "Private API.get_offer_opening_hours"

    def test_no_existing_hours_returns_empty_week(self, auth_client, offer):
    ...
    def test_opening_hours_existings_are_returned_with_all_week_days(self, auth_client, offer):
    ...
    def test_every_weekday_has_opening_hours_set_and_all_are_returned(self, auth_client, offer):
        opening_hours = timespan_str_to_numrange([("10:00", "12:00"), ("14:00", "18:00")])
