...
class Returns200Test:
    def test_create_one_price_category(self, client):
        ...
        response = client.with_session_auth("user@example.com").patch(f"/offers/{offer.id}/price_categories", json=data)
    ...
    def test_edit_one_price_category(self, client):
        ...
        client.with_session_auth("user@example.com").patch(f"/offers/{offer.id}/price_categories", json=data)
        price_category = db.session.query(offers_models.PriceCategory).one()
