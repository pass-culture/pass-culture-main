...
class Returns201Test:
    ...
    def test_create_pro_advice(self, mock_create_pro_advice, client):
        ...
        mock_create_pro_advice.return_value = offers_models.ProAdvice(
        ...
        mock_create_pro_advice.assert_called_once_with(
    ...
    def test_create_pro_advice_without_author(self, mock_create_pro_advice, client):
        ...
        mock_create_pro_advice.assert_called_once_with(offer, "Une super reco.", None, user_offerer.user.id)
