...
class Returns200Test:
    def test_complete_booking_single(self, app):
        ...
        assert reader[0]["Nom de l'offre"] == booking.stock.offer.name
        ...
        assert reader[0]["Prix de la réservation"] == booking.stock.price
    ...
    def test_complete_booking_multiple(self, app):
        ...
        for i in range(3):
            ...
            assert reader[i]["Nom de l'offre"] == bookings[i].stock.offer.name
            ...
            assert reader[i]["Prix de la réservation"] == bookings[i].stock.price
