...
class Returns200Test:
    ...
    def test_should_not_return_booking_token_when_booking_is_external(self, client: Any):
        ...
        # when
        expected_num_queries = 13  # 2 users + session (DELETE) + user + user_session (INSERT) + user + user_offerer
        # + user_pro_new_nav_state + user_offerer + user_session + user + anon_1 + external_booking
