...
class PostReminderTest:
    ...
    def test_already_existing_reminder(self, client):
        ...
        reminders_factories.FutureOfferReminderFactory(futureOffer=future_offer_1, user=user)
        reminders_factories.FutureOfferReminderFactory(futureOffer=future_offer_2, user=user)
