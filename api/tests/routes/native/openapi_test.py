            ...
            "schemas": {
                ...
                "CategoryResponseModel": {
                    "properties": {
                        ...
                        "searchValue": {"nullable": True, "title": "Searchvalue", "type": "string"},
                    },
                    "required": ["label", "parents"],
                ...
                "DepositAmountsByAge": {
                    "properties": {
                        "age_15": {"title": "Age 15", "type": "integer"},
                        "age_16": {"title": "Age 16", "type": "integer"},
                        "age_17": {"title": "Age 17", "type": "integer"},
                        "age_18": {"title": "Age 18", "type": "integer"},
                    },
                    "required": ["age_15", "age_16", "age_17", "age_18"],
                ...
                "EligibilityType": {
                    "description": "An enumeration.",
                    "enum": ["age-17-18", "free", "underage", "age-18"],
                ...
                "OfferResponse": {
                    "properties": {
                        ...
                        "isHeadline": {"title": "Isheadline", "type": "boolean"},
                        "isReleased": {"title": "Isreleased", "type": "boolean"},
                ...
                "OfferVenueResponse": {
                    "properties": {
                        ...
                        "id": {"title": "Id", "type": "integer"},
                        "isPermanent": {"title": "Ispermanent", "type": "boolean"},
                        "isOpenToPublic": {"title": "Isopentopublic", "type": "boolean"},
                        "name": {"title": "Name", "type": "string"},
                    ...
                    "required": ["id", "offerer", "name", "coordinates", "isPermanent", "isOpenToPublic", "timezone"],
                ...
                "SettingsResponse": {
                    "properties": {
                        ...
                        "depositAmountsByAge": {"$ref": "#/components/schemas/DepositAmountsByAge"},
                        ...
                        "wipEnableCreditV3": {"title": "Wipenablecreditv3", "type": "boolean"},
                    },
                    "required": [
                ...
                "SubcategoryResponseModelv2": {
                    "properties": {
                        ...
                        "homepageLabelName": {"title": "Homepagelabelname", "type": "string"},
                        "id": {"title": "Id", "type": "string"},
                        "isEvent": {"title": "Isevent", "type": "boolean"},
                        "nativeCategoryId": {"nullable": True, "title": "Nativecategoryid", "type": "string"},
                        "onlineOfflinePlatform": {"$ref": "#/components/schemas/OnlineOfflinePlatformChoicesEnum"},
                        "searchGroupName": {"title": "Searchgroupname", "type": "string"},
                    },
                    "required": [
                        "id",
                        "categoryId",
