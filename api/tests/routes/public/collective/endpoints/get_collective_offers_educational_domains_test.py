...
class CollectiveOffersGetEducationalDomainsTest:
    def test_list_educational_domains(self, client):
        ...
        response = client.with_explicit_token(offerers_factories.DEFAULT_CLEAR_API_KEY).get(
            url_for("public_api.v2_prefixed_public_api.collectives_offers.list_educational_domains")
        )
    ...
    def test_list_educational_domains_anonymous_returns_401(self, client):
        ...
        # When
        response = client.get(url_for("public_api.v2_prefixed_public_api.collectives_offers.list_educational_domains"))
