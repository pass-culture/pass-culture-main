    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                403,
                {"code": "CONFIRMATION_LIMIT_DATE_HAS_PASSED"},
            ),
...
class ResetCollectiveBookingTest(AdageMockEndpointHelper):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                factories.PendingReimbursementCollectiveBookingFactory,
                {"code": "CANNOT_SET_BACK_REIMBURSED_BOOKING_TO_PENDING"},
            ),
...
class RepayCollectiveBookingTest(AdageMockEndpointHelper):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (factories.PendingReimbursementCollectiveBookingFactory, {"code": "CANNOT_REIMBURSE_REIMBURSED_BOOKING"}),
