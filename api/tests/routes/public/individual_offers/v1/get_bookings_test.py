            ...
            "bookings": [
                {
                    ...
                    "offerDepartementCode": booking.stock.offer.offererAddress.address.departmentCode,
        ...
        assert response.json == {
            "bookings": [
                ...
                },
                {
                    ...
                    "offerDepartementCode": booking_2.stock.offer.offererAddress.address.departmentCode,
                    "venueId": venue_provider.venue.id,
                    "venueName": venue_provider.venue.name,
                    "userFirstName": booking_2.user.firstName,
                    "userLastName": booking_2.user.lastName,
        ...
        assert response.json == {
            "bookings": [
                ...
                },
                {
                    ...
                    "offerDepartementCode": booking_3.stock.offer.offererAddress.address.departmentCode,
                    "venueId": venue_provider.venue.id,
                    "venueName": venue_provider.venue.name,
