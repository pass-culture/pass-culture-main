...
class GetBookingsByTokenReturns200Test:
    def test_key_has_rights_and_regular_product_offer(self, client):
        ...
        assert response.json == {
            ...
            "pagination": {
                ...
                "limitPerPage": 50,
                "pagesLinks": {
                    "current": "http://localhost/public/bookings/v1/bookings?page=1&limit=50",
                    "first": "http://localhost/public/bookings/v1/bookings?page=1&limit=50",
                    "last": "http://localhost/public/bookings/v1/bookings?page=1&limit=50",
                    "next": None,
                    "previous": None,
                },
            },
    ...
    def test_multiple_pages(self, client):
        ...
        assert response.json == {
            ...
            "pagination": {
                ...
                "limitPerPage": 2,
                "pagesLinks": {
                    "current": "http://localhost/public/bookings/v1/bookings?page=1&limit=2",
                    "first": "http://localhost/public/bookings/v1/bookings?page=1&limit=2",
                    "last": "http://localhost/public/bookings/v1/bookings?page=2&limit=2",
                    "next": "http://localhost/public/bookings/v1/bookings?page=2&limit=2",
                    "previous": None,
                },
            },
        }
    ...
    def test_second_page(self, client):
        ...
        response = client.with_explicit_token(offerers_factories.DEFAULT_CLEAR_API_KEY).get(
            f"/public/bookings/v1/bookings?offer_id={event_offer.id}&limit=2&page=2",
        )
        ...
        assert response.json == {
            ...
            "pagination": {
                ...
                "limitPerPage": 2,
                "pagesLinks": {
                    "current": "http://localhost/public/bookings/v1/bookings?page=2&limit=2",
                    "first": "http://localhost/public/bookings/v1/bookings?page=1&limit=2",
                    "last": "http://localhost/public/bookings/v1/bookings?page=2&limit=2",
                    "next": None,
                    "previous": "http://localhost/public/bookings/v1/bookings?page=1&limit=2",
                },
            },
        }
...
class GetBookingsByOfferReturns404Test:
    def test_request_inexisting_page(self, client):
        ...
        response = client.with_explicit_token(offerers_factories.DEFAULT_CLEAR_API_KEY).get(
            f"/public/bookings/v1/bookings?offer_id={product_offer.id}&page=2",
        )
