...
ROLE_PERMISSIONS: dict[str, list[perm_models.Permissions]] = {
    ...
    "support_pro": [
        ...
        perm_models.Permissions.CLOSE_VENUE,
        perm_models.Permissions.REOPEN_VENUE,
    ...
    "support_pro_n2": [
        ...
        perm_models.Permissions.MOVE_COLLECTIVE_OFFER,
    ...
    "gestion_catalogue": [
        perm_models.Permissions.BLACKLIST_ARTISTS,
        perm_models.Permissions.MANAGE_ARTISTS,
        perm_models.Permissions.READ_OFFERS,
    ],
}
