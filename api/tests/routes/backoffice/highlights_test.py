...
class ListHighlightsTest(GetEndpointHelper):
    ...
    def test_without_filters(self, authenticated_client):
        ...
        assert (
            rows[0]["Dates des demandes de participation"]
        ...
        assert (
            rows[1]["Dates des demandes de participation"]
...
class CreateHighlightTest(PostEndpointHelper):
    ...
    def test_create_highlight_in_the_past(self, authenticated_client):
        ...
        assert (
            html_parser.extract_alert(response.data)
            == "Les données envoyées comportent des erreurs. Dates de disponibilité des demandes de participation : "
            "La date de fin de demande de participation ne peut pas être dans le passé ; Dates du temps fort : La date "
    ...
    def test_create_highlight_missing_field_should_fail(self, authenticated_client):
        ...
        assert (
            ...
            "Description : La description est obligatoire ; Dates de disponibilité des demandes de participation : "
            "Les dates de demande sont obligatoires ; Dates du temps fort : Les dates du temps fort sont obligatoires ; "
            "Image du temps fort : L'image du temps fort est obligatoire ;"
        )
