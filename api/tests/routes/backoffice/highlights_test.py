...
class CreateHighlightTest(PostEndpointHelper):
    ...
    def test_create_highlight_in_the_past_should_fail(self, authenticated_client):
        ...
        assert (
            ...
            "Date de valorisation : La date de valorisation ne peut pas être dans le passé ;"
        )
    ...
    def test_create_highlight_missing_field_should_fail(self, authenticated_client):
        ...
        assert (
            ...
            "Les dates de l'évènement sont obligatoires ; Date de valorisation : La date de valorisation est obligatoire ; "
...
class UpdateHighlightTest(PostEndpointHelper):
    ...
    def test_update_highlight_missing_field_should_fail(self, authenticated_client):
        ...
        assert (
            ...
            "Date de valorisation : La date de valorisation est obligatoire ;"
        )
