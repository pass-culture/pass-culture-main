...
class ListAlgoliaOffersTest(GetEndpointHelper):
    ...
    def test_list_offers_filter_on_price(self, authenticated_client):
        ...
        with patch("pcapi.routes.backoffice.offers.blueprint.seach_offers_ids", return_value=[]) as algolia_mock:
...
class BatchOfferValidateTest(PostEndpointHelper):
    ...
    def test_batch_validate_offers(self, legit_user, authenticated_client):
        ...
        # user_session, user, select offer (3 in 1 query), update offer (3 in 1 query), fetch feature flag WIP_ENABLE_BREVO_PRO_SUBACCOUNT (1 query)
