...
class ActivateOrDeactivateOffererHelper(PostEndpointHelper):
    ...
    def test_should_update_brevo_contacts(self, authenticated_client, clear_redis):
        offerer = offerers_factories.OffererFactory(
...
class DownloadReimbursementDetailsTest(PostEndpointHelper):
    endpoint = "backoffice.offerer.download_reimbursement_details"
    endpoint_kwargs = {"offerer_id": 1}
    needed_permission = perm_models.Permissions.READ_PRO_ENTITY
...
class DownloadInvoicesTest(PostEndpointHelper):
    endpoint = "backoffice.offerer.download_invoices"
    endpoint_kwargs = {"offerer_id": 1}
    needed_permission = perm_models.Permissions.READ_PRO_ENTITY
