...
class GetOffererStatsTest(GetEndpointHelper):
    ...
    # get offerer (1 query)
    # get collectie offer templates count (1 query)
    ...
    def test_get_stats(self, authenticated_client, venue_factory, expected_revenue_text):
        ...
        assert (
            "Offres 137 Individuelles 125 réservables | 12 non réservables 56 Collectives 54 réservables | 2 non réservables 1 Vitrines"
            == cards_text[0]
        )
    ...
    def test_clickhouse_connector_raises_api_error(self, mock_run_query, authenticated_client):
        ...
        assert (
            "Offres N/A Individuelles N/A réservables | N/A non réservables N/A Collectives N/A réservables | N/A non réservables 0 Vitrines"
            in html_parser.extract_cards_text(response.data)[0]
        )
        assert "Réservations N/A Individuelles N/A Collectives" in html_parser.extract_cards_text(response.data)[1]
    ...
    def test_offerer_without_venues(self, mock_run_query, authenticated_client):
        ...
        assert (
            "Offres N/A Individuelles N/A réservables | N/A non réservables N/A Collectives N/A réservables | N/A non réservables N/A Vitrines"
            in html_parser.extract_cards_text(response.data)[0]
        )
        assert "Réservations N/A Individuelles N/A Collectives" in html_parser.extract_cards_text(response.data)[1]
        assert "Chiffre d'affaires total réalisé N/A" in html_parser.extract_cards_text(response.data)[2]
