...
class GetUserActivityTest(GetEndpointHelper):
    ...
    def test_get_beneficiary_activity(self, authenticated_client):
        ...
        first_chronicle = chronicles_factories.ChronicleFactory(
            user=user, ean="9782370730541", dateCreated=datetime.datetime.utcnow() - datetime.timedelta(days=3)
        )
        offers_factories.ProductFactory(ean="9782370730541", name="Le Backoffice pour les nuls")
