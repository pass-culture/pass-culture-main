...
class GetProductDetailsTest(GetEndpointHelper):
    ...
    def test_get_detail_product(self, mock_get_by_ean13, authenticated_client):
        ...
        offers_factories.OfferFactory(product=product, ean="1234567891234")

        # offre non liées au produit
        offers_factories.OfferFactory(ean="1234567891234")
    ...
    def test_get_detail_product_check_offer_format(self, mock_get_by_ean13, authenticated_client):
        ...
        offer = offers_factories.OfferFactory(
            product=product, venue=offerers_factories.VenueFactory(name="Venue 1"), ean="1234567891234"
        )
        offers_factories.StockFactory(offer=offer, price=10)

        # offre non liées au produit
        unlinked_offer = offers_factories.OfferFactory(
            venue=offerers_factories.VenueFactory(name="Venue 2"), ean="1234567891234"
        )
...
class GetProductLinkOfferFormTest(PostEndpointHelper):
    ...
    def test_confirm_product_link_offers_form(self, authenticated_client):
        ...
        unlinked_offers = [offers_factories.OfferFactory(ean="1234567891234") for _ in range(10)]
