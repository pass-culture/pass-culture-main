...
class SetPricingPointTest(PostEndpointHelper):
    ...
    def test_set_pricing_point(self, authenticated_client):
        ...
        redirected_response = authenticated_client.get(response.headers["location"])
        assert html_parser.extract_alert(redirected_response.data) == "Ce lieu à été lié a un point de valorisation"
    ...
    def test_venue_already_has_a_pricing_point(self, authenticated_client, venue_with_no_siret):
        ...
        redirected_response = authenticated_client.get(response.headers["location"])
        assert html_parser.extract_alert(redirected_response.data) == "Ce lieu est déja lié a un point de valorisation"
