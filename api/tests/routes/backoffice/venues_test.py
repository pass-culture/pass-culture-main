...
class DeleteVenueTest(PostEndpointHelper):
    ...
    def test_cant_delete_venue_when_custom_reimbursement_rule_is_active(self, legit_user, authenticated_client):
        venue_to_delete = offerers_factories.VenueFactory(pricing_point="self")
        ...
        assert (
            "Impossible de supprimer un point de valorisation ayant un tarif dérogatoire actif ou futur."
