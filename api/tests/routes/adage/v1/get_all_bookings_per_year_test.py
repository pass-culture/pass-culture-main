            ...
            "bookings": [
                {
                    ...
                    "totalAmount": booking1.stock.price,
                    ...
                    "domainIds": [domain.id for domain in booking1.stock.offer.domains],
                    "domainLabels": [domain.name for domain in booking1.stock.offer.domains],
                },
                {
                    "id": booking2.id,
                    ...
                    "totalAmount": booking2.stock.price,
                    ...
                    "domainIds": [domain.id for domain in booking2.stock.offer.domains],
                    "domainLabels": [domain.name for domain in booking2.stock.offer.domains],
                },
            ],
        }
