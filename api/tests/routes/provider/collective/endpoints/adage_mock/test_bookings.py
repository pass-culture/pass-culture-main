...
from tests.routes.provider.helpers import PublicAPIRestrictedEnvEndpointHelper
from tests.routes.provider.helpers import assert_attribute_does_not_change
from tests.routes.provider.helpers import assert_attribute_value_changes_to
...
class UseCollectiveBookingTest(AdageMockEndpointHelper):
    ...
    @patch("pcapi.routes.provider.collective.endpoints.adage_mock.bookings.finance_api")
