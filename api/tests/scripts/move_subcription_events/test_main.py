...
from pcapi.scripts.move_subcription_events.main import move_subscription_and_credit_destination_account
from pcapi.settings import CREDIT_V3_DECREE_DATETIME


@pytest.mark.usefixtures("db_session")
@patch("pcapi.scripts.move_subcription_events.main.read_user_ids_from_csv")
...
def test_subscription_move_and_activation(read_csv_mock):
    ...
    with time_machine.travel(last_year):
        credited_account = users_factories.BeneficiaryFactory(age=17, _phoneNumber="+33123456789")
