"""
Code de pytest-flask-sqlalchemy rappatrié en interne car la modif permettant
d'utiliser sqlalchemy 1.4 n'a jamais été releasée (2022/03/09).
"""
...
@pytest.fixture(scope='function')
def db_session(config, _engine, _session, _transaction):
    '''
