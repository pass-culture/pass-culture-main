...
class SendNotificationFavoritesNotBookedTest:
    @override_features(WIP_DISABLE_NOTIFICATION_FAVORITE_NOT_BOOKED=False)
    def test_send(self):
        rows = [
    ...
    @override_features(WIP_DISABLE_NOTIFICATION_FAVORITE_NOT_BOOKED=True)
    def test_send_with_disabled_notification_cancel_booking(self):
        rows = [
            {"offer_id": 1, "offer_name": "my offer", "user_ids": [1, 2], "count": 2},
            {"offer_id": 2, "offer_name": "another offer", "user_ids": [3], "count": 1},
        ]
