    ...
    with caplog.at_level(logging.INFO):
        client.get(
            ...
            headers={
                ...
                "request-id": "abcd",
                "X-Forwarded-For": "82.65.58.211, front",
                "app-version": "1.230.0",
                "code-push-id": "1234",
                "commit-hash": "abcefgh",
                "platform": "ios",
...
KNOWN_PUBLIC_ENDPOINTS = [
    ...
    "native.native_v1.get_offer_pro_advices",  # → response.status_code = 400
    "native.native_v1.get_venue_advices",  # → response.status_code = 200
    ...
    "native.native_v1.sso_oauth_state",  # → response.status_code = 200
