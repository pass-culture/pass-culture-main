...
from pcapi.core.mails.transactional.pro.offer_validation_to_pro import (
    get_email_data_from_offer,
    retrieve_data_for_offer_approval_email,
    retrieve_data_for_offer_rejection_email,
