...
class FindUsersThatFailedUbbleTest:
    ...
    def should_find_correct_reason_codes(self):
        ...
        assert result == [(user, subscription_models.FraudReasonCode.ID_CHECK_UNPROCESSABLE)]
...
class SendUbbleKoReminderReminderTest:
    ...
    def should_send_21_days_reminders(self):
        ...
        user2 = build_user_with_ko_retryable_ubble_fraud_check(
            reasonCodes=[subscription_models.FraudReasonCode.ID_CHECK_EXPIRED], ubble_date_created=twenty_one_days_ago
        )
    ...
    def should_send_email_for_most_relevant_error_to_user_for_quick_action(self, reason_code):
        ...
        other_reason_code = subscription_models.FraudReasonCode.ID_CHECK_BLOCKED_OTHER
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            < ubble_errors.UBBLE_CODE_ERROR_MAPPING[subscription_models.FraudReasonCode.DUPLICATE_USER].priority
        ],
    )
    def should_not_send_email_if_most_relevant_is_not_retryable(self, reason_code):
        # DUPLICATE_USER is not retryable
        other_reason_code = subscription_models.FraudReasonCode.DUPLICATE_USER
