...
from pcapi.core.mails.transactional.users.offer_link_to_ios_user import (
    get_offer_link_to_ios_user_email_data,
    send_offer_link_to_ios_user_email,
)
...
class SendinblueEmailOfferLinkIosUserTest:
    ...
    def test_send_correct_mail(self):
        ...
        assert mails_testing.outbox[0]["template"] == TransactionalEmail.OFFER_WEBAPP_LINK_TO_IOS_USER.value.__dict__
