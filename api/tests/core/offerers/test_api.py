...
class DeleteVenueTest:
    ...
    def test_delete_cascade_venue_should_delete_expired_custom_reimbursement_rule(self):
        venue = offerers_factories.VenueFactory()
    ...
    @pytest.mark.parametrize(
        "timespan",
        [
            [datetime.datetime.utcnow() - datetime.timedelta(days=100), None],
            [
...
class DeleteOffererTest:
    ...
    def test_delete_cascade_offerer_should_delete_expired_custom_reimbursement_rule(self):
        offerer = offerers_factories.OffererFactory()
