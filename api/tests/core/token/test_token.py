...
class TokenTest:
    ...
    def test_creat_token_then_get_data(self):
        ...
        with freeze_time("2021-01-01"):
            token = token_tools.create_token(self.token_type, self.ttl, self.user_id, self.data)
    ...
    def test_create_token_with_no_data_no_ttl(self):
        ...
        with freeze_time("2021-01-01"):
            token = token_tools.create_token(self.token_type, None, self.user_id)
    ...
    def test_token_from_encoded_token_and_get_data(self):
        ...
        with freeze_time("2021-01-01"):
            old_token = token_tools.create_token(
                self.token_type,
                self.ttl,
                self.user_id,
                self.data,
