...
class QuotientFamilialApplicationTest:
    ...
    @patch("pcapi.connectors.api_particulier.get_quotient_familial")
    def test_get_quotient_familial_caches_calls(self, mocked_get_quotient_familial):
        custodian = subscription_factories.BonusCreditPersonFactory()
        fraud_check = subscription_factories.QFBonusCreditFraudCheckFactory(
            status=subscription_models.FraudCheckStatus.STARTED,
            resultContent=subscription_factories.QuotientFamilialBonusCreditContentFactory.build(
...
class DisabledAdultAllowanceTest:
    ...
    def test_not_recipient_for_disabled_adult_allowance_bonus(self, record_attempt_mock):
        ...
        with requests_mock.Mocker() as mock:
            mock.get(api_particulier.AAH_ENDPOINT, json=bonus_fixtures.AAH_NOT_RECIPIENT_RESPONSE)
...
class DisabledChildEducationAllowanceTest:
    ...
    def test_not_recipient_for_disabled_child_education_allowance_bonus(self, record_attempt_mock):
        ...
        with requests_mock.Mocker() as mock:
            mock.get(api_particulier.AEEH_ENDPOINT, json=bonus_fixtures.AEEH_NOT_RECIPIENT_RESPONSE)
    ...
    def test_bonus_fraud_checks_deletion_when_granted(self):
        ...
        with requests_mock.Mocker() as mock:
            mock.get(api_particulier.AEEH_ENDPOINT, json=bonus_fixtures.AEEH_RECIPIENT_RESPONSE)
