...
from pcapi.core.users.constants import ELIGIBILITY_AGE_18, ELIGIBILITY_END_AGE
from pcapi.models import db
from pcapi.repository import repository

from tests.scripts.beneficiary.fixture import make_parsed_graphql_application, make_single_application
