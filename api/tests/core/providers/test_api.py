...
class DeleteVenueProviderTest:
    ...
    def test_delete_venue_provider(self, mocked_update_venue_offers_active_status_task):
...
class DisableVenueProviderTest:
    @mock.patch("pcapi.core.offers.tasks.update_venue_offers_active_status_task.delay")
    def test_disable_venue_provider(self, mocked_update_venue_offers_active_status_task):
        user = users_factories.UserFactory()
        venue_provider = providers_factories.VenueProviderFactory()
        venue = venue_provider.venue

        request = PostVenueProviderBody(provider_id=venue_provider.providerId, is_active=False)
