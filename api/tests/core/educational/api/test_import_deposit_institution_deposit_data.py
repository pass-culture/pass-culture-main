...
class ImportDepositInstitutionDataTest:
    def test_create_institution(self) -> None:
        ...
        import_deposit_institution_data(
            ...
            period_option=ImportDepositPeriodOption.EDUCATIONAL_YEAR,
            final=False,
            conflict="crash",
        )
...
class ImportDepositPeriodTest:
    ...
    def test_deposit_period_educational_year(self, with_existing_deposit):
    ...
    def test_deposit_period_educational_year_overlap_error(self):
        year = educational_factories.EducationalYearFactory()
        institution = educational_factories.EducationalInstitutionFactory(institutionId="0470010E")
    ...
    @pytest.mark.parametrize("with_existing_deposit", (True, False))
    def test_deposit_period_first_civil_year(self, with_existing_deposit):
        year = educational_factories.EducationalYearFactory()
        institution = educational_factories.EducationalInstitutionFactory(institutionId="0470010E")
        if with_existing_deposit:
        ...
        import_deposit_institution_data(
            ...
            educational_year=year,
            ministry=educational_models.Ministry.EDUCATION_NATIONALE,
            period_option=ImportDepositPeriodOption.FIRST_CIVIL_YEAR,
            final=True,
            conflict="keep",
        )
    ...
    def test_deposit_period_first_civil_year_overlap_error(self):
        year = educational_factories.EducationalYearFactory()
        institution = educational_factories.EducationalInstitutionFactory(institutionId="0470010E")
    ...
    @pytest.mark.parametrize("with_existing_deposit", (True, False))
    def test_deposit_period_second_civil_year(self, with_existing_deposit):
        year = educational_factories.EducationalYearFactory()
        institution = educational_factories.EducationalInstitutionFactory(institutionId="0470010E")
        if with_existing_deposit:
        ...
        import_deposit_institution_data(
            ...
            educational_year=year,
            ministry=educational_models.Ministry.EDUCATION_NATIONALE,
            period_option=ImportDepositPeriodOption.SECOND_CIVIL_YEAR,
            final=True,
            conflict="keep",
        )
    ...
    def test_deposit_period_second_civil_year_overlap_error(self):
        year = educational_factories.EducationalYearFactory()
        institution = educational_factories.EducationalInstitutionFactory(institutionId="0470010E")
        deposit = educational_factories.EducationalDepositFactory(
            educationalInstitution=institution, educationalYear=year
    ...
    @pytest.mark.parametrize("with_existing_deposit", (True, False))
    def test_deposit_period_second_civil_year_with_previous_period_in_db(self, with_existing_deposit):
        year = educational_factories.EducationalYearFactory()
        institution = educational_factories.EducationalInstitutionFactory(institutionId="0470010E")
        if with_existing_deposit:
            educational_factories.EducationalDepositSecondPeriodFactory(
