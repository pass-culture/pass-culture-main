...
def _generate_bookings(deposit, institution, year) -> None:
    ...
    ConfirmedCollectiveBookingFactory.create_batch(
        ...
        collectiveStock__startDatetime=datetime.datetime(year=year.beginningDate.year, month=10, day=1),
    )
    ...
    ConfirmedCollectiveBookingFactory.create_batch(
        ...
        educationalYear=year,
        educationalDeposit=deposit,
        collectiveStock__startDatetime=datetime.datetime(year=year.beginningDate.year + 1, month=2, day=1),
    )
