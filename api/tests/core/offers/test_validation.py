...
class ValidateEventOpeningHoursCanBeUpdatedTest:
    ...
    def assert_is_not_valid(self, **kwargs):
        error = kwargs.pop("err", exceptions.EventOpeningHoursError)
        body = schemas.UpdateEventOpeningHoursModel(**kwargs)
    ...
    def test_the_event_has_been_soft_deleted_any_update_is_not_ok(self):
        ...
        new_start_date = now_with_offset(5)
        self.assert_is_not_valid(startDatetime=new_start_date, err=exceptions.EventOpeningHoursIsSoftDeleted)
    ...
    def test_the_event_has_ended_any_update_is_not_ok(self):
        ...
        new_start_date = now_with_offset(5)
        self.assert_is_not_valid(startDatetime=new_start_date, err=exceptions.EventOpeningHoursEndPassed)
    ...
    def test_new_start_after_current_event_end_is_not_ok(self):
        ...
        self.assert_is_not_valid(startDatetime=new_start_date, err=exceptions.EventOpeningHoursNewStartAfterEnd)

    def test_new_start_too_close_is_not_ok(self):
        new_start_date = now_with_offset(1)
        self.assert_is_not_valid(startDatetime=new_start_date, err=exceptions.EventOpeningHoursStartsTooSoon)

    def test_new_end_too_close_is_not_ok(self):
        new_end_date = now_with_offset(1)
        self.assert_is_not_valid(endDatetime=new_end_date, err=exceptions.EventOpeningHoursEndsTooSoon)
