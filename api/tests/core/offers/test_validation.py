...
class CheckOfferUpdateTest:
    ...
    def test_should_delegate_the_status_check(self, check_validation_status, venue_provider):
        ...
        validation.check_offer_update(offer, {}, mandatory_extra_data_fields=set(), venue_provider=venue_provider)
    ...
    def test_should_return_early_when_no_field_changes(self, fields, venue_provider):
        ...
        validation.check_offer_update(offer, fields, mandatory_extra_data_fields=set(), venue_provider=venue_provider)
