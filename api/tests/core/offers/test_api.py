...
class MoveOfferTest:
    ...
    def test_move_offer_deletes_pro_advice(self):
        """Moving an offer from a venue to another venue should delete the pro advice"""
        offer = factories.OfferFactory()
    ...
    def test_move_event_offer_deletes_pro_advice(self):
        """Moving an event offer from a venue to another venue should delete the pro advice"""
        offerer = offerers_factories.OffererFactory()
        venue = offerers_factories.VenueFactory(managingOfferer=offerer)
        offerers_factories.VenuePricingPointLinkFactory(
            venue=venue,
