...
from pcapi.core.products import api as product_api
...
class UpsertMovieProductFromProviderTest:
    ...
    def test_creates_allocine_product_without_visa_if_does_not_exist(self):
        ...
        product = product_api.upsert_movie_product_from_provider(movie, self.allocine_provider, "idAllocine")
    ...
    def test_does_not_create_product_if_exists(self):
        ...
        new_product = product_api.upsert_movie_product_from_provider(movie, self.allocine_provider, "idAllocine")
    ...
    def test_updates_product_if_exists(self):
        ...
        # When
        product_api.upsert_movie_product_from_provider(movie, self.allocine_provider, "idAllocine")
    ...
    def test_does_not_update_allocine_product_from_non_allocine_synchro(self):
        ...
        # When
        product_api.upsert_movie_product_from_provider(movie, self.boost_provider, "idBoost")
    ...
    def test_updates_allocine_product_from_allocine_stocks_synchro(self):
        ...
        product_api.upsert_movie_product_from_provider(movie, self.allocine_stocks_provider, "idAllocineStocks")
    ...
    def test_updates_product_from_same_synchro(self):
        ...
        product_api.upsert_movie_product_from_provider(movie, self.boost_provider, "idBoost2")
    ...
    def test_updates_allocine_id_when_updates_product_by_visa(self):
        ...
        product_api.upsert_movie_product_from_provider(movie, self.allocine_stocks_provider, "idAllocine")
    ...
    def test_handles_coexisting_incomplete_movies(self, caplog):
        ...
        with caplog.at_level(logging.INFO):
            product_api.upsert_movie_product_from_provider(movie, self.allocine_stocks_provider, "idAllocineProducts")
    ...
    def test_should_not_merge_when_visa_and_allocineId_sent_by_provider_are_incoherent(self, caplog):
        ...
        with caplog.at_level(logging.WARNING):
            product = product_api.upsert_movie_product_from_provider(movie, self.boost_provider, "idBoostProducts")
...
class WhitelistExistingProductTest:
    ...
    def test_modify_product_if_existing_and_not_gcu_compatible(self, requests_mock, settings):
        ...
        product_api.whitelist_product(ean)
...
class ProductCountsConsistencyTest:
    def test_chronicles_count(self) -> None:
        ...
        assert product_api.fetch_inconsistent_products() == {product_1.id}
    ...
    def test_likes_count(self) -> None:
        ...
        assert product_api.fetch_inconsistent_products() == {product.id}
