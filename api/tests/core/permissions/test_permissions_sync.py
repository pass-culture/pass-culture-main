...
def test_sync_first_perms():
    ...
    # when
    perm_models.sync_enum_with_db_field(db.session, TestPermissions, "name", perm_models.Permission)
...
def test_sync_new_roles():
    ...
    # when
    perm_models.sync_enum_with_db_field(db.session, TestRoles, "value", perm_models.Role)
