...
class FormatUserAttributesTest:
    ...
    def test_format_pro_attributes(self):
        ...
        assert formatted_attributes == {
            ...
            "VENUE_ACTIVITY": "BOOKSTORE,CINEMA",
            "VENUE_COUNT": 2,
            "VENUE_CULTURAL_DOMAINS": "Arts numériques,Danse",
...
class BulkImportUsersDataTest:
    ...
    def test_add_contacts_to_list(self, mock_import_contacts, use_pro_subaccount):
        ...
        mock_import_contacts.assert_called_once_with(
            ...
            notify_url=f"{settings.API_URL}/webhooks/brevo/importcontacts/{SENDINBLUE_AUTOMATION_TEST_CONTACT_LIST_ID}/1?token={settings.BREVO_WEBHOOK_SECRET_QUERY_PARAM}",
        )
