        ...
        assert mocked_execute_query.call_args_list[2].kwargs == {
            "variables": {
                "input": {
                    ...
                    "motivation": "Dossier classé sans suite car l'email est déjà utilisé par un compte crédité",
                }
            }
        }
        ...
        assert mocked_execute_query.call_args_list[2].kwargs == {
            "variables": {
                "input": {
                    ...
                    "instructeurId": instructor.backoffice_profile.dsInstructorId,
                    "disableNotification": False,
                    "motivation": "Dossier classé sans suite car l'email est en doublon",
                }
            }
        }
        ...
        assert mocked_execute_query.call_args_list[1].kwargs == {
            "variables": {
                "input": {
                    ...
                    "instructeurId": instructor.backoffice_profile.dsInstructorId,
                    "disableNotification": False,
                    "motivation": "Dossier classé sans suite car le numéro de téléphone est déjà utilisé par un compte crédité",
                }
            }
        }
        ...
        assert mocked_execute_query.call_args_list[1].kwargs == {
            "variables": {
                "input": {
                    ...
                    "instructeurId": instructor.backoffice_profile.dsInstructorId,
                    "disableNotification": False,
                    "motivation": "Dossier classé sans suite car le numéro de téléphone est en doublon",
                }
            }
        }
        ...
        assert mocked_execute_query.call_args_list[1].kwargs == {
            "variables": {
                "input": {
                    ...
                    "instructeurId": instructor.backoffice_profile.dsInstructorId,
                    "disableNotification": False,
                    "motivation": "Dossier classé sans suite car les nom et prénom sont en doublon",
                }
            }
        }
