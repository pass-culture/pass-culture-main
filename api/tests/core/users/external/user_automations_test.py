...
class UserAutomationsTest:
    def _create_users_around_18(self):
        ...
        users_factories.BeneficiaryGrant18Factory(
            email="marc+test@example.net", dateOfBirth=today - relativedelta(days=DAYS_IN_18_YEARS - 29)
        )
        users_factories.BeneficiaryGrant18Factory(
            email="fabien+test@example.net", dateOfBirth=today - relativedelta(days=DAYS_IN_18_YEARS - 30)
        )
        users_factories.BeneficiaryGrant18Factory(
            email="daniel+test@example.net", dateOfBirth=today - relativedelta(days=DAYS_IN_18_YEARS - 31)
        )
        ...
        users_factories.ProFactory(
            email="pro+test@example.net", dateOfBirth=today - relativedelta(days=DAYS_IN_18_YEARS - 30)
        )
        users_factories.UnderageBeneficiaryFactory(
            email="gerard+test@example.net", dateOfBirth=today - relativedelta(days=DAYS_IN_18_YEARS - 30)
        )
    ...
    def test_user_turned_eighteen_automation(
        ...
        result = users_turned_eighteen_automation()
    ...
    def test_user_ex_beneficiary_automation(
        ...
        with freeze_time("2022-12-01 16:00:00"):
            result = users_ex_beneficiary_automation()
