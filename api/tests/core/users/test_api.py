...
class ExtractBeneficiaryDataTest(StorageFolderManager):
    ...
    # 12 select user (authorUser)
    # 13 insert action history
    expected_queries = 13
    # 1 json
    # 2 pdf
...
class BypassEmailConfirmationTest:
    @override_settings(ENABLE_EMAIL_CONFIRMATION_BYPASS=False)
    ...
    @override_settings(ENABLE_EMAIL_CONFIRMATION_BYPASS=True)
