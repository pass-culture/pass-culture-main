import{a as e,n as t}from"./chunk-BneVvdWh.js";import{t as n}from"./react-B_0iYUWB.js";import{t as r}from"./jsx-runtime-fcfuQg7E.js";import{n as i,t as a}from"./SvgIcon-DFqNzU7T.js";import{n as o,t as s}from"./TextInput-CErLASbm.js";import{i as c,n as l,r as u,t as d}from"./iconsList-CmXLHJ2O.js";import{n as f,t as p}from"./stroke-search-CKs6hgjA.js";var m,h,g,_,v,y=t((()=>{m=`_title_1490c_1`,h=`_container_1490c_28`,g=`_name_1490c_41`,_=`_icon_1490c_7`,v={title:m,"icon-stories":`_icon-stories_1490c_7`,"icon-list":`_icon-list_1490c_13`,"search-input-container":`_search-input-container_1490c_21`,container:h,name:g,"name-container":`_name-container_1490c_44`,"copy-to-clipboard":`_copy-to-clipboard_1490c_48`,"icon-container":`_icon-container_1490c_51`,"copy-to-clipboard-wrapper":`_copy-to-clipboard-wrapper_1490c_59`,icon:_}})),b,x,S,C,w,T,E;t((()=>{b=e(n(),1),i(),p(),y(),l(),o(),x=r(),S=(e,t)=>(e=`.*`+e.toLowerCase().split(``).join(`.*`)+`.*`,new RegExp(e).test(t.toLowerCase())),C=[{title:`Full icons`,icons:d},{title:`Stroke icons`,icons:c},{title:`Other icons`,icons:u}],w=()=>{let[e,t]=(0,b.useState)(``),n=async e=>{e.persist();let t=e.currentTarget;await navigator.clipboard.writeText(t.getAttribute(`data-src`)??``),t.classList.add(v[`copy-to-clipboard`]);let n=setTimeout(()=>{t.classList.remove(v[`copy-to-clipboard`]),clearTimeout(n)},600)};return(0,x.jsxs)(`div`,{className:v[`icon-stories`],children:[(0,x.jsx)(`div`,{className:v[`search-input-container`],children:(0,x.jsx)(s,{name:`search`,label:`Rechercher une icon`,icon:f,onChange:e=>t(e.target.value),value:e})}),C.map(t=>{let r=t.icons.filter(t=>S(e,t.src));return r.length===0?null:(0,x.jsxs)(`div`,{children:[(0,x.jsx)(`h1`,{className:v.title,children:t.title}),(0,x.jsx)(`div`,{className:v[`icon-list`],children:r.map(e=>{let t=e.src.split(`/`),r=t[t.length-1].split(`.`)[0].replace(`full-`,``).replace(`stroke-`,``).replace(`shadow-`,``);return(0,x.jsxs)(`div`,{className:v.container,onClick:n,"data-src":e.src,children:[(0,x.jsx)(`div`,{className:v[`copy-to-clipboard-wrapper`],children:(0,x.jsx)(`span`,{children:`Copié !`})}),(0,x.jsx)(`div`,{className:v[`icon-container`],children:(0,x.jsx)(a,{src:e.src,alt:e.src,viewBox:e.viewBox,className:v.icon})}),(0,x.jsx)(`div`,{className:v[`name-container`],children:(0,x.jsx)(`span`,{className:v.name,children:r})})]},e.src)})})]},t.title)})]})},T={title:`@/icons/Icons`},w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`() => {
...
}`,...w.parameters?.docs?.source}}},E=[`Icons`]}))();export{w as Icons,E as __namedExportsOrder,T as default};