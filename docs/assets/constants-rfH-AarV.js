import{r as ct}from"./index-ClcD9ViR.js";import"./config-BdqymTTq.js";import{u as lt}from"./index-DOYoWpww.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bt{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(a=>{if($t(a)){const n=a.getImmediate();return`${n.library}/${n.version}`}else return null}).filter(a=>a).join(" ")}}function $t(e){const t=e.getComponent();return(t==null?void 0:t.type)==="VERSION"}const X="@firebase/app",de="0.11.5";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const I=new Z("@firebase/app"),Kt="@firebase/app-compat",Ht="@firebase/analytics-compat",Ut="@firebase/analytics",Vt="@firebase/app-check-compat",xt="@firebase/app-check",jt="@firebase/auth",Gt="@firebase/auth-compat",Wt="@firebase/database",qt="@firebase/data-connect",zt="@firebase/database-compat",Yt="@firebase/functions",Xt="@firebase/functions-compat",Jt="@firebase/installations",Qt="@firebase/installations-compat",Zt="@firebase/messaging",ea="@firebase/messaging-compat",ta="@firebase/performance",aa="@firebase/performance-compat",na="@firebase/remote-config",sa="@firebase/remote-config-compat",ra="@firebase/storage",ia="@firebase/storage-compat",oa="@firebase/firestore",ca="@firebase/vertexai",la="@firebase/firestore-compat",ua="firebase",da="11.6.1",ha={[X]:"fire-core",[Kt]:"fire-core-compat",[Ut]:"fire-analytics",[Ht]:"fire-analytics-compat",[xt]:"fire-app-check",[Vt]:"fire-app-check-compat",[jt]:"fire-auth",[Gt]:"fire-auth-compat",[Wt]:"fire-rtdb",[qt]:"fire-data-connect",[zt]:"fire-rtdb-compat",[Yt]:"fire-fn",[Xt]:"fire-fn-compat",[Jt]:"fire-iid",[Qt]:"fire-iid-compat",[Zt]:"fire-fcm",[ea]:"fire-fcm-compat",[ta]:"fire-perf",[aa]:"fire-perf-compat",[na]:"fire-rc",[sa]:"fire-rc-compat",[ra]:"fire-gcs",[ia]:"fire-gcs-compat",[oa]:"fire-fst",[la]:"fire-fst-compat",[ca]:"fire-vertex","fire-js":"fire-js",[ua]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Aa(e){A(new y("platform-logger",t=>new Bt(t),"PRIVATE")),A(new y("heartbeat",t=>new Sa(t),"PRIVATE")),E(X,de,e),E(X,de,"esm2017"),E("fire-js","")}Aa("");const $e="@firebase/installations",ae="0.6.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
