...
---`,displayName:`PriceInput`,props:{description:{defaultValue:null,description:``,name:`description`,required:!1,type:{name:`string`}},name:{defaultValue:null,description:`The name of the input, mind what's being used in the form.`,name:`name`,required:!1,type:{name:`string`}},max:{defaultValue:null,description:``,name:`max`,required:!1,type:{name:`string | number`}},disabled:{defaultValue:null,description:``,name:`disabled`,required:!1,type:{name:`boolean`}},required:{defaultValue:{value:`true`},description:``,name:`required`,required:!1,type:{name:`boolean`}},label:{defaultValue:null,description:`A label for the input,
