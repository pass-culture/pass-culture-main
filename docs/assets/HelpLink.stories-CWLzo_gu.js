import{j as O}from"./jsx-runtime-Nms4Y4qS.js";import{r as P}from"./index-BwDkhjyp.js";import"./config-yp2pWrHW.js";import{f as Qt}from"./full-help-Co3hxUDJ.js";import{S as Zt}from"./SvgIcon-Cibea2Sc.js";import"./_commonjsHelpers-BosuxZz1.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sn="FirebaseError";let H=class at extends Error{constructor(t,n,r){super(n),this.code=t,this.customData=r,this.name=sn,Object.setPrototypeOf(this,at.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,q.prototype.create)}},q=class{constructor(t,n,r){this.service=t,this.serviceName=n,this.errors=r}create(t,...n){const r=n[0]||{},a=`${this.service}/${t}`,s=this.errors[t],o=s?on(s,r):"Error",i=`${this.serviceName}: ${o} (${a}).`;return new H(a,i,r)}};function on(e,t){return e.replace(cn,(n,r)=>{const a=t[r];return a!=null?String(a):`<${r}?>`})}const cn=/\{\$([^}]+)}/g;/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ir="firebase-heartbeat-database",cr=1,B="firebase-heartbeat-store";let te=null;function ct(){return te||(te=ge(ir,cr,{upgrade:(e,t)=>{switch(t){case 0:try{e.createObjectStore(B)}catch(n){console.warn(n)}}}}).catch(e=>{throw pe.create("idb-open",{originalErrorMessage:e.message})})),te}async function lr(e){try{const n=(await ct()).transaction(B),r=await n.objectStore(B).get(lt(e));return await n.done,r}catch(t){if(t instanceof H)R.warn(t.message);else{const n=pe.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});R.warn(n.message)}}}async function $e(e,t){try{const r=(await ct()).transaction(B,"readwrite");await r.objectStore(B).put(t,lt(e)),await r.done}catch(n){if(n instanceof H)R.warn(n.message);else{const r=pe.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});R.warn(r.message)}}}function lt(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dt=1e4,ht=`w:${_e}`,ft="FIS_v2",$r="https://firebaseinstallations.googleapis.com/v1",Pr=60*60*1e3,Fr="installations",vr="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pt({projectId:e}){return`${$r}/projects/${e}/installations`}function mt(e){return{token:e.token,requestStatus:2,expiresIn:Hr(e.expiresIn),creationTime:Date.now()}}async function _t(e,t){const r=(await t.json()).error;return L.create("request-failed",{requestName:e,serverCode:r.code,serverMessage:r.message,serverStatus:r.status})}function Ct({apiKey:e}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":e})}function Br(e,{refreshToken:t}){const n=Ct(e);return n.append("Authorization",xr(t)),n}async function It(e){const t=await e();return t.status>=500&&t.status<600?e():t}function Hr(e){return Number(e.replace("s","000"))}function xr(e){return`${ft} ${e}`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kr({appConfig:e,heartbeatServiceProvider:t},{fid:n}){const r=pt(e),a=Ct(e),s=t.getImmediate({optional:!0});if(s){const l=await s.getHeartbeatsHeader();l&&a.append("x-firebase-client",l)}const o={fid:n,authVersion:ft,appId:e.appId,sdkVersion:ht},i={method:"POST",headers:a,body:JSON.stringify(o)},c=await It(()=>fetch(r,i));if(c.ok){const l=await c.json();return{fid:l.fid||n,registrationStatus:2,refreshToken:l.refreshToken,authToken:mt(l.authToken)}}else throw await _t("Create Installation",c)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bt=new Map;function wt(e,t){const n=z(e);Tt(n,t),qr(n,t)}function Tt(e,t){const n=bt.get(e);if(n)for(const r of n)r(t)}function qr(e,t){const n=Wr();n&&n.postMessage({key:e,fid:t}),zr()}let A=null;function Wr(){return!A&&"BroadcastChannel"in self&&(A=new BroadcastChannel("[Firebase] FID Change"),A.onmessage=e=>{Tt(e.data.key,e.data.fid)}),A}function zr(){bt.size===0&&A&&(A.close(),A=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yr="firebase-installations-database",Jr=1,N="firebase-installations-store";let ne=null;function Ce(){return ne||(ne=ge(Yr,Jr,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(N)}}})),ne}async function U(e,t){const n=z(e),a=(await Ce()).transaction(N,"readwrite"),s=a.objectStore(N),o=await s.get(n);return await s.put(t,n),await a.done,(!o||o.fid!==t.fid)&&wt(e,t.fid),t}async function St(e){const t=z(e),r=(await Ce()).transaction(N,"readwrite");await r.objectStore(N).delete(t),await r.done}async function Y(e,t){const n=z(e),a=(await Ce()).transaction(N,"readwrite"),s=a.objectStore(N),o=await s.get(n),i=t(o);return i===void 0?await s.delete(n):await s.put(i,n),await a.done,i&&(!o||o.fid!==i.fid)&&wt(e,i.fid),i}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ie(e){let t;const n=await Y(e.appConfig,r=>{const a=Xr(r),s=Qr(e,a);return t=s.registrationPromise,s.installationEntry});return n.fid===de?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}function Xr(e){const t=e||{fid:Ur(),registrationStatus:0};return yt(t)}function Qr(e,t){if(t.registrationStatus===0){if(!navigator.onLine){const a=Promise.reject(L.create("app-offline"));return{installationEntry:t,registrationPromise:a}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},r=Zr(e,n);return{installationEntry:n,registrationPromise:r}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:ea(e)}:{installationEntry:t}}async function Zr(e,t){try{const n=await Kr(e,t);return U(e.appConfig,n)}catch(n){throw gt(n)&&n.customData.serverCode===409?await St(e.appConfig):await U(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}async function ea(e){let t=await Me(e.appConfig);for(;t.registrationStatus===1;)await Et(100),t=await Me(e.appConfig);if(t.registrationStatus===0){const{installationEntry:n,registrationPromise:r}=await Ie(e);return r||n}return t}function Me(e){return Y(e,t=>{if(!t)throw L.create("installation-not-found");return yt(t)})}function yt(e){return ta(e)?{fid:e.fid,registrationStatus:0}:e}function ta(e){return e.registrationStatus===1&&e.registrationTime+dt<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function na({appConfig:e,heartbeatServiceProvider:t},n){const r=ra(e,n),a=Br(e,n),s=t.getImmediate({optional:!0});if(s){const l=await s.getHeartbeatsHeader();l&&a.append("x-firebase-client",l)}const o={installation:{sdkVersion:ht,appId:e.appId}},i={method:"POST",headers:a,body:JSON.stringify(o)},c=await It(()=>fetch(r,i));if(c.ok){const l=await c.json();return mt(l)}else throw await _t("Generate Auth Token",c)}function ra(e,{fid:t}){return`${pt(e)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ee(e,t=!1){let n;const r=await Y(e.appConfig,s=>{if(!At(s))throw L.create("not-registered");const o=s.authToken;if(!t&&oa(o))return s;if(o.requestStatus===1)return n=aa(e,t),s;{if(!navigator.onLine)throw L.create("app-offline");const i=ca(s);return n=sa(e,i),i}});return n?await n:r.authToken}async function aa(e,t){let n=await Be(e.appConfig);for(;n.authToken.requestStatus===1;)await Et(100),n=await Be(e.appConfig);const r=n.authToken;return r.requestStatus===0?Ee(e,t):r}function Be(e){return Y(e,t=>{if(!At(t))throw L.create("not-registered");const n=t.authToken;return la(n)?Object.assign(Object.assign({},t),{authToken:{requestStatus:0}}):t})}async function sa(e,t){try{const n=await na(e,t),r=Object.assign(Object.assign({},t),{authToken:n});return await U(e.appConfig,r),n}catch(n){if(gt(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await St(e.appConfig);else{const r=Object.assign(Object.assign({},t),{authToken:{requestStatus:0}});await U(e.appConfig,r)}throw n}}function At(e){return e!==void 0&&e.registrationStatus===2}function oa(e){return e.requestStatus===2&&!ia(e)}function ia(e){const t=Date.now();return t<e.creationTime||e.creationTime+e.expiresIn<t+Pr}function ca(e){const t={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},e),{authToken:t})}function la(e){return e.requestStatus===1&&e.requestTime+dt<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dt="installations",ga="installations-internal",pa=e=>{const t=e.getProvider("app").getImmediate(),n=fa(t),r=W(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},ma=e=>{const t=e.getProvider("app").getImmediate(),n=W(t,Dt).getImmediate();return{getId:()=>ua(n),getToken:a=>da(n,a)}};function _a(){b(new j(Dt,pa,"PUBLIC")),b(new j(ga,ma,"PRIVATE"))}_a();E(ut,_e);E(ut,_e,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ka=30,$a=1e3;class Pa{constructor(t={},n=$a){this.throttleMetadata=t,this.intervalMillis=n}getThrottleMetadata(t){return this.throttleMetadata[t]}setThrottleMetadata(t,n){this.throttleMetadata[t]=n}deleteThrottleMetadata(t){delete this.throttleMetadata[t]}}const Rt=new Pa;function Fa(e){return new Headers({Accept:"application/json","x-goog-api-key":e})}async function va(e){var t;const{appId:n,apiKey:r}=e,a={method:"GET",headers:Fa(r)},s=ba.replace("{app-id}",n),o=await fetch(s,a);if(o.status!==200&&o.status!==304){let i="";try{const c=await o.json();!((t=c.error)===null||t===void 0)&&t.message&&(i=c.error.message)}catch{}throw C.create("config-fetch-failed",{httpStatus:o.status,responseMessage:i})}return o.json()}async function Ma(e,t=Rt,n){const{appId:r,apiKey:a,measurementId:s}=e.options;if(!r)throw C.create("no-app-id");if(!a){if(s)return{measurementId:s,appId:r};throw C.create("no-api-key")}const o=t.getThrottleMetadata(r)||{backoffCount:0,throttleEndTimeMillis:Date.now()},i=new xa;return setTimeout(async()=>{i.abort()},n!==void 0?n:Ea),Lt({appId:r,apiKey:a,measurementId:s},o,i,t)}async function Lt(e,{throttleEndTimeMillis:t,backoffCount:n},r,a=Rt){var s;const{appId:o,measurementId:i}=e;try{await Ba(r,t)}catch(c){if(i)return _.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${i} provided in the "measurementId" field in the local Firebase config. [${c==null?void 0:c.message}]`),{appId:o,measurementId:i};throw c}try{const c=await va(e);return a.deleteThrottleMetadata(o),c}catch(c){const l=c;if(!Ha(l)){if(a.deleteThrottleMetadata(o),i)return _.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${i} provided in the "measurementId" field in the local Firebase config. [${l==null?void 0:l.message}]`),{appId:o,measurementId:i};throw c}const u=Number((s=l==null?void 0:l.customData)===null||s===void 0?void 0:s.httpStatus)===503?ve(n,a.intervalMillis,ka):ve(n,a.intervalMillis),f={throttleEndTimeMillis:Date.now()+u,backoffCount:n+1};return a.setThrottleMetadata(o,f),_.debug(`Calling attemptFetch again in ${u} millis`),Lt(e,f,r,a)}}function Ba(e,t){return new Promise((n,r)=>{const a=Math.max(t-Date.now(),0),s=setTimeout(n,a);e.addEventListener(()=>{clearTimeout(s),r(C.create("fetch-throttle",{throttleEndTimeMillis:t}))})})}function Ha(e){if(!(e instanceof x)||!e.customData)return!1;const t=Number(e.customData.httpStatus);return t===429||t===500||t===503||t===504}class xa{constructor(){this.listeners=[]}addEventListener(t){this.listeners.push(t)}abort(){this.listeners.forEach(t=>t())}}async function Ka(e,t,n,r,a){if(a&&a.global){e("event",n,r);return}else{const s=await t,o=Object.assign(Object.assign({},r),{send_to:s});e("event",n,o)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ua{constructor(t){this.app=t}_delete(){return delete M[this.app.options.appId],Promise.resolve()}}let M={},xe=[];const Ke={};let ae="dataLayer",Ga="gtag",Ve,Nt,je=!1;function qa(){const e=[];if(br()&&e.push("This is a browser extension environment."),Sr()||e.push("Cookies are not available."),e.length>0){const t=e.map((r,a)=>`(${a+1}) ${r}`).join(" "),n=C.create("invalid-analytics-context",{errorInfo:t});_.warn(n.message)}}function Wa(e,t,n){qa();const r=e.options.appId;if(!r)throw C.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)_.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw C.create("no-api-key");if(M[r]!=null)throw C.create("already-exists",{id:r});if(!je){Aa(ae);const{wrappedGtag:s,gtagCore:o}=La(M,xe,Ke,ae,Ga);Nt=s,Ve=o,je=!0}return M[r]=ja(e,xe,Ke,t,Ve,ae,n),new Ua(e)}function za(e,t,n,r){e=kr(e),Ka(Nt,M[e.app.options.appId],t,n,r).catch(a=>_.error(a))}const Ue="@firebase/analytics",Ge="0.10.3";function Ya(){b(new j(He,(t,{options:n})=>{const r=t.getProvider("app").getImmediate(),a=t.getProvider("installations-internal").getImmediate();return Wa(r,a,n)},"PUBLIC")),b(new j("analytics-internal",e,"PRIVATE")),E(Ue,Ge),E(Ue,Ge,"esm2017");function e(t){try{const n=t.getProvider(He).getImmediate();return{logEvent:(r,a,s)=>za(n,r,a,s)}}catch(n){throw C.create("interop-component-reg-failed",{reason:n})}}}Ya();const kt="@firebase/installations",we="0.6.6";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $t=1e4,Pt=`w:${we}`,Ft="FIS_v2",Ja="https://firebaseinstallations.googleapis.com/v1",Xa=60*60*1e3,Qa="installations",Za="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mt({projectId:e}){return`${Ja}/projects/${e}/installations`}function Bt(e){return{token:e.token,requestStatus:2,expiresIn:ns(e.expiresIn),creationTime:Date.now()}}async function Ht(e,t){const r=(await t.json()).error;return k.create("request-failed",{requestName:e,serverCode:r.code,serverMessage:r.message,serverStatus:r.status})}function xt({apiKey:e}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":e})}function ts(e,{refreshToken:t}){const n=xt(e);return n.append("Authorization",rs(t)),n}async function Kt(e){const t=await e();return t.status>=500&&t.status<600?e():t}function ns(e){return Number(e.replace("s","000"))}function rs(e){return`${Ft} ${e}`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function as({appConfig:e,heartbeatServiceProvider:t},{fid:n}){const r=Mt(e),a=xt(e),s=t.getImmediate({optional:!0});if(s){const l=await s.getHeartbeatsHeader();l&&a.append("x-firebase-client",l)}const o={fid:n,authVersion:Ft,appId:e.appId,sdkVersion:Pt},i={method:"POST",headers:a,body:JSON.stringify(o)},c=await Kt(()=>fetch(r,i));if(c.ok){const l=await c.json();return{fid:l.fid||n,registrationStatus:2,refreshToken:l.refreshToken,authToken:Bt(l.authToken)}}else throw await Ht("Create Installation",c)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jt=new Map;function Ut(e,t){const n=J(e);Gt(n,t),ls(n,t)}function Gt(e,t){const n=jt.get(e);if(n)for(const r of n)r(t)}function ls(e,t){const n=us();n&&n.postMessage({key:e,fid:t}),ds()}let D=null;function us(){return!D&&"BroadcastChannel"in self&&(D=new BroadcastChannel("[Firebase] FID Change"),D.onmessage=e=>{Gt(e.data.key,e.data.fid)}),D}function ds(){jt.size===0&&D&&(D.close(),D=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hs="firebase-installations-database",fs=1,$="firebase-installations-store";let se=null;function Te(){return se||(se=ge(hs,fs,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore($)}}})),se}async function G(e,t){const n=J(e),a=(await Te()).transaction($,"readwrite"),s=a.objectStore($),o=await s.get(n);return await s.put(t,n),await a.done,(!o||o.fid!==t.fid)&&Ut(e,t.fid),t}async function qt(e){const t=J(e),r=(await Te()).transaction($,"readwrite");await r.objectStore($).delete(t),await r.done}async function X(e,t){const n=J(e),a=(await Te()).transaction($,"readwrite"),s=a.objectStore($),o=await s.get(n),i=t(o);return i===void 0?await s.delete(n):await s.put(i,n),await a.done,i&&(!o||o.fid!==i.fid)&&Ut(e,i.fid),i}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Se(e){let t;const n=await X(e.appConfig,r=>{const a=gs(r),s=ps(e,a);return t=s.registrationPromise,s.installationEntry});return n.fid===he?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}function gs(e){const t=e||{fid:is(),registrationStatus:0};return Wt(t)}function ps(e,t){if(t.registrationStatus===0){if(!navigator.onLine){const a=Promise.reject(k.create("app-offline"));return{installationEntry:t,registrationPromise:a}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},r=ms(e,n);return{installationEntry:n,registrationPromise:r}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:_s(e)}:{installationEntry:t}}async function ms(e,t){try{const n=await as(e,t);return G(e.appConfig,n)}catch(n){throw vt(n)&&n.customData.serverCode===409?await qt(e.appConfig):await G(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}async function _s(e){let t=await qe(e.appConfig);for(;t.registrationStatus===1;)await Vt(100),t=await qe(e.appConfig);if(t.registrationStatus===0){const{installationEntry:n,registrationPromise:r}=await Se(e);return r||n}return t}function qe(e){return X(e,t=>{if(!t)throw k.create("installation-not-found");return Wt(t)})}function Wt(e){return Cs(e)?{fid:e.fid,registrationStatus:0}:e}function Cs(e){return e.registrationStatus===1&&e.registrationTime+$t<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Is({appConfig:e,heartbeatServiceProvider:t},n){const r=Es(e,n),a=ts(e,n),s=t.getImmediate({optional:!0});if(s){const l=await s.getHeartbeatsHeader();l&&a.append("x-firebase-client",l)}const o={installation:{sdkVersion:Pt,appId:e.appId}},i={method:"POST",headers:a,body:JSON.stringify(o)},c=await Kt(()=>fetch(r,i));if(c.ok){const l=await c.json();return Bt(l)}else throw await Ht("Generate Auth Token",c)}function Es(e,{fid:t}){return`${Mt(e)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ye(e,t=!1){let n;const r=await X(e.appConfig,s=>{if(!zt(s))throw k.create("not-registered");const o=s.authToken;if(!t&&Ts(o))return s;if(o.requestStatus===1)return n=bs(e,t),s;{if(!navigator.onLine)throw k.create("app-offline");const i=ys(s);return n=ws(e,i),i}});return n?await n:r.authToken}async function bs(e,t){let n=await We(e.appConfig);for(;n.authToken.requestStatus===1;)await Vt(100),n=await We(e.appConfig);const r=n.authToken;return r.requestStatus===0?ye(e,t):r}function We(e){return X(e,t=>{if(!zt(t))throw k.create("not-registered");const n=t.authToken;return As(n)?Object.assign(Object.assign({},t),{authToken:{requestStatus:0}}):t})}async function ws(e,t){try{const n=await Is(e,t),r=Object.assign(Object.assign({},t),{authToken:n});return await G(e.appConfig,r),n}catch(n){if(vt(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await qt(e.appConfig);else{const r=Object.assign(Object.assign({},t),{authToken:{requestStatus:0}});await G(e.appConfig,r)}throw n}}function zt(e){return e!==void 0&&e.registrationStatus===2}function Ts(e){return e.requestStatus===2&&!Ss(e)}function Ss(e){const t=Date.now();return t<e.creationTime||e.creationTime+e.expiresIn<t+Xa}function ys(e){const t={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},e),{authToken:t})}function As(e){return e.requestStatus===1&&e.requestTime+$t<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yt="installations",Ns="installations-internal",ks=e=>{const t=e.getProvider("app").getImmediate(),n=Ls(t),r=W(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},$s=e=>{const t=e.getProvider("app").getImmediate(),n=W(t,Yt).getImmediate();return{getId:()=>Ds(n),getToken:a=>Os(n,a)}};function Ps(){b(new F(Yt,ks,"PUBLIC")),b(new F(Ns,$s,"PRIVATE"))}Ps();E(kt,we);E(kt,we,"esm2017");const ie="@firebase/remote-config",ze="0.4.6";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
