...
If this prop is provided, the error message will be displayed and the field will be marked as errored`,name:"error",required:!1,type:{name:"string"}},updatePriceValue:{defaultValue:null,description:"",name:"updatePriceValue",required:!0,type:{name:"(value: string) => void"}}}}}catch{}const ne={title:"@/ui-kit/formsV2/PriceInput",component:u},s={args:{name:"email",label:"Email"}},o={args:{name:"email",label:"Email",smallLabel:!0}},i={args:{name:"email",label:"Email",showFreeCheckbox:!0}};var E,I,C;s.parameters={...s.parameters,docs:{...(E=s.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    name: 'email',
    label: 'Email'
  }
