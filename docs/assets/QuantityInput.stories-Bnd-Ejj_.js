import{j as n}from"./jsx-runtime-DF2Pcvd1.js";import{u as z,a as O,F as P}from"./index.esm-BBvhERNj.js";import{c as G}from"./index-DeARc5FM.js";import{r as u}from"./index-B2-qRKKC.js";import{C as J}from"./Checkbox-BgMMalPS.js";import{T as K}from"./TextInput-BXnJurHW.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./Tag-DoB-Hjk-.js";import"./full-thumb-up-Bb4kpRpM.js";import"./SvgIcon-DfLnDDE5.js";import"./BaseInput-JKfrEs2s.js";import"./stroke-search-dgesjRZH.js";import"./FieldError-B3RhE53I.js";import"./stroke-error-DSZD431a.js";import"./FieldLayoutCharacterCount-Cg7wcWeq.js";import"./index.module-BDmDBTbR.js";const X={"quantity-row":"_quantity-row_szr8k_1"},f=({label:e="Quantité",name:r="quantity",onChange:t,onBlur:l,disabled:q,className:N,required:A,asterisk:C,minimum:g=0,maximum:R=1e6,value:y,error:W,ariaLabel:H})=>{const M=r,s=u.useRef(null),B=`${r}.unlimited`,x=u.useRef(null),o=y!==0&&!y,[i,b]=u.useState(o);u.useEffect(()=>{var v;const h=document.activeElement===x.current;!i&&h&&((v=s.current)==null||v.focus())},[i]),u.useEffect(()=>{i!==o&&b(o)},[o]);const D=a=>{t==null||t(a),b(a.target.value==="")},U=()=>{let a=`${g}`;i||(a=""),t==null||t({target:{value:a}}),s.current&&(s.current.value=a),b(h=>!h)},$=n.jsx(J,{ref:x,label:"Illimité",name:B,onChange:U,checked:i,disabled:q});return n.jsx(K,{ref:s,className:G(X["quantity-row"],N),name:M,label:e,required:A,asterisk:C,disabled:q,type:"number",hasDecimal:!1,min:g,max:R,step:1,InputExtension:$,onChange:D,onBlur:l,value:i?"":y??"",error:W,"aria-label":H})};try{f.displayName="QuantityInput",f.__docgenInfo={description:`The QuantityInput component is a combination of a TextInput and a BaseCheckbox to define quantities.
An undefined quantity is meant to be interpreted as unlimited.`,displayName:"QuantityInput",props:{asterisk:{defaultValue:null,description:`A property to not displayed asterisk even if field is required
If this prop is provided, the asterisk will not be displayed`,name:"asterisk",required:!1,type:{name:"boolean"}},className:{defaultValue:null,description:`A custom class for the field layout,
