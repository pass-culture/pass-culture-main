import{j as n}from"./jsx-runtime-BYYWji4R.js";import{u as $,a as z,F as O}from"./index.esm-nHDMj4MR.js";import{c as P}from"./index-DeARc5FM.js";import{r as o}from"./index-ClcD9ViR.js";import{C as G}from"./Checkbox-DTEzzpCr.js";import{T as J}from"./TextInput-CZOlu6xY.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./Tag-CQO0EYV8.js";import"./full-thumb-up-Bb4kpRpM.js";import"./SvgIcon-CyWUmZpn.js";import"./BaseInput-BI1b_EYZ.js";import"./FieldError-ky1_Lcaw.js";import"./stroke-error-DSZD431a.js";import"./FieldLayoutCharacterCount-Cf20ddBy.js";import"./index.module-D0awDY1b.js";const K={"quantity-row":"_quantity-row_szr8k_1"},f=({label:e="Quantité",name:r="quantity",onChange:t,onBlur:u,disabled:h,className:N,required:L,asterisk:A,minimum:b=0,maximum:C=1e6,value:s,error:R})=>{const W=r,l=o.useRef(null),H=`${r}.unlimited`,q=o.useRef(null),M=s!==0&&!s,[i,x]=o.useState(M);o.useEffect(()=>{var g;const y=document.activeElement===q.current;!i&&y&&((g=l.current)==null||g.focus())},[i]);const B=a=>{t==null||t(a),x(a.target.value==="")},D=()=>{let a=`${b}`;i||(a=""),t==null||t({target:{value:a}}),l.current&&(l.current.value=a),x(y=>!y)},U=n.jsx(G,{ref:q,label:"Illimité",name:H,onChange:D,checked:i,disabled:h});return n.jsx(J,{ref:l,className:P(K["quantity-row"],N),name:W,label:e,required:L,asterisk:A,disabled:h,type:"number",hasDecimal:!1,min:b,max:C,step:1,InputExtension:U,onChange:B,onBlur:u,value:i?"":s===0?"0":s||"",error:R})};try{f.displayName="QuantityInput",f.__docgenInfo={description:`The QuantityInput component is a combination of a TextInput and a BaseCheckbox to define quantities.
...
}`,...(j=(T=p.parameters)==null?void 0:T.docs)==null?void 0:j.source}}};const fe=["Default","SmallLabel","Required","WithinForm"];export{m as Default,c as Required,d as SmallLabel,p as WithinForm,fe as __namedExportsOrder,pe as default};
