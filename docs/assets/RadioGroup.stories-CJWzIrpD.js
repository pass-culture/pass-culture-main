import{j as a}from"./jsx-runtime-BYYWji4R.js";import{u as ee,a as ae,F as re}from"./index.esm-Z2NZos4s.js";import{B as ne,R as o}from"./BaseRadio-DbWHkTHm.js";import{c as oe}from"./index-DeARc5FM.js";import{F as ie}from"./FieldSetLayout-Cs-MLWIC.js";import"./index-ClcD9ViR.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./SvgIcon-CyWUmZpn.js";import"./FieldError-azuIsM2E.js";import"./stroke-error-DSZD431a.js";const y={"radio-group-item":"_radio-group-item_1pthw_1","radio-group-display-inline":"_radio-group-display-inline_1pthw_4","radio-group-display-inline-grow":"_radio-group-display-inline-grow_1pthw_4"},t=({disabled:r,group:e,name:s,legend:b,describedBy:z,className:J,variant:K,onChange:Q,isOptional:U=!0,displayMode:Y,error:v,checkedOption:Z})=>a.jsx(ie,{className:oe(y["radio-group"],J),dataTestId:`wrapper-${s}`,error:v,legend:b,name:`radio-group-${s}`,ariaDescribedBy:z,isOptional:U,hideFooter:!0,children:a.jsx("div",{className:y[`radio-group-display-${Y}`],children:e.map(i=>a.jsx("div",{className:y["radio-group-item"],children:a.jsx(ne,{disabled:r,label:i.label,name:s,value:i.value,variant:K,hasError:!!v,onChange:Q,icon:i.icon,iconPosition:i.iconPosition,description:i.description,checked:Z===i.value,...v?{ariaDescribedBy:`error-${s}`}:{},childrenOnChecked:i.childrenOnChecked})},i.value))})});try{t.displayName="RadioGroup",t.__docgenInfo={description:"The RadioGroup component is a set of radio buttons grouped together under a common `fieldset`.",displayName:"RadioGroup",props:{name:{defaultValue:null,description:"The name of the radio group field.",name:"name",required:!0,type:{name:"string"}},disabled:{defaultValue:null,description:"Whether the radio buttons are disabled.",name:"disabled",required:!1,type:{name:"boolean"}},onChange:{defaultValue:null,description:"Callback function to handle changes in the radio group.",name:"onChange",required:!1,type:{name:"((e: ChangeEvent<HTMLInputElement>) => void)"}},className:{defaultValue:null,description:"Custom CSS class applied to the group's `fieldset` element.",name:"className",required:!1,type:{name:"string"}},isOptional:{defaultValue:{value:"true"},description:"Whether or not the group is optional.",name:"isOptional",required:!1,type:{name:"boolean"}},group:{defaultValue:null,description:`The group of radio button options.
Each item contains a label and a value.
The label is what's displayed while the value is used as an identifier.`,name:"group",required:!0,type:{name:"GroupOption[]"}},variant:{defaultValue:null,description:"Variant of the radio inputs styles within the group.",name:"variant",required:!1,type:{name:"enum",value:[{value:'"BOX"'}]}},error:{defaultValue:null,description:"Error message",name:"error",required:!1,type:{name:"string"}},displayMode:{defaultValue:null,description:`How the radio buttons are displayed within the group.
