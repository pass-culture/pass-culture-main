 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nn(e){S(new y("platform-logger",t=>new Gt(t),"PRIVATE")),S(new y("heartbeat",t=>new Ln(t),"PRIVATE")),I(Z,ge,e),I(Z,ge,"esm2017"),I("fire-js","")}Nn("");const qe="@firebase/installations",se="0.6.6";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ze=1e4,Ye=`w:${se}`,Je="FIS_v2",kn="https://firebaseinstallations.googleapis.com/v1",Fn=60*60*1e3,Pn="installations",vn="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fa(){S(new y(Jr,e,"PUBLIC").setMultipleInstances(!0)),I(Y,Le),I(Y,Le,"esm2017");function e(t,{instanceIdentifier:n}){const a=t.getProvider("app").getImmediate(),r=t.getProvider("installations-internal").getImmediate();if(typeof window>"u")throw p.create("registration-window");if(!te())throw p.create("indexed-db-unavailable");const{projectId:s,apiKey:i,appId:o}=a.options;if(!s)throw p.create("registration-project-id");if(!i)throw p.create("registration-api-key");if(!o)throw p.create("registration-app-id");n=n||"firebase";const c=new da(o,a.name,n),l=new ha(c),d=new ne(Y);d.logLevel=u.ERROR;const h=new ta(r,yn,n,s,i,o),f=new aa(h,c),g=new Zr(f,c,l,d),E=new oa(a,g,l,c,d);return Qr(E),E}}fa();const pt=N.createContext({});function Re({children:e}){const[t,n]=N.useState();return O.jsx(pt.Provider,{value:{logEvent:t,setLogEvent:n},children:e})}try{Re.displayName="AnalyticsContextProvider",Re.__docgenInfo={description:"",displayName:"AnalyticsContextProvider",props:{}}}catch{}const ga=N.createContext({remoteConfig:null,setRemoteConfig:null,remoteConfigData:null,setRemoteConfigData:null});function Me({children:e}){const[t,n]=N.useState(null),[a,r]=N.useState(null);return O.jsx(ga.Provider,{value:{remoteConfig:t,setRemoteConfig:n,remoteConfigData:a,setRemoteConfigData:r},children:e})}try{Me.displayName="RemoteContextProvider",Me.__docgenInfo={description:"",displayName:"RemoteContextProvider",props:{}}}catch{}function pa(){return N.useContext(pt)}const Ne={"help-link":"_help-link_1c4y5_2","help-link-text":"_help-link-text_1c4y5_10"},ma=()=>{const{logEvent:e}=pa();return O.jsxs("a",{onClick:()=>e==null?void 0:e(ve.CLICKED_HELP_LINK,{from:location.pathname}),className:Ne["help-link"],href:"https://aide.passculture.app/hc/fr/articles/4411991940369--Acteurs-culturels-Comment-poster-une-offre-%C3%A0-destination-d-un-groupe-scolaire-",rel:"noreferrer",target:"_blank",children:[O.jsx(Ct,{src:mt,alt:"",width:"42"}),O.jsx("span",{className:Ne["help-link-text"],children:"Aide"})]})},ya={title:"components/HelpLink",component:ma,decorators:[e=>O.jsx("div",{style:{width:500,height:500},children:O.jsx(e,{})})]},B={};var ke,Fe,Pe;B.parameters={...B.parameters,docs:{...(ke=B.parameters)==null?void 0:ke.docs,source:{originalSource:"{}",...(Pe=(Fe=B.parameters)==null?void 0:Fe.docs)==null?void 0:Pe.source}}};const Sa=["Default"];export{B as Default,Sa as __namedExportsOrder,ya as default};
