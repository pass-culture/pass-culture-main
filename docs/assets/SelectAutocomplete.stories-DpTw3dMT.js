import{j as e}from"./jsx-runtime-DF2Pcvd1.js";import{o as j,c as D,a as T}from"./index.esm-BKJwTNIf.js";import{r as k}from"./index-B2-qRKKC.js";import{u as w,a as W,F as C}from"./index.esm-BBvhERNj.js";import{S as i}from"./SelectAutocomplete-D6MPIrfI.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-DeARc5FM.js";import"./BaseInput-JKfrEs2s.js";import"./stroke-search-dgesjRZH.js";import"./SvgIcon-DfLnDDE5.js";import"./FieldLayout-CMYQjvf2.js";import"./full-clear-Q4kCtSRL.js";import"./full-close-5Oxr7nnd.js";import"./full-help-blUMxBcv.js";import"./Button-CJb_rOOr.js";import"./stroke-pass-CALgybTM.js";import"./Tooltip-C-mHJC8R.js";import"./Button.module-Md2doL54.js";import"./types-yVZEaApa.js";import"./FieldError-B3RhE53I.js";import"./stroke-error-DSZD431a.js";import"./FieldLayoutCharacterCount-Cg7wcWeq.js";import"./index.module-BDmDBTbR.js";import"./stroke-down-Co3p5GaP.js";const R=({children:r})=>{const t=W({defaultValues:{departement:"05"},resolver:j(D().shape({departement:T().required("Veuillez choisir un département dans la liste")})),mode:"onTouched"});return e.jsx(C,{...t,children:r})},p=[{value:"01",label:"Ain"},{value:"02",label:"Aisne"},{value:"03",label:"Allier"},{value:"04",label:"Alpes-de-Haute-Provence test de libellé très long"},{value:"05",label:"Hautes-Alpes"},{value:"06",label:"Alpes-Maritimes"},{value:"07",label:"Ardèche"},{value:"08",label:"Ardennes"},{value:"09",label:"Ariège"},{value:"10",label:"Aube"},{value:"11",label:"Aude"},{value:"12",label:"Aveyron"},{value:"13",label:"Bouches-du-Rhône"},{value:"14",label:"Calvados"},{value:"15",label:"Cantal"}],ae={title:"@/ui-kit/forms/SelectAutocomplete",component:i},n={wrapper:{color:"#666",fontSize:"0.8rem",padding:"0 1rem",backgroundColor:"#f5f5f5",borderRadius:"0.2rem",border:"thin solid #e1e1e1",minHeight:"45px",marginBottom:"1rem",display:"flex",alignItems:"center"},pre:{display:"inline-block",padding:"0.5rem"}},a={args:{name:"departement",label:"Département",options:p,isOptional:!0}},o={args:{name:"departement",label:"Département",options:p,isOptional:!0,resetOnOpen:!1,value:"05"}},s={render:()=>{const[r,t]=k.useState("");return e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:n.wrapper,children:["Search text value: ",e.jsx("pre",{style:n.pre,children:r})]}),e.jsx(i,{label:"Département",name:"departement",options:p,isOptional:!0,onSearch:m=>t(m)})]})}},l={decorators:[r=>e.jsx(R,{children:e.jsx(r,{})})],render:()=>{var c;const{register:r,watch:t,formState:{errors:m}}=w(),F=t("departement");return e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:n.wrapper,children:["Selected value in the form:"," ",e.jsx("pre",{style:n.pre,children:F})]}),e.jsx(i,{label:"Département",options:p,...r("departement"),error:(c=m.departement)==null?void 0:c.message})]})}};var d,u,h;a.parameters={...a.parameters,docs:{...(d=a.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
    name: 'departement',
    label: 'Département',
    options,
...
}`,...(O=(A=l.parameters)==null?void 0:A.docs)==null?void 0:O.source}}};const oe=["Default","NoResetOnOpen","WithOnsearchTrigger","WithinFormValidation"];export{a as Default,o as NoResetOnOpen,s as WithOnsearchTrigger,l as WithinFormValidation,oe as __namedExportsOrder,ae as default};
