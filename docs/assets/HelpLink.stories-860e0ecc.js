 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pt="FirebaseError";class D extends Error{constructor(t,n,a){super(n),this.code=t,this.customData=a,this.name=Pt,Object.setPrototypeOf(this,D.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,B.prototype.create)}}class B{constructor(t,n,a){this.service=t,this.serviceName=n,this.errors=a}create(t,...n){const a=n[0]||{},r=`${this.service}/${t}`,s=this.errors[t],i=s?Nt(s,a):"Error",c=`${this.serviceName}: ${i} (${r}).`;return new D(r,c,a)}}function Nt(e,t){return e.replace(vt,(n,a)=>{const r=t[a];return r!=null?String(r):`<${a}?>`})}const vt=/\{\$([^}]+)}/g;/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bt=1e3,$t=2,xt=4*60*60*1e3,Kt=.5;function ee(e,t=Bt,n=$t){const a=t*Math.pow(n,e),r=Math.round(Kt*a*(Math.random()-.5)*2);return Math.min(xt,a+r)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nn{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(rn(n)){const a=n.getImmediate();return`${a.library}/${a.version}`}else return null}).filter(n=>n).join(" ")}}function rn(e){const t=e.getComponent();return(t==null?void 0:t.type)==="VERSION"}const re="@firebase/app",be="0.9.24";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const L=new ce("@firebase/app"),an="@firebase/app-compat",sn="@firebase/analytics-compat",on="@firebase/analytics",cn="@firebase/app-check-compat",ln="@firebase/app-check",un="@firebase/auth",dn="@firebase/auth-compat",hn="@firebase/database",fn="@firebase/database-compat",gn="@firebase/functions",pn="@firebase/functions-compat",mn="@firebase/installations",Cn="@firebase/installations-compat",_n="@firebase/messaging",In="@firebase/messaging-compat",En="@firebase/performance",bn="@firebase/performance-compat",wn="@firebase/remote-config",yn="@firebase/remote-config-compat",Sn="@firebase/storage",Tn="@firebase/storage-compat",Dn="@firebase/firestore",An="@firebase/firestore-compat",On="firebase",Rn="10.7.0",Ln={[re]:"fire-core",[an]:"fire-core-compat",[on]:"fire-analytics",[sn]:"fire-analytics-compat",[ln]:"fire-app-check",[cn]:"fire-app-check-compat",[un]:"fire-auth",[dn]:"fire-auth-compat",[hn]:"fire-rtdb",[fn]:"fire-rtdb-compat",[gn]:"fire-fn",[pn]:"fire-fn-compat",[mn]:"fire-iid",[Cn]:"fire-iid-compat",[_n]:"fire-fcm",[In]:"fire-fcm-compat",[En]:"fire-perf",[bn]:"fire-perf-compat",[wn]:"fire-rc",[yn]:"fire-rc-compat",[Sn]:"fire-gcs",[Tn]:"fire-gcs-compat",[Dn]:"fire-fst",[An]:"fire-fst-compat","fire-js":"fire-js",[On]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pn=Rn;function I(e,t,n){var a;let r=(a=Ln[e])!==null&&a!==void 0?a:e;n&&(r+=`-${n}`);const s=r.match(/\s|\//),i=t.match(/\s|\//);if(s||i){const c=[`Unable to register library "${r}" with version "${t}":`];s&&c.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&i&&c.push("and"),i&&c.push(`version name "${t}" contains illegal characters (whitespace or "/")`),L.warn(c.join(" "));return}T(new S(`${r}-version`,()=>({library:r,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cr="firebase-installations-database",_r=1,F="firebase-installations-store";let J=null;function fe(){return J||(J=Qn(Cr,_r,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(F)}}})),J}async function K(e,t){const n=H(e),r=(await fe()).transaction(F,"readwrite"),s=r.objectStore(F),i=await s.get(n);return await s.put(t,n),await r.done,(!i||i.fid!==t.fid)&&pt(e,t.fid),t}async function Ct(e){const t=H(e),a=(await fe()).transaction(F,"readwrite");await a.objectStore(F).delete(t),await a.done}async function j(e,t){const n=H(e),r=(await fe()).transaction(F,"readwrite"),s=r.objectStore(F),i=await s.get(n),c=t(i);return c===void 0?await s.delete(n):await s.put(c,n),await r.done,c&&(!i||i.fid!==c.fid)&&pt(e,c.fid),c}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Fr(e){const t=e,{installationEntry:n,registrationPromise:a}=await ge(t);return a?a.catch(console.error):pe(t).catch(console.error),n.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function kr(e,t=!1){const n=e;return await Pr(n),(await pe(n,t)).token}async function Pr(e){const{registrationPromise:t}=await ge(e);t&&await t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nr(e){if(!e||!e.options)throw X("App Configuration");if(!e.name)throw X("App Name");const t=["projectId","apiKey","appId"];for(const n of t)if(!e.options[n])throw X(n);return{appName:e.name,projectId:e.options.projectId,apiKey:e.options.apiKey,appId:e.options.appId}}function X(e){return M.create("missing-app-config-values",{valueName:e})}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Et="installations",vr="installations-internal",Br=e=>{const t=e.getProvider("app").getImmediate(),n=Nr(t),a=Qe(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:a,_delete:()=>Promise.resolve()}},$r=e=>{const t=e.getProvider("app").getImmediate(),n=Qe(t,Et).getImmediate();return{getId:()=>Fr(n),getToken:r=>kr(n,r)}};function xr(){T(new S(Et,Br,"PUBLIC")),T(new S(vr,$r,"PRIVATE"))}xr();I(rt,he);I(rt,he,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Me="analytics",Kr="firebase_id",Hr="origin",jr=60*1e3,Vr="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",me="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Na(){T(new S(_a,e,"PUBLIC").setMultipleInstances(!0)),I(Z,$e),I(Z,$e,"esm2017");function e(t,{instanceIdentifier:n}){const a=t.getProvider("app").getImmediate(),r=t.getProvider("installations-internal").getImmediate();if(typeof window>"u")throw p.create("registration-window");if(!oe())throw p.create("indexed-db-unavailable");const{projectId:s,apiKey:i,appId:c}=a.options;if(!s)throw p.create("registration-project-id");if(!i)throw p.create("registration-api-key");if(!c)throw p.create("registration-app-id");n=n||"firebase";const o=new ka(c,a.name,n),l=new Pa(o),d=new ce(Z);d.logLevel=u.ERROR;const h=new ya(r,Pn,n,s,i,c),f=new Da(h,o),g=new ba(f,o,l,d),E=new Ra(a,g,l,o,d);return Ea(E),E}}Na();const Tt=k.createContext({});function xe({children:e}){const[t,n]=k.useState();return R.jsx(Tt.Provider,{value:{logEvent:t,setLogEvent:n},children:e})}try{xe.displayName="AnalyticsContextProvider",xe.__docgenInfo={description:"",displayName:"AnalyticsContextProvider",props:{}}}catch{}const va=k.createContext({remoteConfig:null,setRemoteConfig:null,remoteConfigData:null,setRemoteConfigData:null});function Ke({children:e}){const[t,n]=k.useState(null),[a,r]=k.useState(null);return R.jsx(va.Provider,{value:{remoteConfig:t,setRemoteConfig:n,remoteConfigData:a,setRemoteConfigData:r},children:e})}try{Ke.displayName="RemoteContextProvider",Ke.__docgenInfo={description:"",displayName:"RemoteContextProvider",props:{}}}catch{}function Ba(){return k.useContext(Tt)}const He={"help-link":"_help-link_9okj2_2","help-link-text":"_help-link-text_9okj2_10"},$a=()=>{const{logEvent:e}=Ba();return R.jsxs("a",{onClick:()=>e==null?void 0:e(Ge.CLICKED_HELP_LINK,{from:location.pathname}),className:He["help-link"],href:"https://aide.passculture.app/hc/fr/articles/4411991940369--Acteurs-culturels-Comment-poster-une-offre-%C3%A0-destination-d-un-groupe-scolaire-",rel:"noreferrer",target:"_blank",children:[R.jsx(At,{src:Dt,alt:"",width:"42"}),R.jsx("span",{className:He["help-link-text"],children:"Aide"})]})},xa=$a,Wa={title:"components/HelpLink",component:xa,decorators:[e=>R.jsx("div",{style:{width:500,height:500},children:R.jsx(e,{})})]},$={};var je,Ve,Ue;$.parameters={...$.parameters,docs:{...(je=$.parameters)==null?void 0:je.docs,source:{originalSource:"{}",...(Ue=(Ve=$.parameters)==null?void 0:Ve.docs)==null?void 0:Ue.source}}};const qa=["Default"];export{$ as Default,qa as __namedExportsOrder,Wa as default};
