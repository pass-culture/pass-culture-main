...
This is to support custom logic when the quantity changes.`,name:"onChange",required:!1,type:{name:"((quantity: string) => void)"}},min:{defaultValue:{value:"0"},description:"The minimum value allowed for the quantity. Make sure it matches validation schema.",name:"min",required:!1,type:{name:"string"}}}}}catch{}const Z={title:"ui-kit/formsV2/QuantityInput",component:o},s={args:{name:"quantity",label:"Quantité"}},r={args:{name:"quantity",label:"Quantité",smallLabel:!0}},u={args:{name:"quantity",label:"Quantité",required:!0}};var v,I,Q;s.parameters={...s.parameters,docs:{...(v=s.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    name: 'quantity',
    label: 'Quantité'
  }
...
}`,...(L=(w=u.parameters)==null?void 0:w.docs)==null?void 0:L.source}}};const ee=["Default","SmallLabel","Required"];export{s as Default,u as Required,r as SmallLabel,ee as __namedExportsOrder,Z as default};
