import{j as c}from"./jsx-runtime-BlY_W4Ue.js";import{c as d}from"./index-jInYAdJZ.js";import{r as s}from"./iframe-CkBRxpYx.js";import"./preload-helper-PPVm8Dsz.js";const p="_toggle_xgcid_1",g={toggle:p,"toggle-display":"_toggle-display_xgcid_18"},l=({isActiveByDefault:e=!1,isDisabled:u=!1,label:i,labelPosition:o="left",handleClick:n})=>{const[a,r]=s.useState(e);s.useEffect(()=>{r(e)},[e]);const f=s.useCallback(()=>{r(!a),n?.()},[a,n]);return c.jsxs("button",{className:d(g.toggle),type:"button",disabled:u,"aria-pressed":a,onClick:f,children:[o==="left"?i:null,c.jsx("span",{className:d(g["toggle-display"]),hidden:!0}),o==="right"?i:null]})};try{l.displayName="Toggle",l.__docgenInfo={description:`The Toggle component is used to render a button that represents an on/off state.
