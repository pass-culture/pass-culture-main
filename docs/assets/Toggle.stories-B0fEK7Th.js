import{j as d}from"./jsx-runtime-DF2Pcvd1.js";import{c}from"./index-DeARc5FM.js";import{r as l}from"./index-B2-qRKKC.js";import"./_commonjsHelpers-Cpj98o6Y.js";const y="_toggle_dz9az_1",u={toggle:y,"toggle-display":"_toggle-display_dz9az_18"},o=({isActiveByDefault:e=!1,isDisabled:m=!1,label:i,labelPosition:n="left",handleClick:t})=>{const[s,r]=l.useState(e);l.useEffect(()=>{r(e)},[e]);const b=l.useCallback(()=>{r(!s),t==null||t()},[s,t]);return d.jsxs("button",{className:c(u.toggle),type:"button",disabled:m,"aria-pressed":s,onClick:b,children:[n==="left"?i:null,d.jsx("span",{className:c(u["toggle-display"]),hidden:!0}),n==="right"?i:null]})};try{o.displayName="Toggle",o.__docgenInfo={description:`The Toggle component is used to render a button that represents an on/off state.
