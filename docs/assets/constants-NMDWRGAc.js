import{r as _t}from"./index-QQMyt9Ur.js";import"./config-BqmKEuqZ.js";import{u as It}from"./chunk-B7RQU5TL-DNIVRQ2o.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xt{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(a=>{if(Jt(a)){const n=a.getImmediate();return`${n.library}/${n.version}`}else return null}).filter(a=>a).join(" ")}}function Jt(t){return t.getComponent()?.type==="VERSION"}const Z="@firebase/app",me="0.14.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const E=new ae("@firebase/app"),Qt="@firebase/app-compat",Zt="@firebase/analytics-compat",ea="@firebase/analytics",ta="@firebase/app-check-compat",aa="@firebase/app-check",na="@firebase/auth",sa="@firebase/auth-compat",ia="@firebase/database",ra="@firebase/data-connect",oa="@firebase/database-compat",ca="@firebase/functions",la="@firebase/functions-compat",ha="@firebase/installations",da="@firebase/installations-compat",ua="@firebase/messaging",fa="@firebase/messaging-compat",ga="@firebase/performance",ma="@firebase/performance-compat",pa="@firebase/remote-config",Ca="@firebase/remote-config-compat",Ea="@firebase/storage",_a="@firebase/storage-compat",Ia="@firebase/firestore",ba="@firebase/ai",wa="@firebase/firestore-compat",Sa="firebase",Ta="12.2.0",ya={[Z]:"fire-core",[Qt]:"fire-core-compat",[ea]:"fire-analytics",[Zt]:"fire-analytics-compat",[aa]:"fire-app-check",[ta]:"fire-app-check-compat",[na]:"fire-auth",[sa]:"fire-auth-compat",[ia]:"fire-rtdb",[ra]:"fire-data-connect",[oa]:"fire-rtdb-compat",[ca]:"fire-fn",[la]:"fire-fn-compat",[ha]:"fire-iid",[da]:"fire-iid-compat",[ua]:"fire-fcm",[fa]:"fire-fcm-compat",[ga]:"fire-perf",[ma]:"fire-perf-compat",[pa]:"fire-rc",[Ca]:"fire-rc-compat",[Ea]:"fire-gcs",[_a]:"fire-gcs-compat",[Ia]:"fire-fst",[wa]:"fire-fst-compat",[ba]:"fire-vertex","fire-js":"fire-js",[Sa]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
