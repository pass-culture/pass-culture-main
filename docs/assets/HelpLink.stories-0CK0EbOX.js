 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mn(e){y(new S("platform-logger",t=>new jt(t),"PRIVATE")),y(new S("heartbeat",t=>new Rn(t),"PRIVATE")),E(Q,fe,e),E(Q,fe,"esm2017"),E("fire-js","")}Mn("");const Ue="@firebase/installations",ae="0.6.10";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
