import{j as e}from"./jsx-runtime-CfatFE5O.js";import{u,a as p,F as h}from"./index.esm-DECH_zav.js";import{S as c}from"./Slider-CBwJBNGj.js";import"./index-ClcD9ViR.js";import"./_commonjsHelpers-Cpj98o6Y.js";const f={title:"ui-kit/Slider",component:c},g=({children:r})=>{const t=p({defaultValues:{scale:"km"}});return e.jsx(h,{...t,children:e.jsx("form",{children:r})})},n={args:{name:"myField",scale:"km",onChange:()=>{}},decorators:[r=>e.jsx("div",{style:{padding:"2rem"},children:e.jsx(r,{})})]},s={args:{name:"myField",scale:"km"},decorators:[r=>e.jsx("div",{style:{width:300,height:300},children:e.jsx(g,{children:e.jsx(r,{})})})],render:r=>{const{register:t}=u();return e.jsx(c,{...r,...t("myField")})}};var o,a,i;n.parameters={...n.parameters,docs:{...(o=n.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
    name: 'myField',
    scale: 'km',
    onChange: () => {
