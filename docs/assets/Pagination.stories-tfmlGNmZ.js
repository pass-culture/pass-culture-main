import{j as e}from"./jsx-runtime-BsmbOXDk.js";import{s as u,a as l}from"./stroke-right-DelDNWyg.js";import{S as i}from"./SvgIcon-BTPBkL1x.js";import"./iframe-CUpjhus9.js";import"./preload-helper-PPVm8Dsz.js";const p="_pagination_wrgeu_1",d="_button_wrgeu_11",o={pagination:p,button:d},r=({currentPage:t,onPreviousPageClick:s,onNextPageClick:c,pageCount:a})=>a>1?e.jsxs("div",{className:o.pagination,children:[e.jsx("button",{disabled:t===1,onClick:s,type:"button",className:o.button,children:e.jsx(i,{src:u,alt:"Page précédente",width:"16"})}),e.jsxs("span",{children:["Page ",t,"/",a]}),e.jsx("button",{disabled:t>=a,onClick:c,type:"button",className:o.button,"data-testid":"next-page-button",children:e.jsx(i,{src:l,alt:"Page suivante",width:"16"})})]}):null;try{r.displayName="Pagination",r.__docgenInfo={description:`The Pagination component allows navigation between different pages of content.
