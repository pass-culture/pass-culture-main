import{j as M}from"./jsx-runtime-Nms4Y4qS.js";import{K as dt}from"./index-C4Y-b_h4.js";import{r as ft}from"./index-BwDkhjyp.js";import"./config-CSZcq_wr.js";import{u as gt}from"./index-C_BCaKYK.js";import{f as pt}from"./full-help-Co3hxUDJ.js";import{S as mt}from"./SvgIcon-Cibea2Sc.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-CReuRBEY.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yt="FirebaseError";class T extends Error{constructor(t,n,r){super(n),this.code=t,this.customData=r,this.name=yt,Object.setPrototypeOf(this,T.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,v.prototype.create)}}class v{constructor(t,n,r){this.service=t,this.serviceName=n,this.errors=r}create(t,...n){const r=n[0]||{},a=`${this.service}/${t}`,s=this.errors[t],i=s?St(s,r):"Error",c=`${this.serviceName}: ${i} (${a}).`;return new T(a,c,r)}}function St(e,t){return e.replace(Tt,(n,r)=>{const a=t[r];return a!=null?String(a):`<${r}?>`})}const Tt=/\{\$([^}]+)}/g;/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ne(e){return e&&e._delegate?e._delegate:e}class y{constructor(t,n,r){this.name=t,this.instanceFactory=n,this.type=r,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(t){return this.instantiationMode=t,this}setMultipleInstances(t){return this.multipleInstances=t,this}setServiceProps(t){return this.serviceProps=t,this}setInstanceCreatedCallback(t){return this.onInstanceCreated=t,this}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sn="firebase-heartbeat-database",Tn=1,F="firebase-heartbeat-store";let j=null;function xe(){return j||(j=Ke(Sn,Tn,{upgrade:(e,t)=>{switch(t){case 0:try{e.createObjectStore(F)}catch(n){console.warn(n)}}}}).catch(e=>{throw re.create("idb-open",{originalErrorMessage:e.message})})),j}async function An(e){try{const n=(await xe()).transaction(F),r=await n.objectStore(F).get(Ue(e));return await n.done,r}catch(t){if(t instanceof T)O.warn(t.message);else{const n=re.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});O.warn(n.message)}}}async function me(e,t){try{const r=(await xe()).transaction(F,"readwrite");await r.objectStore(F).put(t,Ue(e)),await r.done}catch(n){if(n instanceof T)O.warn(n.message);else{const r=re.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});O.warn(r.message)}}}function Ue(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mn(e){S(new y("platform-logger",t=>new jt(t),"PRIVATE")),S(new y("heartbeat",t=>new Ln(t),"PRIVATE")),I(Q,fe,e),I(Q,fe,"esm2017"),I("fire-js","")}Mn("");const Ve="@firebase/installations",ae="0.6.8";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const je=1e4,Ge=`w:${ae}`,We="FIS_v2",kn="https://firebaseinstallations.googleapis.com/v1",Fn=60*60*1e3,vn="installations",Nn="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const it="installations",gr="installations-internal",pr=e=>{const t=e.getProvider("app").getImmediate(),n=fr(t),r=He(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},mr=e=>{const t=e.getProvider("app").getImmediate(),n=He(t,it).getImmediate();return{getId:()=>ur(n),getToken:a=>hr(n,a)}};function _r(){S(new y(it,pr,"PUBLIC")),S(new y(gr,mr,"PRIVATE"))}_r();I(Ve,ae);I(Ve,ae,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
