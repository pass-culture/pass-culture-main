import{j as P}from"./jsx-runtime-BYYWji4R.js";import{V as pt}from"./index-DITXTutv.js";import{r as mt}from"./index-ClcD9ViR.js";import"./config-BqmKEuqZ.js";import{u as Ct}from"./chunk-AYJ5UCUI-4sbN1OUM.js";import{f as _t}from"./full-help-blUMxBcv.js";import{S as Et}from"./SvgIcon-CyWUmZpn.js";import"./_commonjsHelpers-Cpj98o6Y.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qt{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(a=>{if(zt(a)){const n=a.getImmediate();return`${n.library}/${n.version}`}else return null}).filter(a=>a).join(" ")}}function zt(e){const t=e.getComponent();return(t==null?void 0:t.type)==="VERSION"}const Q="@firebase/app",fe="0.12.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const I=new te("@firebase/app"),Yt="@firebase/app-compat",Xt="@firebase/analytics-compat",Jt="@firebase/analytics",Qt="@firebase/app-check-compat",Zt="@firebase/app-check",ea="@firebase/auth",ta="@firebase/auth-compat",aa="@firebase/database",na="@firebase/data-connect",sa="@firebase/database-compat",ra="@firebase/functions",ia="@firebase/functions-compat",oa="@firebase/installations",ca="@firebase/installations-compat",la="@firebase/messaging",ua="@firebase/messaging-compat",da="@firebase/performance",ha="@firebase/performance-compat",fa="@firebase/remote-config",ga="@firebase/remote-config-compat",pa="@firebase/storage",ma="@firebase/storage-compat",Ca="@firebase/firestore",_a="@firebase/vertexai",Ea="@firebase/firestore-compat",Ia="firebase",ba="11.7.1",Sa={[Q]:"fire-core",[Yt]:"fire-core-compat",[Jt]:"fire-analytics",[Xt]:"fire-analytics-compat",[Zt]:"fire-app-check",[Qt]:"fire-app-check-compat",[ea]:"fire-auth",[ta]:"fire-auth-compat",[aa]:"fire-rtdb",[na]:"fire-data-connect",[sa]:"fire-rtdb-compat",[ra]:"fire-fn",[ia]:"fire-fn-compat",[oa]:"fire-iid",[ca]:"fire-iid-compat",[la]:"fire-fcm",[ua]:"fire-fcm-compat",[da]:"fire-perf",[ha]:"fire-perf-compat",[fa]:"fire-rc",[ga]:"fire-rc-compat",[pa]:"fire-gcs",[ma]:"fire-gcs-compat",[Ca]:"fire-fst",[Ea]:"fire-fst-compat",[_a]:"fire-vertex","fire-js":"fire-js",[Ia]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function va(e){A(new y("platform-logger",t=>new qt(t),"PRIVATE")),A(new y("heartbeat",t=>new Pa(t),"PRIVATE")),E(Q,fe,e),E(Q,fe,"esm2017"),E("fire-js","")}va("");const je="@firebase/installations",se="0.6.14";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
