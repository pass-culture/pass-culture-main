import{j as k}from"./jsx-runtime-CfatFE5O.js";import{V as dt}from"./index-DfbDQrFU.js";import{r as ft}from"./index-ClcD9ViR.js";import"./config-BdqymTTq.js";import{u as gt}from"./index-xCbVRQir.js";import{f as pt}from"./full-help-Co3hxUDJ.js";import{S as mt}from"./SvgIcon-g5H-kf5W.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-B5DG7xGS.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jt{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Gt(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function Gt(e){const t=e.getComponent();return(t==null?void 0:t.type)==="VERSION"}const Q="@firebase/app",fe="0.10.16";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yn="firebase-heartbeat-database",An=1,P="firebase-heartbeat-store";let j=null;function xe(){return j||(j=Ke(yn,An,{upgrade:(e,t)=>{switch(t){case 0:try{e.createObjectStore(P)}catch(n){console.warn(n)}}}}).catch(e=>{throw re.create("idb-open",{originalErrorMessage:e.message})})),j}async function Dn(e){try{const n=(await xe()).transaction(P),r=await n.objectStore(P).get(Ve(e));return await n.done,r}catch(t){if(t instanceof A)I.warn(t.message);else{const n=re.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});I.warn(n.message)}}}async function me(e,t){try{const r=(await xe()).transaction(P,"readwrite");await r.objectStore(P).put(t,Ve(e)),await r.done}catch(n){if(n instanceof A)I.warn(n.message);else{const r=re.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});I.warn(r.message)}}}function Ve(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const it="installations",pr="installations-internal",mr=e=>{const t=e.getProvider("app").getImmediate(),n=gr(t),r=He(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},Cr=e=>{const t=e.getProvider("app").getImmediate(),n=He(t,it).getImmediate();return{getId:()=>hr(n),getToken:a=>dr(n,a)}};function _r(){y(new S(it,mr,"PUBLIC")),y(new S(pr,Cr,"PRIVATE"))}_r();E(Ue,ae);E(Ue,ae,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
