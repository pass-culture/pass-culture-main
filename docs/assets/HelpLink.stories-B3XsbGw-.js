 ...
 */const $e=function(e){const t=[];let n=0;for(let r=0;r<e.length;r++){let s=e.charCodeAt(r);s<128?t[n++]=s:s<2048?(t[n++]=s>>6|192,t[n++]=s&63|128):(s&64512)===55296&&r+1<e.length&&(e.charCodeAt(r+1)&64512)===56320?(s=65536+((s&1023)<<10)+(e.charCodeAt(++r)&1023),t[n++]=s>>18|240,t[n++]=s>>12&63|128,t[n++]=s>>6&63|128,t[n++]=s&63|128):(t[n++]=s>>12|224,t[n++]=s>>6&63|128,t[n++]=s&63|128)}return t},wt=function(e){const t=[];let n=0,r=0;for(;n<e.length;){const s=e[n++];if(s<128)t[r++]=String.fromCharCode(s);else if(s>191&&s<224){const a=e[n++];t[r++]=String.fromCharCode((s&31)<<6|a&63)}else if(s>239&&s<365){const a=e[n++],i=e[n++],o=e[n++],c=((s&7)<<18|(a&63)<<12|(i&63)<<6|o&63)-65536;t[r++]=String.fromCharCode(55296+(c>>10)),t[r++]=String.fromCharCode(56320+(c&1023))}else{const a=e[n++],i=e[n++];t[r++]=String.fromCharCode((s&15)<<12|(a&63)<<6|i&63)}}return t.join("")},yt={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(e,t){if(!Array.isArray(e))throw Error("encodeByteArray takes an array as a parameter");this.init_();const n=t?this.byteToCharMapWebSafe_:this.byteToCharMap_,r=[];for(let s=0;s<e.length;s+=3){const a=e[s],i=s+1<e.length,o=i?e[s+1]:0,c=s+2<e.length,l=c?e[s+2]:0,d=a>>2,f=(a&3)<<4|o>>4;let g=(o&15)<<2|l>>6,p=l&63;c||(p=64,i||(g=64)),r.push(n[d],n[f],n[g],n[p])}return r.join("")},encodeString(e,t){return this.HAS_NATIVE_SUPPORT&&!t?btoa(e):this.encodeByteArray($e(e),t)},decodeString(e,t){return this.HAS_NATIVE_SUPPORT&&!t?atob(e):wt(this.decodeStringToByteArray(e,t))},decodeStringToByteArray(e,t){this.init_();const n=t?this.charToByteMapWebSafe_:this.charToByteMap_,r=[];for(let s=0;s<e.length;){const a=n[e.charAt(s++)],o=s<e.length?n[e.charAt(s)]:0;++s;const l=s<e.length?n[e.charAt(s)]:64;++s;const f=s<e.length?n[e.charAt(s)]:64;if(++s,a==null||o==null||l==null||f==null)throw new St;const g=a<<2|o>>4;if(r.push(g),l!==64){const p=o<<4&240|l>>2;if(r.push(p),f!==64){const b=l<<6&192|f;r.push(b)}}}return r},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let e=0;e<this.ENCODED_VALS.length;e++)this.byteToCharMap_[e]=this.ENCODED_VALS.charAt(e),this.charToByteMap_[this.byteToCharMap_[e]]=e,this.byteToCharMapWebSafe_[e]=this.ENCODED_VALS_WEBSAFE.charAt(e),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[e]]=e,e>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(e)]=e,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(e)]=e)}}};class St extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const Tt=function(e){const t=$e(e);return yt.encodeByteArray(t,!0)},He=function(e){return Tt(e).replace(/\./g,"")};function At(){try{return typeof indexedDB=="object"}catch{return!1}}function Dt(){return new Promise((e,t)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(r);s.onsuccess=()=>{s.result.close(),n||self.indexedDB.deleteDatabase(r),e(!0)},s.onupgradeneeded=()=>{n=!1},s.onerror=()=>{var a;t(((a=s.error)===null||a===void 0?void 0:a.message)||"")}}catch(n){t(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ot="FirebaseError";let re=class xe extends Error{constructor(t,n,r){super(n),this.code=t,this.customData=r,this.name=Ot,Object.setPrototypeOf(this,xe.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Ke.prototype.create)}},Ke=class{constructor(t,n,r){this.service=t,this.serviceName=n,this.errors=r}create(t,...n){const r=n[0]||{},s=`${this.service}/${t}`,a=this.errors[t],i=a?Rt(a,r):"Error",o=`${this.serviceName}: ${i} (${s}).`;return new re(s,o,r)}};function Rt(e,t){return e.replace(Lt,(n,r)=>{const s=t[r];return s!=null?String(s):`<${r}?>`})}const Lt=/\{\$([^}]+)}/g;let X=class{constructor(t,n,r){this.name=t,this.instanceFactory=n,this.type=r,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(t){return this.instantiationMode=t,this}setMultipleInstances(t){return this.multipleInstances=t,this}setServiceProps(t){return this.serviceProps=t,this}setInstanceCreatedCallback(t){return this.onInstanceCreated=t,this}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wt{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(qt(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function qt(e){const t=e.getComponent();return(t==null?void 0:t.type)==="VERSION"}const ee="@firebase/app",pe="0.10.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const O=new Pt("@firebase/app"),zt="@firebase/app-compat",Yt="@firebase/analytics-compat",Jt="@firebase/analytics",Xt="@firebase/app-check-compat",Qt="@firebase/app-check",Zt="@firebase/auth",en="@firebase/auth-compat",tn="@firebase/database",nn="@firebase/database-compat",rn="@firebase/functions",sn="@firebase/functions-compat",an="@firebase/installations",on="@firebase/installations-compat",cn="@firebase/messaging",ln="@firebase/messaging-compat",un="@firebase/performance",dn="@firebase/performance-compat",hn="@firebase/remote-config",fn="@firebase/remote-config-compat",gn="@firebase/storage",pn="@firebase/storage-compat",mn="@firebase/firestore",_n="@firebase/firestore-compat",Cn="firebase",En="10.10.0",In={[ee]:"fire-core",[zt]:"fire-core-compat",[Jt]:"fire-analytics",[Yt]:"fire-analytics-compat",[Qt]:"fire-app-check",[Xt]:"fire-app-check-compat",[Zt]:"fire-auth",[en]:"fire-auth-compat",[tn]:"fire-rtdb",[nn]:"fire-rtdb-compat",[rn]:"fire-fn",[sn]:"fire-fn-compat",[an]:"fire-iid",[on]:"fire-iid-compat",[cn]:"fire-fcm",[ln]:"fire-fcm-compat",[un]:"fire-perf",[dn]:"fire-perf-compat",[hn]:"fire-rc",[fn]:"fire-rc-compat",[gn]:"fire-gcs",[pn]:"fire-gcs-compat",[mn]:"fire-fst",[_n]:"fire-fst-compat","fire-js":"fire-js",[Cn]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tn="firebase-heartbeat-database",An=1,P="firebase-heartbeat-store";let W=null;function We(){return W||(W=je(Tn,An,{upgrade:(e,t)=>{switch(t){case 0:try{e.createObjectStore(P)}catch(n){console.warn(n)}}}}).catch(e=>{throw ae.create("idb-open",{originalErrorMessage:e.message})})),W}async function Dn(e){try{const n=(await We()).transaction(P),r=await n.objectStore(P).get(qe(e));return await n.done,r}catch(t){if(t instanceof re)O.warn(t.message);else{const n=ae.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});O.warn(n.message)}}}async function Ce(e,t){try{const r=(await We()).transaction(P,"readwrite");await r.objectStore(P).put(t,qe(e)),await r.done}catch(n){if(n instanceof re)O.warn(n.message);else{const r=ae.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});O.warn(r.message)}}}function qe(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mn(e){S(new X("platform-logger",t=>new Wt(t),"PRIVATE")),S(new X("heartbeat",t=>new Ln(t),"PRIVATE")),I(ee,pe,e),I(ee,pe,"esm2017"),I("fire-js","")}Mn("");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var u;(function(e){e[e.DEBUG=0]="DEBUG",e[e.VERBOSE=1]="VERBOSE",e[e.INFO=2]="INFO",e[e.WARN=3]="WARN",e[e.ERROR=4]="ERROR",e[e.SILENT=5]="SILENT"})(u||(u={}));const Fn={debug:u.DEBUG,verbose:u.VERBOSE,info:u.INFO,warn:u.WARN,error:u.ERROR,silent:u.SILENT},Pn=u.INFO,kn={[u.DEBUG]:"log",[u.VERBOSE]:"log",[u.INFO]:"info",[u.WARN]:"warn",[u.ERROR]:"error"},Bn=(e,t,...n)=>{if(t<e.logLevel)return;const r=new Date().toISOString(),s=kn[t];if(s)console[s](`[${r}]  ${e.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`)};class ze{constructor(t){this.name=t,this._logLevel=Pn,this._logHandler=Bn,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(t){if(!(t in u))throw new TypeError(`Invalid value "${t}" assigned to \`logLevel\``);this._logLevel=t}setLogLevel(t){this._logLevel=typeof t=="string"?Fn[t]:t}get logHandler(){return this._logHandler}set logHandler(t){if(typeof t!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=t}get userLogHandler(){return this._userLogHandler}set userLogHandler(t){this._userLogHandler=t}debug(...t){this._userLogHandler&&this._userLogHandler(this,u.DEBUG,...t),this._logHandler(this,u.DEBUG,...t)}log(...t){this._userLogHandler&&this._userLogHandler(this,u.VERBOSE,...t),this._logHandler(this,u.VERBOSE,...t)}info(...t){this._userLogHandler&&this._userLogHandler(this,u.INFO,...t),this._logHandler(this,u.INFO,...t)}warn(...t){this._userLogHandler&&this._userLogHandler(this,u.WARN,...t),this._logHandler(this,u.WARN,...t)}error(...t){this._userLogHandler&&this._userLogHandler(this,u.ERROR,...t),this._logHandler(this,u.ERROR,...t)}}function $n(){const e=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof e=="object"&&e.id!==void 0}function Ye(){try{return typeof indexedDB=="object"}catch{return!1}}function Hn(){return new Promise((e,t)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(r);s.onsuccess=()=>{s.result.close(),n||self.indexedDB.deleteDatabase(r),e(!0)},s.onupgradeneeded=()=>{n=!1},s.onerror=()=>{var a;t(((a=s.error)===null||a===void 0?void 0:a.message)||"")}}catch(n){t(n)}})}function xn(){return!(typeof navigator>"u"||!navigator.cookieEnabled)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Je(e){return e&&e._delegate?e._delegate:e}class k{constructor(t,n,r){this.name=t,this.instanceFactory=n,this.type=r,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(t){return this.instantiationMode=t,this}setMultipleInstances(t){return this.multipleInstances=t,this}setServiceProps(t){return this.serviceProps=t,this}setInstanceCreatedCallback(t){return this.onInstanceCreated=t,this}}const Xe="@firebase/installations",ie="0.6.5";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qe=1e4,Ze=`w:${ie}`,et="FIS_v2",zn="https://firebaseinstallations.googleapis.com/v1",Yn=60*60*1e3,Jn="installations",Xn="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qn={"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."},R=new x(Jn,Xn,Qn);function tt(e){return e instanceof v&&e.code.includes("request-failed")}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nt({projectId:e}){return`${zn}/projects/${e}/installations`}function rt(e){return{token:e.token,requestStatus:2,expiresIn:er(e.expiresIn),creationTime:Date.now()}}async function st(e,t){const r=(await t.json()).error;return R.create("request-failed",{requestName:e,serverCode:r.code,serverMessage:r.message,serverStatus:r.status})}function at({apiKey:e}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":e})}function Zn(e,{refreshToken:t}){const n=at(e);return n.append("Authorization",tr(t)),n}async function it(e){const t=await e();return t.status>=500&&t.status<600?e():t}function er(e){return Number(e.replace("s","000"))}function tr(e){return`${et} ${e}`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function nr({appConfig:e,heartbeatServiceProvider:t},{fid:n}){const r=nt(e),s=at(e),a=t.getImmediate({optional:!0});if(a){const l=await a.getHeartbeatsHeader();l&&s.append("x-firebase-client",l)}const i={fid:n,authVersion:et,appId:e.appId,sdkVersion:Ze},o={method:"POST",headers:s,body:JSON.stringify(i)},c=await it(()=>fetch(r,o));if(c.ok){const l=await c.json();return{fid:l.fid||n,registrationStatus:2,refreshToken:l.refreshToken,authToken:rt(l.authToken)}}else throw await st("Create Installation",c)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ur="firebase-installations-database",dr=1,L="firebase-installations-store";let q=null;function oe(){return q||(q=je(ur,dr,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(L)}}})),q}async function H(e,t){const n=K(e),s=(await oe()).transaction(L,"readwrite"),a=s.objectStore(L),i=await a.get(n);return await a.put(t,n),await s.done,(!i||i.fid!==t.fid)&&lt(e,t.fid),t}async function dt(e){const t=K(e),r=(await oe()).transaction(L,"readwrite");await r.objectStore(L).delete(t),await r.done}async function V(e,t){const n=K(e),s=(await oe()).transaction(L,"readwrite"),a=s.objectStore(L),i=await a.get(n),o=t(i);return o===void 0?await a.delete(n):await a.put(o,n),await s.done,o&&(!i||i.fid!==o.fid)&&lt(e,o.fid),o}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ce(e){let t;const n=await V(e.appConfig,r=>{const s=hr(r),a=fr(e,s);return t=a.registrationPromise,a.installationEntry});return n.fid===ne?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}function hr(e){const t=e||{fid:ar(),registrationStatus:0};return ht(t)}function fr(e,t){if(t.registrationStatus===0){if(!navigator.onLine){const s=Promise.reject(R.create("app-offline"));return{installationEntry:t,registrationPromise:s}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},r=gr(e,n);return{installationEntry:n,registrationPromise:r}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:pr(e)}:{installationEntry:t}}async function gr(e,t){try{const n=await nr(e,t);return H(e.appConfig,n)}catch(n){throw tt(n)&&n.customData.serverCode===409?await dt(e.appConfig):await H(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}async function pr(e){let t=await be(e.appConfig);for(;t.registrationStatus===1;)await ot(100),t=await be(e.appConfig);if(t.registrationStatus===0){const{installationEntry:n,registrationPromise:r}=await ce(e);return r||n}return t}function be(e){return V(e,t=>{if(!t)throw R.create("installation-not-found");return ht(t)})}function ht(e){return mr(e)?{fid:e.fid,registrationStatus:0}:e}function mr(e){return e.registrationStatus===1&&e.registrationTime+Qe<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _r({appConfig:e,heartbeatServiceProvider:t},n){const r=Cr(e,n),s=Zn(e,n),a=t.getImmediate({optional:!0});if(a){const l=await a.getHeartbeatsHeader();l&&s.append("x-firebase-client",l)}const i={installation:{sdkVersion:Ze,appId:e.appId}},o={method:"POST",headers:s,body:JSON.stringify(i)},c=await it(()=>fetch(r,o));if(c.ok){const l=await c.json();return rt(l)}else throw await st("Generate Auth Token",c)}function Cr(e,{fid:t}){return`${nt(e)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function le(e,t=!1){let n;const r=await V(e.appConfig,a=>{if(!ft(a))throw R.create("not-registered");const i=a.authToken;if(!t&&br(i))return a;if(i.requestStatus===1)return n=Er(e,t),a;{if(!navigator.onLine)throw R.create("app-offline");const o=yr(a);return n=Ir(e,o),o}});return n?await n:r.authToken}async function Er(e,t){let n=await we(e.appConfig);for(;n.authToken.requestStatus===1;)await ot(100),n=await we(e.appConfig);const r=n.authToken;return r.requestStatus===0?le(e,t):r}function we(e){return V(e,t=>{if(!ft(t))throw R.create("not-registered");const n=t.authToken;return Sr(n)?Object.assign(Object.assign({},t),{authToken:{requestStatus:0}}):t})}async function Ir(e,t){try{const n=await _r(e,t),r=Object.assign(Object.assign({},t),{authToken:n});return await H(e.appConfig,r),n}catch(n){if(tt(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await dt(e.appConfig);else{const r=Object.assign(Object.assign({},t),{authToken:{requestStatus:0}});await H(e.appConfig,r)}throw n}}function ft(e){return e!==void 0&&e.registrationStatus===2}function br(e){return e.requestStatus===2&&!wr(e)}function wr(e){const t=Date.now();return t<e.creationTime||e.creationTime+e.expiresIn<t+Yn}function yr(e){const t={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},e),{authToken:t})}function Sr(e){return e.requestStatus===1&&e.requestTime+Qe<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gt="installations",Rr="installations-internal",Lr=e=>{const t=e.getProvider("app").getImmediate(),n=Or(t),r=Ge(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},Nr=e=>{const t=e.getProvider("app").getImmediate(),n=Ge(t,gt).getImmediate();return{getId:()=>Tr(n),getToken:s=>Ar(n,s)}};function vr(){S(new k(gt,Lr,"PUBLIC")),S(new k(Rr,Nr,"PRIVATE"))}vr();I(Xe,ie);I(Xe,ie,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ye="analytics",Mr="firebase_id",Fr="origin",Pr=60*1e3,kr="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",ue="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qr=30,zr=1e3;class Yr{constructor(t={},n=zr){this.throttleMetadata=t,this.intervalMillis=n}getThrottleMetadata(t){return this.throttleMetadata[t]}setThrottleMetadata(t,n){this.throttleMetadata[t]=n}deleteThrottleMetadata(t){delete this.throttleMetadata[t]}}const mt=new Yr;function Jr(e){return new Headers({Accept:"application/json","x-goog-api-key":e})}async function Xr(e){var t;const{appId:n,apiKey:r}=e,s={method:"GET",headers:Jr(r)},a=kr.replace("{app-id}",n),i=await fetch(a,s);if(i.status!==200&&i.status!==304){let o="";try{const c=await i.json();!((t=c.error)===null||t===void 0)&&t.message&&(o=c.error.message)}catch{}throw C.create("config-fetch-failed",{httpStatus:i.status,responseMessage:o})}return i.json()}async function Qr(e,t=mt,n){const{appId:r,apiKey:s,measurementId:a}=e.options;if(!r)throw C.create("no-app-id");if(!s){if(a)return{measurementId:a,appId:r};throw C.create("no-api-key")}const i=t.getThrottleMetadata(r)||{backoffCount:0,throttleEndTimeMillis:Date.now()},o=new ts;return setTimeout(async()=>{o.abort()},n!==void 0?n:Pr),_t({appId:r,apiKey:s,measurementId:a},i,o,t)}async function _t(e,{throttleEndTimeMillis:t,backoffCount:n},r,s=mt){var a;const{appId:i,measurementId:o}=e;try{await Zr(r,t)}catch(c){if(o)return _.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${o} provided in the "measurementId" field in the local Firebase config. [${c==null?void 0:c.message}]`),{appId:i,measurementId:o};throw c}try{const c=await Xr(e);return s.deleteThrottleMetadata(i),c}catch(c){const l=c;if(!es(l)){if(s.deleteThrottleMetadata(i),o)return _.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${o} provided in the "measurementId" field in the local Firebase config. [${l==null?void 0:l.message}]`),{appId:i,measurementId:o};throw c}const d=Number((a=l==null?void 0:l.customData)===null||a===void 0?void 0:a.httpStatus)===503?te(n,s.intervalMillis,qr):te(n,s.intervalMillis),f={throttleEndTimeMillis:Date.now()+d,backoffCount:n+1};return s.setThrottleMetadata(i,f),_.debug(`Calling attemptFetch again in ${d} millis`),_t(e,f,r,s)}}function Zr(e,t){return new Promise((n,r)=>{const s=Math.max(t-Date.now(),0),a=setTimeout(n,s);e.addEventListener(()=>{clearTimeout(a),r(C.create("fetch-throttle",{throttleEndTimeMillis:t}))})})}function es(e){if(!(e instanceof v)||!e.customData)return!1;const t=Number(e.customData.httpStatus);return t===429||t===500||t===503||t===504}class ts{constructor(){this.listeners=[]}addEventListener(t){this.listeners.push(t)}abort(){this.listeners.forEach(t=>t())}}async function ns(e,t,n,r,s){if(s&&s.global){e("event",n,r);return}else{const a=await t,i=Object.assign(Object.assign({},r),{send_to:a});e("event",n,i)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class as{constructor(t){this.app=t}_delete(){return delete F[this.app.options.appId],Promise.resolve()}}let F={},Se=[];const Te={};let Y="dataLayer",is="gtag",Ae,Ct,De=!1;function os(){const e=[];if($n()&&e.push("This is a browser extension environment."),xn()||e.push("Cookies are not available."),e.length>0){const t=e.map((r,s)=>`(${s+1}) ${r}`).join(" "),n=C.create("invalid-analytics-context",{errorInfo:t});_.warn(n.message)}}function cs(e,t,n){os();const r=e.options.appId;if(!r)throw C.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)_.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw C.create("no-api-key");if(F[r]!=null)throw C.create("already-exists",{id:r});if(!De){Kr(Y);const{wrappedGtag:a,gtagCore:i}=Gr(F,Se,Te,Y,is);Ct=a,Ae=i,De=!0}return F[r]=ss(e,Se,Te,t,Ae,Y,n),new as(e)}function ls(e,t,n,r){e=Je(e),ns(Ct,F[e.app.options.appId],t,n,r).catch(s=>_.error(s))}const Oe="@firebase/analytics",Re="0.10.1";function us(){S(new k(ye,(t,{options:n})=>{const r=t.getProvider("app").getImmediate(),s=t.getProvider("installations-internal").getImmediate();return cs(r,s,n)},"PUBLIC")),S(new k("analytics-internal",e,"PRIVATE")),I(Oe,Re),I(Oe,Re,"esm2017");function e(t){try{const n=t.getProvider(ye).getImmediate();return{logEvent:(r,s,a)=>ls(n,r,s,a)}}catch(n){throw C.create("interop-component-reg-failed",{reason:n})}}}us();const J="@firebase/remote-config",Le="0.4.5";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ms{constructor(t,n,r,s,a,i){this.firebaseInstallations=t,this.sdkVersion=n,this.namespace=r,this.projectId=s,this.apiKey=a,this.appId=i}async fetch(t){const[n,r]=await Promise.all([this.firebaseInstallations.getId(),this.firebaseInstallations.getToken()]),a=`${window.FIREBASE_REMOTE_CONFIG_URL_BASE||"https://firebaseremoteconfig.googleapis.com"}/v1/projects/${this.projectId}/namespaces/${this.namespace}:fetch?key=${this.apiKey}`,i={"Content-Type":"application/json","Content-Encoding":"gzip","If-None-Match":t.eTag||"*"},o={sdk_version:this.sdkVersion,app_instance_id:n,app_instance_id_token:r,app_id:this.appId,language_code:ps()},c={method:"POST",headers:i,body:JSON.stringify(o)},l=fetch(a,c),d=new Promise((E,w)=>{t.signal.addEventListener(()=>{const de=new Error("The operation was aborted.");de.name="AbortError",w(de)})});let f;try{await Promise.race([l,d]),f=await l}catch(E){let w="fetch-client-network";throw(E==null?void 0:E.name)==="AbortError"&&(w="fetch-timeout"),m.create(w,{originalErrorMessage:E==null?void 0:E.message})}let g=f.status;const p=f.headers.get("ETag")||void 0;let b,M;if(f.status===200){let E;try{E=await f.json()}catch(w){throw m.create("fetch-client-parse",{originalErrorMessage:w==null?void 0:w.message})}b=E.entries,M=E.state}if(M==="INSTANCE_STATE_UNSPECIFIED"?g=500:M==="NO_CHANGE"?g=304:(M==="NO_TEMPLATE"||M==="EMPTY_CONFIG")&&(b={}),g!==304&&g!==200)throw m.create("fetch-status",{httpStatus:g});return{status:g,eTag:p,config:b}}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Os(){S(new k(ds,e,"PUBLIC").setMultipleInstances(!0)),I(J,Le),I(J,Le,"esm2017");function e(t,{instanceIdentifier:n}){const r=t.getProvider("app").getImmediate(),s=t.getProvider("installations-internal").getImmediate();if(typeof window>"u")throw m.create("registration-window");if(!Ye())throw m.create("indexed-db-unavailable");const{projectId:a,apiKey:i,appId:o}=r.options;if(!a)throw m.create("registration-project-id");if(!i)throw m.create("registration-api-key");if(!o)throw m.create("registration-app-id");n=n||"firebase";const c=new As(o,r.name,n),l=new Ds(c),d=new ze(J);d.logLevel=u.ERROR;const f=new ms(s,Sn,n,a,i,o),g=new Es(f,c),p=new gs(g,c,l,d),b=new ws(r,p,l,c,d);return fs(b),b}}Os();const Et=N.createContext({});function Ne({children:e}){const[t,n]=N.useState();return D.jsx(Et.Provider,{value:{logEvent:t,setLogEvent:n},children:e})}try{Ne.displayName="AnalyticsContextProvider",Ne.__docgenInfo={description:"",displayName:"AnalyticsContextProvider",props:{}}}catch{}const Rs=N.createContext({remoteConfig:null,setRemoteConfig:null,remoteConfigData:null,setRemoteConfigData:null});function ve({children:e}){const[t,n]=N.useState(null),[r,s]=N.useState(null);return D.jsx(Rs.Provider,{value:{remoteConfig:t,setRemoteConfig:n,remoteConfigData:r,setRemoteConfigData:s},children:e})}try{ve.displayName="RemoteContextProvider",ve.__docgenInfo={description:"",displayName:"RemoteContextProvider",props:{}}}catch{}function Ls(){return N.useContext(Et)}const Me={"help-link":"_help-link_9okj2_2","help-link-text":"_help-link-text_9okj2_10"},Ns=()=>{const{logEvent:e}=Ls();return D.jsxs("a",{onClick:()=>e==null?void 0:e(Be.CLICKED_HELP_LINK,{from:location.pathname}),className:Me["help-link"],href:"https://aide.passculture.app/hc/fr/articles/4411991940369--Acteurs-culturels-Comment-poster-une-offre-%C3%A0-destination-d-un-groupe-scolaire-",rel:"noreferrer",target:"_blank",children:[D.jsx(bt,{src:It,alt:"",width:"42"}),D.jsx("span",{className:Me["help-link-text"],children:"Aide"})]})},vs=Ns,Vs={title:"components/HelpLink",component:vs,decorators:[e=>D.jsx("div",{style:{width:500,height:500},children:D.jsx(e,{})})]},B={};var Fe,Pe,ke;B.parameters={...B.parameters,docs:{...(Fe=B.parameters)==null?void 0:Fe.docs,source:{originalSource:"{}",...(ke=(Pe=B.parameters)==null?void 0:Pe.docs)==null?void 0:ke.source}}};const Us=["Default"];export{B as Default,Us as __namedExportsOrder,Vs as default};
