...
}`,...(Se=(fe=L.parameters)==null?void 0:fe.docs)==null?void 0:Se.source}}};var _e,xe,ye;P.parameters={...P.parameters,docs:{...(_e=P.parameters)==null?void 0:_e.docs,source:{originalSource:`{
  args: {
    data: [],
    noData: {
      hasNoData: true,
...
}`,...(ye=(xe=P.parameters)==null?void 0:xe.docs)==null?void 0:ye.source}}};var Ce,je,ve;H.parameters={...H.parameters,docs:{...(Ce=H.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
  args: {
    selectable: true,
    selectedNumber: '0 sélectionnée'
  }
}`,...(ve=(je=H.parameters)==null?void 0:je.docs)==null?void 0:ve.source}}};var Ne,we,Re;$.parameters={...$.parameters,docs:{...(Ne=$.parameters)==null?void 0:Ne.docs,source:{originalSource:`{
  render: args => {
...
}`,...(Re=(we=$.parameters)==null?void 0:we.docs)==null?void 0:Re.source}}};var Te,De,Ae;O.parameters={...O.parameters,docs:{...(Te=O.parameters)==null?void 0:Te.docs,source:{originalSource:`{
  render: args => <Table {...args} selectable isRowSelectable={row => row.status === 'active'} // disable inactive rows
  selectedNumber="—" />
}`,...(Ae=(De=O.parameters)==null?void 0:De.docs)==null?void 0:Ae.source}}};var ke,Ve,Ie;W.parameters={...W.parameters,docs:{...(ke=W.parameters)==null?void 0:ke.docs,source:{originalSource:`{
  args: {
    isSticky: true
  },
...
}`,...(Ie=(Ve=W.parameters)==null?void 0:Ve.docs)==null?void 0:Ie.source}}};var Ee,Fe,qe;M.parameters={...M.parameters,docs:{...(Ee=M.parameters)==null?void 0:Ee.docs,source:{originalSource:`{
  args: {
    columns: [{
      ...baseColumns[0],
      headerHidden: true
...
}`,...(qe=(Fe=M.parameters)==null?void 0:Fe.docs)==null?void 0:qe.source}}};var Le,Pe,He;z.parameters={...z.parameters,docs:{...(Le=z.parameters)==null?void 0:Le.docs,source:{originalSource:`{
  args: {
    columns: [{
      ...baseColumns[0],
      headerColSpan: 2
...
}`,...(He=(Pe=z.parameters)==null?void 0:Pe.docs)==null?void 0:He.source}}};var $e,Oe,We,Me,ze;v.parameters={...v.parameters,docs:{...($e=v.parameters)==null?void 0:$e.docs,source:{originalSource:`{
  render: args => {
...
}`,...(We=(Oe=v.parameters)==null?void 0:Oe.docs)==null?void 0:We.source},description:{story:`Full-row (colspan) detail row
Your Table renders a second <tr> with a single <td colSpan=...>
whenever getFullRowContent(row) returns a ReactNode.`,...(ze=(Me=v.parameters)==null?void 0:Me.docs)==null?void 0:ze.description}}};var Be,Ze,Ue,Ye,Ge;N.parameters={...N.parameters,docs:{...(Be=N.parameters)==null?void 0:Be.docs,source:{originalSource:`{
  render: args => {
...
}`,...(Qe=(Ke=B.parameters)==null?void 0:Ke.docs)==null?void 0:Qe.source}}};const Wa=["Basic","CollapseVariant","Loading","NoResults","NoDataState","SelectableUncontrolled","SelectableControlled","SelectableWithDisabledRows","StickyHeaderInScrollContainer","WithHiddenColumns","WithHeaderColSpan","WithFullRowAlwaysDisplayedDetail","WithFullRowDetail","SortingShowcase"];export{E as Basic,F as CollapseVariant,q as Loading,P as NoDataState,L as NoResults,$ as SelectableControlled,H as SelectableUncontrolled,O as SelectableWithDisabledRows,B as SortingShowcase,W as StickyHeaderInScrollContainer,v as WithFullRowAlwaysDisplayedDetail,N as WithFullRowDetail,z as WithHeaderColSpan,M as WithHiddenColumns,Wa as __namedExportsOrder,Oa as default};
