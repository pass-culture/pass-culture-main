import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{d as n}from"./iframe-sN1Hpdnf.js";import{t as r}from"./jsx-runtime-DeHZSEgm.js";import{t as i}from"./classnames-D09xBJOL.js";import{n as a,t as o}from"./SvgIcon-DRPrlrFF.js";import{n as s,t as c}from"./dist-DGuxZqMg.js";import{a as l,c as u,i as d,n as f,o as p,s as m}from"./iconsList-2_Asjd9e.js";import{n as h,t as g}from"./stroke-user-c-Truh91.js";var _,v;function y(){return(y=t((()=>{_=`_infopanel_18993_1`,v={infopanel:_,"infopanel-left-wrapper":`_infopanel-left-wrapper_18993_6`,"infopanel-left-wrapper-icon":`_infopanel-left-wrapper-icon_18993_13`,"infopanel-icon":`_infopanel-icon_18993_13`,"infopanel-left-wrapper-stepnumber":`_infopanel-left-wrapper-stepnumber_18993_16`,"infopanel-content-wrapper":`_infopanel-content-wrapper_18993_20`,"infopanel-small":`_infopanel-small_18993_24`,"infopanel-title":`_infopanel-title_18993_41`,"infopanel-content":`_infopanel-content_18993_20`,"infopanel-large":`_infopanel-large_18993_51`,"infopanel-flat":`_infopanel-flat_18993_111`,"infopanel-elevated":`_infopanel-elevated_18993_114`}})))()}var b,x;function S(){return(S=t((()=>{b=function(e){return e.FLAT=`flat`,e.ELEVATED=`elevated`,e}({}),x=function(e){return e.LARGE=`large`,e.SMALL=`small`,e}({})})))()}var C,w,T;function E(){return(E=t((()=>{C=e(i(),1),a(),y(),S(),w=r(),T=({title:e,titleLevel:t=`3`,children:n,surface:r,size:i=x.LARGE,icon:a,iconAlt:s,stepNumber:c})=>{let l=c!==void 0,u=t===`2`?(0,w.jsx)(`h2`,{className:v[`infopanel-title`],children:e}):(0,w.jsx)(`h3`,{className:v[`infopanel-title`],children:e});return(0,w.jsxs)(`section`,{className:(0,C.default)(v.infopanel,v[`infopanel-${r}`],v[`infopanel-${i}`]),children:[(0,w.jsxs)(`div`,{className:(0,C.default)(v[`infopanel-left-wrapper`],{[v[`infopanel-left-wrapper-icon`]]:a,[v[`infopanel-left-wrapper-stepnumber`]]:l}),children:[a&&(0,w.jsx)(o,{src:a,alt:s,className:v[`infopanel-icon`]}),l&&c]}),(0,w.jsxs)(`div`,{className:v[`infopanel-content-wrapper`],children:[u,(0,w.jsx)(`p`,{className:v[`infopanel-content`],children:n})]})]})};try{T.displayName=`InfoPanel`,T.__docgenInfo={description:``,displayName:`InfoPanel`,filePath:`/home/runner/work/pass-culture-main/pass-culture-main/pro/src/ui-kit/InfoPanel/InfoPanel.tsx`,methods:[],props:{title:{defaultValue:null,declarations:[{fileName:`pro/src/ui-kit/InfoPanel/types.ts`,name:`TypeLiteral`}],description:``,name:`title`,required:!0,tags:{},type:{name:`string`}},titleLevel:{defaultValue:{value:`3`},declarations:[{fileName:`pro/src/ui-kit/InfoPanel/types.ts`,name:`TypeLiteral`}],description:``,name:`titleLevel`,required:!1,tags:{},type:{name:`enum`,raw:`"2" | "3"`,value:[{value:`"2"`},{value:`"3"`}]}},surface:{defaultValue:null,declarations:[{fileName:`pro/src/ui-kit/InfoPanel/types.ts`,name:`TypeLiteral`}],description:``,name:`surface`,required:!0,tags:{},type:{name:`enum`,raw:`InfoPanelSurface`,value:[{value:`"flat"`,description:``,fullComment:``,tags:{}},{value:`"elevated"`,description:``,fullComment:``,tags:{}}]}},size:{defaultValue:{value:`InfoPanelSize.LARGE`},declarations:[{fileName:`pro/src/ui-kit/InfoPanel/types.ts`,name:`TypeLiteral`}],description:``,name:`size`,required:!1,tags:{},type:{name:`enum`,raw:`InfoPanelSize`,value:[{value:`"large"`,description:``,fullComment:``,tags:{}},{value:`"small"`,description:``,fullComment:``,tags:{}}]}},icon:{defaultValue:null,declarations:[{fileName:`pro/src/ui-kit/InfoPanel/types.ts`,name:`TypeLiteral`},{fileName:`pro/src/ui-kit/InfoPanel/types.ts`,name:`TypeLiteral`}],description:``,name:`icon`,required:!1,tags:{},type:{name:`string`}},iconAlt:{defaultValue:null,declarations:[{fileName:`pro/src/ui-kit/InfoPanel/types.ts`,name:`TypeLiteral`},{fileName:`pro/src/ui-kit/InfoPanel/types.ts`,name:`TypeLiteral`}],description:``,name:`iconAlt`,required:!1,tags:{},type:{name:`string`}},stepNumber:{defaultValue:null,declarations:[{fileName:`pro/src/ui-kit/InfoPanel/types.ts`,name:`TypeLiteral`},{fileName:`pro/src/ui-kit/InfoPanel/types.ts`,name:`TypeLiteral`}],description:``,name:`stepNumber`,required:!1,tags:{},type:{name:`number`}}},tags:{}}}catch{}})))()}var D,O,k,A,j,M,N,P,F,I,L,R,z,B;function V(){return(V=t((()=>{n(),s(),g(),m(),l(),f(),E(),S(),D=r(),O={none:null,...Object.fromEntries(d.map(e=>[e.src.split(`/`).pop()?.replace(`.svg`,``)||``,e.src]))},k={title:`@/ui-kit/InfoPanel`,component:T,decorators:[c],args:{title:`Panel title`,children:`Panel content description.`,size:x.LARGE},argTypes:{surface:{control:`select`,options:Object.values(b),description:"Variante visuelle. `flat` n'a pas de bordure, `elevated` a une bordure."},size:{control:`select`,options:Object.values(x),description:`Taille du panneau.`,table:{defaultValue:{summary:`large`}}},title:{control:`text`,description:`Titre affiché en haut du panneau.`},children:{control:`text`,description:`Contenu du panneau (chaîne de caractères ou JSX).`},stepNumber:{control:`number`,description:`Numéro d'étape affiché à gauche.`},icon:{control:`select`,options:Object.keys(O),mapping:O,description:"Source de l'icône SVG affichée à gauche (uniquement quand `stepNumber` est non-défini)",if:{arg:`stepNumber`,exists:!1}},iconAlt:{control:`text`,description:"Texte alternatif accessible pour l'icône (uniquement quand `stepNumber` est non-défini)",if:{arg:`stepNumber`,exists:!1}}},parameters:{docs:{description:{component:`\`InfoPanel\` affiche une information contextuelle avec un titre et un texte descriptif.
