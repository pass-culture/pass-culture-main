import{j as n}from"./jsx-runtime-CfatFE5O.js";import{c as r}from"./index-DeARc5FM.js";import{r as l}from"./index-ClcD9ViR.js";import"./_commonjsHelpers-Cpj98o6Y.js";const b="_toggle_lh4i3_1",c={toggle:b,"toggle-display":"_toggle-display_lh4i3_21"},o=({isActiveByDefault:e=!1,isDisabled:p=!1,label:f="Label",handleClick:t})=>{const[s,i]=l.useState(e);l.useEffect(()=>{i(e)},[e]);const m=l.useCallback(()=>{i(!s),t==null||t()},[s,t]);return n.jsxs("button",{className:r(c.toggle),type:"button",disabled:p,"aria-pressed":s,onClick:m,children:[f,n.jsx("span",{className:r(c["toggle-display"]),hidden:!0})]})};try{o.displayName="Toggle",o.__docgenInfo={description:`The Toggle component is used to render a button that represents an on/off state.
