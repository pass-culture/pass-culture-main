 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kt="FirebaseError";class D extends Error{constructor(t,n,a){super(n),this.code=t,this.customData=a,this.name=kt,Object.setPrototypeOf(this,D.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,B.prototype.create)}}class B{constructor(t,n,a){this.service=t,this.serviceName=n,this.errors=a}create(t,...n){const a=n[0]||{},r=`${this.service}/${t}`,s=this.errors[t],i=s?vt(s,a):"Error",c=`${this.serviceName}: ${i} (${r}).`;return new D(r,c,a)}}function vt(e,t){return e.replace(Nt,(n,a)=>{const r=t[a];return r!=null?String(r):`<${a}?>`})}const Nt=/\{\$([^}]+)}/g;/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nn{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(rn(n)){const a=n.getImmediate();return`${a.library}/${a.version}`}else return null}).filter(n=>n).join(" ")}}function rn(e){const t=e.getComponent();return(t==null?void 0:t.type)==="VERSION"}const re="@firebase/app",Ee="0.9.25";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const R=new ce("@firebase/app"),an="@firebase/app-compat",sn="@firebase/analytics-compat",on="@firebase/analytics",cn="@firebase/app-check-compat",ln="@firebase/app-check",un="@firebase/auth",dn="@firebase/auth-compat",hn="@firebase/database",fn="@firebase/database-compat",gn="@firebase/functions",pn="@firebase/functions-compat",mn="@firebase/installations",Cn="@firebase/installations-compat",_n="@firebase/messaging",In="@firebase/messaging-compat",bn="@firebase/performance",En="@firebase/performance-compat",wn="@firebase/remote-config",yn="@firebase/remote-config-compat",Sn="@firebase/storage",Tn="@firebase/storage-compat",Dn="@firebase/firestore",An="@firebase/firestore-compat",On="firebase",Ln="10.7.1",Rn={[re]:"fire-core",[an]:"fire-core-compat",[on]:"fire-analytics",[sn]:"fire-analytics-compat",[ln]:"fire-app-check",[cn]:"fire-app-check-compat",[un]:"fire-auth",[dn]:"fire-auth-compat",[hn]:"fire-rtdb",[fn]:"fire-rtdb-compat",[gn]:"fire-fn",[pn]:"fire-fn-compat",[mn]:"fire-iid",[Cn]:"fire-iid-compat",[_n]:"fire-fcm",[In]:"fire-fcm-compat",[bn]:"fire-perf",[En]:"fire-perf-compat",[wn]:"fire-rc",[yn]:"fire-rc-compat",[Sn]:"fire-gcs",[Tn]:"fire-gcs-compat",[Dn]:"fire-fst",[An]:"fire-fst-compat","fire-js":"fire-js",[On]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kn=Ln;function I(e,t,n){var a;let r=(a=Rn[e])!==null&&a!==void 0?a:e;n&&(r+=`-${n}`);const s=r.match(/\s|\//),i=t.match(/\s|\//);if(s||i){const c=[`Unable to register library "${r}" with version "${t}":`];s&&c.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&i&&c.push("and"),i&&c.push(`version name "${t}" contains illegal characters (whitespace or "/")`),R.warn(c.join(" "));return}T(new S(`${r}-version`,()=>({library:r,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vn="firebase-heartbeat-database",Nn=1,N="firebase-heartbeat-store";let W=null;function Ze(){return W||(W=Zt(vn,Nn,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(N)}}}).catch(e=>{throw ue.create("idb-open",{originalErrorMessage:e.message})})),W}async function Bn(e){try{return await(await Ze()).transaction(N).objectStore(N).get(et(e))}catch(t){if(t instanceof D)R.warn(t.message);else{const n=ue.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});R.warn(n.message)}}}async function ye(e,t){try{const a=(await Ze()).transaction(N,"readwrite");await a.objectStore(N).put(t,et(e)),await a.done}catch(n){if(n instanceof D)R.warn(n.message);else{const a=ue.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});R.warn(a.message)}}}function et(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $n=1024,xn=30*24*60*60*1e3;class Kn{constructor(t){this.container=t,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new Hn(n),this._heartbeatsCachePromise=this._storage.read().then(a=>(this._heartbeatsCache=a,a))}async triggerHeartbeat(){var t,n;const r=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=Se();if(!(((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((n=this._heartbeatsCache)===null||n===void 0?void 0:n.heartbeats)==null))&&!(this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(i=>i.date===s)))return this._heartbeatsCache.heartbeats.push({date:s,agent:r}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(i=>{const c=new Date(i.date).valueOf();return Date.now()-c<=xn}),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){var t;if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const n=Se(),{heartbeatsToSend:a,unsentEntries:r}=jn(this._heartbeatsCache.heartbeats),s=qe(JSON.stringify({version:2,heartbeats:a}));return this._heartbeatsCache.lastSentHeartbeatDate=n,r.length>0?(this._heartbeatsCache.heartbeats=r,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}}function Se(){return new Date().toISOString().substring(0,10)}function jn(e,t=$n){const n=[];let a=e.slice();for(const r of e){const s=n.find(i=>i.agent===r.agent);if(s){if(s.dates.push(r.date),Te(n)>t){s.dates.pop();break}}else if(n.push({agent:r.agent,dates:[r.date]}),Te(n)>t){n.pop();break}a=a.slice(1)}return{heartbeatsToSend:n,unsentEntries:a}}class Hn{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return oe()?ze().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const n=await Bn(this.app);return n!=null&&n.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(t){var n;if(await this._canUseIndexedDBPromise){const r=await this.read();return ye(this.app,{lastSentHeartbeatDate:(n=t.lastSentHeartbeatDate)!==null&&n!==void 0?n:r.lastSentHeartbeatDate,heartbeats:t.heartbeats})}else return}async add(t){var n;if(await this._canUseIndexedDBPromise){const r=await this.read();return ye(this.app,{lastSentHeartbeatDate:(n=t.lastSentHeartbeatDate)!==null&&n!==void 0?n:r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...t.heartbeats]})}else return}}function Te(e){return qe(JSON.stringify({version:2,heartbeats:e})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ge(e){let t;const n=await H(e.appConfig,a=>{const r=Ir(a),s=br(e,r);return t=s.registrationPromise,s.installationEntry});return n.fid===ie?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}function Ir(e){const t=e||{fid:hr(),registrationStatus:0};return _t(t)}function br(e,t){if(t.registrationStatus===0){if(!navigator.onLine){const r=Promise.reject(M.create("app-offline"));return{installationEntry:t,registrationPromise:r}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},a=Er(e,n);return{installationEntry:n,registrationPromise:a}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:wr(e)}:{installationEntry:t}}async function Er(e,t){try{const n=await lr(e,t);return K(e.appConfig,n)}catch(n){throw ot(n)&&n.customData.serverCode===409?await Ct(e.appConfig):await K(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}async function wr(e){let t=await Le(e.appConfig);for(;t.registrationStatus===1;)await ft(100),t=await Le(e.appConfig);if(t.registrationStatus===0){const{installationEntry:n,registrationPromise:a}=await ge(e);return a||n}return t}function Le(e){return H(e,t=>{if(!t)throw M.create("installation-not-found");return _t(t)})}function _t(e){return yr(e)?{fid:e.fid,registrationStatus:0}:e}function yr(e){return e.registrationStatus===1&&e.registrationTime+at<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Pr(e,t=!1){const n=e;return await kr(n),(await pe(n,t)).token}async function kr(e){const{registrationPromise:t}=await ge(e);t&&await t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bt="installations",Nr="installations-internal",Br=e=>{const t=e.getProvider("app").getImmediate(),n=vr(t),a=Qe(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:a,_delete:()=>Promise.resolve()}},$r=e=>{const t=e.getProvider("app").getImmediate(),n=Qe(t,bt).getImmediate();return{getId:()=>Fr(n),getToken:r=>Pr(n,r)}};function xr(){T(new S(bt,Br,"PUBLIC")),T(new S(Nr,$r,"PRIVATE"))}xr();I(rt,he);I(rt,he,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Me="analytics",Kr="firebase_id",jr="origin",Hr=60*1e3,Vr="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",me="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ha{constructor(t){this.app=t}_delete(){return delete v[this.app.options.appId],Promise.resolve()}}let v={},Fe=[];const Pe={};let Q="dataLayer",fa="gtag",ke,St,ve=!1;function ga(){const e=[];if(Ft()&&e.push("This is a browser extension environment."),Pt()||e.push("Cookies are not available."),e.length>0){const t=e.map((a,r)=>`(${r+1}) ${a}`).join(" "),n=C.create("invalid-analytics-context",{errorInfo:t});m.warn(n.message)}}function pa(e,t,n){ga();const a=e.options.appId;if(!a)throw C.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)m.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw C.create("no-api-key");if(v[a]!=null)throw C.create("already-exists",{id:a});if(!ve){zr(Q);const{wrappedGtag:s,gtagCore:i}=Qr(v,Fe,Pe,Q,fa);St=s,ke=i,ve=!0}return v[a]=da(e,Fe,Pe,t,ke,Q,n),new ha(e)}function ma(e,t,n,a){e=Ye(e),la(St,v[e.app.options.appId],t,n,a).catch(r=>m.error(r))}const Ne="@firebase/analytics",Be="0.10.0";function Ca(){T(new S(Me,(t,{options:n})=>{const a=t.getProvider("app").getImmediate(),r=t.getProvider("installations-internal").getImmediate();return pa(a,r,n)},"PUBLIC")),T(new S("analytics-internal",e,"PRIVATE")),I(Ne,Be),I(Ne,Be,"esm2017");function e(t){try{const n=t.getProvider(Me).getImmediate();return{logEvent:(a,r,s)=>ma(n,a,r,s)}}catch(n){throw C.create("interop-component-reg-failed",{reason:n})}}}Ca();const Z="@firebase/remote-config",$e="0.4.4";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ya{constructor(t,n,a,r,s,i){this.firebaseInstallations=t,this.sdkVersion=n,this.namespace=a,this.projectId=r,this.apiKey=s,this.appId=i}async fetch(t){const[n,a]=await Promise.all([this.firebaseInstallations.getId(),this.firebaseInstallations.getToken()]),s=`${window.FIREBASE_REMOTE_CONFIG_URL_BASE||"https://firebaseremoteconfig.googleapis.com"}/v1/projects/${this.projectId}/namespaces/${this.namespace}:fetch?key=${this.apiKey}`,i={"Content-Type":"application/json","Content-Encoding":"gzip","If-None-Match":t.eTag||"*"},c={sdk_version:this.sdkVersion,app_instance_id:n,app_instance_id_token:a,app_id:this.appId,language_code:wa()},o={method:"POST",headers:i,body:JSON.stringify(c)},l=fetch(s,o),d=new Promise((_,E)=>{t.signal.addEventListener(()=>{const Ce=new Error("The operation was aborted.");Ce.name="AbortError",E(Ce)})});let h;try{await Promise.race([l,d]),h=await l}catch(_){let E="fetch-client-network";throw(_==null?void 0:_.name)==="AbortError"&&(E="fetch-timeout"),p.create(E,{originalErrorMessage:_==null?void 0:_.message})}let f=h.status;const g=h.headers.get("ETag")||void 0;let b,k;if(h.status===200){let _;try{_=await h.json()}catch(E){throw p.create("fetch-client-parse",{originalErrorMessage:E==null?void 0:E.message})}b=_.entries,k=_.state}if(k==="INSTANCE_STATE_UNSPECIFIED"?f=500:k==="NO_CHANGE"?f=304:(k==="NO_TEMPLATE"||k==="EMPTY_CONFIG")&&(b={}),f!==304&&f!==200)throw p.create("fetch-status",{httpStatus:f});return{status:f,eTag:g,config:b}}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function va(){T(new S(_a,e,"PUBLIC").setMultipleInstances(!0)),I(Z,$e),I(Z,$e,"esm2017");function e(t,{instanceIdentifier:n}){const a=t.getProvider("app").getImmediate(),r=t.getProvider("installations-internal").getImmediate();if(typeof window>"u")throw p.create("registration-window");if(!oe())throw p.create("indexed-db-unavailable");const{projectId:s,apiKey:i,appId:c}=a.options;if(!s)throw p.create("registration-project-id");if(!i)throw p.create("registration-api-key");if(!c)throw p.create("registration-app-id");n=n||"firebase";const o=new Pa(c,a.name,n),l=new ka(o),d=new ce(Z);d.logLevel=u.ERROR;const h=new ya(r,kn,n,s,i,c),f=new Da(h,o),g=new Ea(f,o,l,d),b=new La(a,g,l,o,d);return ba(b),b}}va();const Tt=P.createContext({});function xe({children:e}){const[t,n]=P.useState();return L.jsx(Tt.Provider,{value:{logEvent:t,setLogEvent:n},children:e})}try{xe.displayName="AnalyticsContextProvider",xe.__docgenInfo={description:"",displayName:"AnalyticsContextProvider",props:{}}}catch{}const Na=P.createContext({remoteConfig:null,setRemoteConfig:null,remoteConfigData:null,setRemoteConfigData:null});function Ke({children:e}){const[t,n]=P.useState(null),[a,r]=P.useState(null);return L.jsx(Na.Provider,{value:{remoteConfig:t,setRemoteConfig:n,remoteConfigData:a,setRemoteConfigData:r},children:e})}try{Ke.displayName="RemoteContextProvider",Ke.__docgenInfo={description:"",displayName:"RemoteContextProvider",props:{}}}catch{}function Ba(){return P.useContext(Tt)}const je={"help-link":"_help-link_9okj2_2","help-link-text":"_help-link-text_9okj2_10"},$a=()=>{const{logEvent:e}=Ba();return L.jsxs("a",{onClick:()=>e==null?void 0:e(Ge.CLICKED_HELP_LINK,{from:location.pathname}),className:je["help-link"],href:"https://aide.passculture.app/hc/fr/articles/4411991940369--Acteurs-culturels-Comment-poster-une-offre-%C3%A0-destination-d-un-groupe-scolaire-",rel:"noreferrer",target:"_blank",children:[L.jsx(At,{src:Dt,alt:"",width:"42"}),L.jsx("span",{className:je["help-link-text"],children:"Aide"})]})},xa=$a,Wa={title:"components/HelpLink",component:xa,decorators:[e=>L.jsx("div",{style:{width:500,height:500},children:L.jsx(e,{})})]},$={};var He,Ve,Ue;$.parameters={...$.parameters,docs:{...(He=$.parameters)==null?void 0:He.docs,source:{originalSource:"{}",...(Ue=(Ve=$.parameters)==null?void 0:Ve.docs)==null?void 0:Ue.source}}};const qa=["Default"];export{$ as Default,qa as __namedExportsOrder,Wa as default};
