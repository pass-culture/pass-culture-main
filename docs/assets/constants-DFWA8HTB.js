import{r as ct}from"./index-B2-qRKKC.js";import"./config-BqmKEuqZ.js";import{u as lt}from"./chunk-PVWAREVJ-Bt0DAUl0.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $t{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(a=>{if(Kt(a)){const n=a.getImmediate();return`${n.library}/${n.version}`}else return null}).filter(a=>a).join(" ")}}function Kt(e){const t=e.getComponent();return(t==null?void 0:t.type)==="VERSION"}const X="@firebase/app",he="0.14.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const E=new Z("@firebase/app"),vt="@firebase/app-compat",Ht="@firebase/analytics-compat",Vt="@firebase/analytics",Ut="@firebase/app-check-compat",xt="@firebase/app-check",jt="@firebase/auth",Gt="@firebase/auth-compat",Wt="@firebase/database",qt="@firebase/data-connect",zt="@firebase/database-compat",Yt="@firebase/functions",Xt="@firebase/functions-compat",Jt="@firebase/installations",Qt="@firebase/installations-compat",Zt="@firebase/messaging",ea="@firebase/messaging-compat",ta="@firebase/performance",aa="@firebase/performance-compat",na="@firebase/remote-config",sa="@firebase/remote-config-compat",ra="@firebase/storage",ia="@firebase/storage-compat",oa="@firebase/firestore",ca="@firebase/ai",la="@firebase/firestore-compat",ua="firebase",ha="12.1.0",da={[X]:"fire-core",[vt]:"fire-core-compat",[Vt]:"fire-analytics",[Ht]:"fire-analytics-compat",[xt]:"fire-app-check",[Ut]:"fire-app-check-compat",[jt]:"fire-auth",[Gt]:"fire-auth-compat",[Wt]:"fire-rtdb",[qt]:"fire-data-connect",[zt]:"fire-rtdb-compat",[Yt]:"fire-fn",[Xt]:"fire-fn-compat",[Jt]:"fire-iid",[Qt]:"fire-iid-compat",[Zt]:"fire-fcm",[ea]:"fire-fcm-compat",[ta]:"fire-perf",[aa]:"fire-perf-compat",[na]:"fire-rc",[sa]:"fire-rc-compat",[ra]:"fire-gcs",[ia]:"fire-gcs-compat",[oa]:"fire-fst",[la]:"fire-fst-compat",[ca]:"fire-vertex","fire-js":"fire-js",[ua]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ye=new Map;function Xe(e,t){const a=$(e);Je(a,t),Ha(a,t)}function Je(e,t){const a=Ye.get(e);if(a)for(const n of a)n(t)}function Ha(e,t){const a=Va();a&&a.postMessage({key:e,fid:t}),Ua()}let L=null;function Va(){return!L&&"BroadcastChannel"in self&&(L=new BroadcastChannel("[Firebase] FID Change"),L.onmessage=e=>{Je(e.data.key,e.data.fid)}),L}function Ua(){Ye.size===0&&L&&(L.close(),L=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xa({appConfig:e,heartbeatServiceProvider:t},a){const n=Ja(e,a),s=Pa(e,a),r=t.getImmediate({optional:!0});if(r){const l=await r.getHeartbeatsHeader();l&&s.append("x-firebase-client",l)}const i={installation:{sdkVersion:He,appId:e.appId}},c={method:"POST",headers:s,body:JSON.stringify(i)},o=await qe(()=>fetch(n,c));if(o.ok){const l=await o.json();return je(l)}else throw await Ge("Generate Auth Token",o)}function Ja(e,{fid:t}){return`${xe(e)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vn{constructor(t){this.app=t}_delete(){return delete P[this.app.options.appId],Promise.resolve()}}let P={},Ie=[];const be={};let G="dataLayer",Hn="gtag",Se,rt,we=!1;function Vn(){const e=[];if(gt()&&e.push("This is a browser extension environment."),pt()||e.push("Cookies are not available."),e.length>0){const t=e.map((n,s)=>`(${s+1}) ${n}`).join(" "),a=m.create("invalid-analytics-context",{errorInfo:t});g.warn(a.message)}}function Un(e,t,a){Vn();const n=e.options.appId;if(!n)throw m.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)g.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw m.create("no-api-key");if(P[n]!=null)throw m.create("already-exists",{id:n});if(!we){bn(G);const{wrappedGtag:r,gtagCore:i}=yn(P,Ie,be,G,Hn);rt=r,Se=i,we=!0}return P[n]=Kn(e,Ie,be,t,Se,G,a),new vn(e)}function xn(e,t,a,n){e=Fe(e),Bn(rt,P[e.app.options.appId],t,a,n).catch(s=>g.error(s))}const Te="@firebase/analytics",ye="0.10.18";function jn(){A(new y(Ee,(t,{options:a})=>{const n=t.getProvider("app").getImmediate(),s=t.getProvider("installations-internal").getImmediate();return Un(n,s,a)},"PUBLIC")),A(new y("analytics-internal",e,"PRIVATE")),_(Te,ye),_(Te,ye,"esm2020");function e(t){try{const a=t.getProvider(Ee).getImmediate();return{logEvent:(n,s,r)=>xn(a,n,s,r)}}catch(a){throw m.create("interop-component-reg-failed",{reason:a})}}}jn();const W="@firebase/remote-config",Ae="0.6.6";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
