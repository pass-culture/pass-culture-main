import{j as m}from"./jsx-runtime-BYYWji4R.js";import{R as G,r}from"./index-ClcD9ViR.js";import{C as W}from"./Checkbox-B5qVwrwP.js";import{T as O}from"./TextInput-CZOlu6xY.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-DeARc5FM.js";import"./Tag-CQO0EYV8.js";import"./full-thumb-up-Bb4kpRpM.js";import"./SvgIcon-CyWUmZpn.js";import"./BaseInput-BI1b_EYZ.js";import"./FieldError-ky1_Lcaw.js";import"./stroke-error-DSZD431a.js";import"./FieldLayoutCharacterCount-Cf20ddBy.js";import"./index.module-D0awDY1b.js";const $={"input-layout-small-label":"_input-layout-small-label_kaqxt_1"},u=G.forwardRef(({className:p,name:d,label:R,max:N,rightIcon:P,disabled:f,smallLabel:S,showFreeCheckbox:b,hideAsterisk:h=!1,updatePriceValue:g},L)=>{var x,y;const a=r.useRef(null),j=`${d}.free`,n=r.useRef(null),[l,c]=r.useState(!1);r.useEffect(()=>{var k;const t=document.activeElement===n.current;!l&&t&&((k=a.current)==null||k.focus())},[l]),r.useEffect(()=>{var e;n.current&&((e=a.current)==null?void 0:e.value)==="0"&&c(!0)},[(x=a.current)==null?void 0:x.value,(y=n.current)==null?void 0:y.value]);const A=e=>{g(e.target.value),b&&c(e.target.value==="0")},T=()=>{const e=!l;c(e);let t="";e&&(t="0"),a.current&&(g(t),a.current.value=t)},D=m.jsx(W,{ref:n,label:"Gratuit",checked:l,name:j,onChange:T,disabled:f});return m.jsx("div",{ref:L,children:m.jsx(O,{ref:a,className:p,labelClassName:S?$["input-layout-small-label"]:"",required:!h,name:d,label:R,type:"number",step:"0.01",min:0,max:N,rightIcon:P,disabled:f,asterisk:!h,onChange:A,...b?{InputExtension:D}:{}})})});u.displayName="PriceInput";try{u.displayName="PriceInput",u.__docgenInfo={description:`The PriceInput component is a combination of a TextInput and a Checkbox to define prices.
It integrates with Formik for form state management and is used when an null price is meant to be interpreted as free.

---`,displayName:"PriceInput",props:{name:{defaultValue:null,description:"",name:"name",required:!1,type:{name:"string"}},className:{defaultValue:null,description:`A custom class for the field layout,
...
}`,...(w=(F=i.parameters)==null?void 0:F.docs)==null?void 0:w.source}}};const ne=["Default","SmallLabel","WithCheckbox"];export{s as Default,o as SmallLabel,i as WithCheckbox,ne as __namedExportsOrder,re as default};
