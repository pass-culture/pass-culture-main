import{j as P}from"./jsx-runtime-CfatFE5O.js";import{V as Yt}from"./index-DfbDQrFU.js";import{r as Jt}from"./index-ClcD9ViR.js";import"./config-BdqymTTq.js";import{u as Xt}from"./index-xCbVRQir.js";import{f as Qt}from"./full-help-Co3hxUDJ.js";import{S as Zt}from"./SvgIcon-g5H-kf5W.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-B5DG7xGS.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rn{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Ln(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function Ln(e){const t=e.getComponent();return(t==null?void 0:t.type)==="VERSION"}const ce="@firebase/app",Le="0.10.15";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hr=1024,fr=30*24*60*60*1e3;class gr{constructor(t){this.container=t,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new mr(n),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var t,n;try{const a=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=Ne();return((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((n=this._heartbeatsCache)===null||n===void 0?void 0:n.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(i=>i.date===s)?void 0:(this._heartbeatsCache.heartbeats.push({date:s,agent:a}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(i=>{const o=new Date(i.date).valueOf();return Date.now()-o<=fr}),this._storage.overwrite(this._heartbeatsCache))}catch(r){w.warn(r)}}async getHeartbeatsHeader(){var t;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const n=Ne(),{heartbeatsToSend:r,unsentEntries:a}=pr(this._heartbeatsCache.heartbeats),s=Ze(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=n,a.length>0?(this._heartbeatsCache.heartbeats=a,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(n){return w.warn(n),""}}}function Ne(){return new Date().toISOString().substring(0,10)}function pr(e,t=hr){const n=[];let r=e.slice();for(const a of e){const s=n.find(i=>i.agent===a.agent);if(s){if(s.dates.push(a.date),Pe(n)>t){s.dates.pop();break}}else if(n.push({agent:a.agent,dates:[a.date]}),Pe(n)>t){n.pop();break}r=r.slice(1)}return{heartbeatsToSend:n,unsentEntries:r}}class mr{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return et()?tt().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const n=await dr(this.app);return n!=null&&n.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(t){var n;if(await this._canUseIndexedDBPromise){const a=await this.read();return Fe(this.app,{lastSentHeartbeatDate:(n=t.lastSentHeartbeatDate)!==null&&n!==void 0?n:a.lastSentHeartbeatDate,heartbeats:t.heartbeats})}else return}async add(t){var n;if(await this._canUseIndexedDBPromise){const a=await this.read();return Fe(this.app,{lastSentHeartbeatDate:(n=t.lastSentHeartbeatDate)!==null&&n!==void 0?n:a.lastSentHeartbeatDate,heartbeats:[...a.heartbeats,...t.heartbeats]})}else return}}function Pe(e){return Ze(JSON.stringify({version:2,heartbeats:e})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const It=new Map;function Et(e,t){const n=q(e);bt(n,t),kr(n,t)}function bt(e,t){const n=It.get(e);if(n)for(const r of n)r(t)}function kr(e,t){const n=$r();n&&n.postMessage({key:e,fid:t}),Fr()}let D=null;function $r(){return!D&&"BroadcastChannel"in self&&(D=new BroadcastChannel("[Firebase] FID Change"),D.onmessage=e=>{bt(e.data.key,e.data.fid)}),D}function Fr(){It.size===0&&D&&(D.close(),D=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kt=1e4,$t=`w:${be}`,Ft="FIS_v2",Ja="https://firebaseinstallations.googleapis.com/v1",Xa=60*60*1e3,Qa="installations",Za="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function as({appConfig:e,heartbeatServiceProvider:t},{fid:n}){const r=Pt(e),a=Bt(e),s=t.getImmediate({optional:!0});if(s){const l=await s.getHeartbeatsHeader();l&&a.append("x-firebase-client",l)}const i={fid:n,authVersion:Ft,appId:e.appId,sdkVersion:$t},o={method:"POST",headers:a,body:JSON.stringify(i)},c=await Ht(()=>fetch(r,o));if(c.ok){const l=await c.json();return{fid:l.fid||n,registrationStatus:2,refreshToken:l.refreshToken,authToken:Mt(l.authToken)}}else throw await vt("Create Installation",c)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hs="firebase-installations-database",fs=1,F="firebase-installations-store";let re=null;function we(){return re||(re=fe(hs,fs,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(F)}}})),re}async function j(e,t){const n=z(e),a=(await we()).transaction(F,"readwrite"),s=a.objectStore(F),i=await s.get(n);return await s.put(t,n),await a.done,(!i||i.fid!==t.fid)&&xt(e,t.fid),t}async function Ut(e){const t=z(e),r=(await we()).transaction(F,"readwrite");await r.objectStore(F).delete(t),await r.done}async function Y(e,t){const n=z(e),a=(await we()).transaction(F,"readwrite"),s=a.objectStore(F),i=await s.get(n),o=t(i);return o===void 0?await s.delete(n):await s.put(o,n),await a.done,o&&(!i||i.fid!==o.fid)&&xt(e,o.fid),o}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wt="installations",ks="installations-internal",$s=e=>{const t=e.getProvider("app").getImmediate(),n=Ls(t),r=G(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},Fs=e=>{const t=e.getProvider("app").getImmediate(),n=G(t,Wt).getImmediate();return{getId:()=>Ds(n),getToken:a=>Os(n,a)}};function Ns(){b(new ue(Wt,$s,"PUBLIC")),b(new ue(ks,Fs,"PRIVATE"))}Ns();E(Lt,be);E(Lt,be,"esm2017");const se="@firebase/remote-config",We="0.4.11";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Us=60*1e3,Gs=12*60*60*1e3;class qs{get fetchTimeMillis(){return this._storageCache.getLastSuccessfulFetchTimestampMillis()||-1}get lastFetchStatus(){return this._storageCache.getLastFetchStatus()||"no-fetch-yet"}constructor(t,n,r,a,s){this.app=t,this._client=n,this._storageCache=r,this._storage=a,this._logger=s,this._isInitializationComplete=!1,this.settings={fetchTimeoutMillis:Us,minimumFetchIntervalMillis:Gs},this.defaultConfig={}}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
