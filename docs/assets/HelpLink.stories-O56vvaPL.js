 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pt="FirebaseError";class D extends Error{constructor(t,n,a){super(n),this.code=t,this.customData=a,this.name=Pt,Object.setPrototypeOf(this,D.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,B.prototype.create)}}class B{constructor(t,n,a){this.service=t,this.serviceName=n,this.errors=a}create(t,...n){const a=n[0]||{},r=`${this.service}/${t}`,s=this.errors[t],i=s?kt(s,a):"Error",c=`${this.serviceName}: ${i} (${r}).`;return new D(r,c,a)}}function kt(e,t){return e.replace(Nt,(n,a)=>{const r=t[a];return r!=null?String(r):`<${a}?>`})}const Nt=/\{\$([^}]+)}/g;/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vn={"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."},ue=new B("app","Firebase",vn);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pn=Ln;function I(e,t,n){var a;let r=(a=Rn[e])!==null&&a!==void 0?a:e;n&&(r+=`-${n}`);const s=r.match(/\s|\//),i=t.match(/\s|\//);if(s||i){const c=[`Unable to register library "${r}" with version "${t}":`];s&&c.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&i&&c.push("and"),i&&c.push(`version name "${t}" contains illegal characters (whitespace or "/")`),R.warn(c.join(" "));return}T(new S(`${r}-version`,()=>({library:r,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vr(e,t=!1){const n=e;return await Pr(n),(await pe(n,t)).token}async function Pr(e){const{registrationPromise:t}=await ge(e);t&&await t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bt="installations",Nr="installations-internal",Br=e=>{const t=e.getProvider("app").getImmediate(),n=kr(t),a=Qe(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:a,_delete:()=>Promise.resolve()}},$r=e=>{const t=e.getProvider("app").getImmediate(),n=Qe(t,bt).getImmediate();return{getId:()=>Fr(n),getToken:r=>vr(n,r)}};function xr(){T(new S(bt,Br,"PUBLIC")),T(new S(Nr,$r,"PRIVATE"))}xr();I(rt,he);I(rt,he,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ha{constructor(t){this.app=t}_delete(){return delete k[this.app.options.appId],Promise.resolve()}}let k={},Fe=[];const ve={};let Q="dataLayer",fa="gtag",Pe,St,ke=!1;function ga(){const e=[];if(Ft()&&e.push("This is a browser extension environment."),vt()||e.push("Cookies are not available."),e.length>0){const t=e.map((a,r)=>`(${r+1}) ${a}`).join(" "),n=C.create("invalid-analytics-context",{errorInfo:t});m.warn(n.message)}}function pa(e,t,n){ga();const a=e.options.appId;if(!a)throw C.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)m.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw C.create("no-api-key");if(k[a]!=null)throw C.create("already-exists",{id:a});if(!ke){zr(Q);const{wrappedGtag:s,gtagCore:i}=Qr(k,Fe,ve,Q,fa);St=s,Pe=i,ke=!0}return k[a]=da(e,Fe,ve,t,Pe,Q,n),new ha(e)}function ma(e,t,n,a){e=Ye(e),la(St,k[e.app.options.appId],t,n,a).catch(r=>m.error(r))}const Ne="@firebase/analytics",Be="0.10.0";function Ca(){T(new S(Me,(t,{options:n})=>{const a=t.getProvider("app").getImmediate(),r=t.getProvider("installations-internal").getImmediate();return pa(a,r,n)},"PUBLIC")),T(new S("analytics-internal",e,"PRIVATE")),I(Ne,Be),I(Ne,Be,"esm2017");function e(t){try{const n=t.getProvider(Me).getImmediate();return{logEvent:(a,r,s)=>ma(n,a,r,s)}}catch(n){throw C.create("interop-component-reg-failed",{reason:n})}}}Ca();const Z="@firebase/remote-config",$e="0.4.4";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ka(){T(new S(_a,e,"PUBLIC").setMultipleInstances(!0)),I(Z,$e),I(Z,$e,"esm2017");function e(t,{instanceIdentifier:n}){const a=t.getProvider("app").getImmediate(),r=t.getProvider("installations-internal").getImmediate();if(typeof window>"u")throw p.create("registration-window");if(!oe())throw p.create("indexed-db-unavailable");const{projectId:s,apiKey:i,appId:c}=a.options;if(!s)throw p.create("registration-project-id");if(!i)throw p.create("registration-api-key");if(!c)throw p.create("registration-app-id");n=n||"firebase";const o=new va(c,a.name,n),l=new Pa(o),d=new ce(Z);d.logLevel=u.ERROR;const h=new ya(r,Pn,n,s,i,c),f=new Da(h,o),g=new Ea(f,o,l,d),b=new La(a,g,l,o,d);return ba(b),b}}ka();const Tt=v.createContext({});function xe({children:e}){const[t,n]=v.useState();return L.jsx(Tt.Provider,{value:{logEvent:t,setLogEvent:n},children:e})}try{xe.displayName="AnalyticsContextProvider",xe.__docgenInfo={description:"",displayName:"AnalyticsContextProvider",props:{}}}catch{}const Na=v.createContext({remoteConfig:null,setRemoteConfig:null,remoteConfigData:null,setRemoteConfigData:null});function Ke({children:e}){const[t,n]=v.useState(null),[a,r]=v.useState(null);return L.jsx(Na.Provider,{value:{remoteConfig:t,setRemoteConfig:n,remoteConfigData:a,setRemoteConfigData:r},children:e})}try{Ke.displayName="RemoteContextProvider",Ke.__docgenInfo={description:"",displayName:"RemoteContextProvider",props:{}}}catch{}function Ba(){return v.useContext(Tt)}const je={"help-link":"_help-link_9okj2_2","help-link-text":"_help-link-text_9okj2_10"},$a=()=>{const{logEvent:e}=Ba();return L.jsxs("a",{onClick:()=>e==null?void 0:e(Ge.CLICKED_HELP_LINK,{from:location.pathname}),className:je["help-link"],href:"https://aide.passculture.app/hc/fr/articles/4411991940369--Acteurs-culturels-Comment-poster-une-offre-%C3%A0-destination-d-un-groupe-scolaire-",rel:"noreferrer",target:"_blank",children:[L.jsx(At,{src:Dt,alt:"",width:"42"}),L.jsx("span",{className:je["help-link-text"],children:"Aide"})]})},xa=$a,Wa={title:"components/HelpLink",component:xa,decorators:[e=>L.jsx("div",{style:{width:500,height:500},children:L.jsx(e,{})})]},$={};var He,Ve,Ue;$.parameters={...$.parameters,docs:{...(He=$.parameters)==null?void 0:He.docs,source:{originalSource:"{}",...(Ue=(Ve=$.parameters)==null?void 0:Ve.docs)==null?void 0:Ue.source}}};const qa=["Default"];export{$ as Default,qa as __namedExportsOrder,Wa as default};
