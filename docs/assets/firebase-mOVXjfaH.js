import{r as K}from"./index-ClcD9ViR.js";import"./config-BdqymTTq.js";import{b as lt}from"./index-C3LhMar3.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nt{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(kt(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function kt(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const X="@firebase/app",de="0.11.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const I=new ee("@firebase/app"),xt="@firebase/app-compat",jt="@firebase/analytics-compat",Ht="@firebase/analytics",Vt="@firebase/app-check-compat",Ut="@firebase/app-check",Wt="@firebase/auth",qt="@firebase/auth-compat",Gt="@firebase/database",Kt="@firebase/data-connect",zt="@firebase/database-compat",Yt="@firebase/functions",Jt="@firebase/functions-compat",Xt="@firebase/installations",Qt="@firebase/installations-compat",Zt="@firebase/messaging",en="@firebase/messaging-compat",tn="@firebase/performance",nn="@firebase/performance-compat",sn="@firebase/remote-config",rn="@firebase/remote-config-compat",an="@firebase/storage",on="@firebase/storage-compat",cn="@firebase/firestore",ln="@firebase/vertexai",un="@firebase/firestore-compat",hn="firebase",dn="11.5.0",fn={[X]:"fire-core",[xt]:"fire-core-compat",[Ht]:"fire-analytics",[jt]:"fire-analytics-compat",[Ut]:"fire-app-check",[Vt]:"fire-app-check-compat",[Wt]:"fire-auth",[qt]:"fire-auth-compat",[Gt]:"fire-rtdb",[Kt]:"fire-data-connect",[zt]:"fire-rtdb-compat",[Yt]:"fire-fn",[Jt]:"fire-fn-compat",[Xt]:"fire-iid",[Qt]:"fire-iid-compat",[Zt]:"fire-fcm",[en]:"fire-fcm-compat",[tn]:"fire-perf",[nn]:"fire-perf-compat",[sn]:"fire-rc",[rn]:"fire-rc-compat",[an]:"fire-gcs",[on]:"fire-gcs-compat",[cn]:"fire-fst",[un]:"fire-fst-compat",[ln]:"fire-vertex","fire-js":"fire-js",[hn]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
