import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{f as n}from"./iframe-CK48msh6.js";import{t as r}from"./jsx-runtime-DeHZSEgm.js";import{t as i}from"./classnames-D09xBJOL.js";import{n as a,t as o}from"./lib-DPyIggfz.js";import{n as s,t as c}from"./dist-usUpQArZ.js";import{n as l,t as u}from"./noop-C6_kCKXi.js";var d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D;function O(){return(O=t((()=>{d=`_stepper_i0asc_1`,f=`_button_i0asc_9`,p=`_link_i0asc_10`,m=`_wrapper_i0asc_11`,h=`_indicator_i0asc_61`,g=`_number_i0asc_74`,_=`_label_i0asc_84`,v=`_sublabel_i0asc_90`,y=`_connector_i0asc_97`,b=`_horizontal_i0asc_102`,x=`_vertical_i0asc_123`,S=`_disabled_i0asc_144`,C=`_current_i0asc_156`,w=`_done_i0asc_174`,T=`_active_i0asc_179`,E=`_clickable_i0asc_182`,D={stepper:d,button:f,link:p,wrapper:m,"visually-hidden":`_visually-hidden_i0asc_41`,"step-item":`_step-item_i0asc_52`,"step-content":`_step-content_i0asc_56`,indicator:h,number:g,"text-container":`_text-container_i0asc_78`,label:_,sublabel:v,connector:y,horizontal:b,vertical:x,disabled:S,current:C,done:w,active:T,clickable:E}})))()}function k({linkUrl:e,hasButton:t,onClick:n,voiceOverText:r,isActive:i,children:a,ref:s}){return e?(0,M.jsx)(o,{to:e,onClick:n,className:D.link,"aria-label":r,children:a}):t?(0,M.jsx)(`button`,{type:`button`,onClick:n,className:D.button,"aria-label":r,children:a}):(0,M.jsxs)(`div`,{ref:s,className:D.wrapper,tabIndex:-1,children:[(0,M.jsx)(`div`,{role:`log`,className:D[`visually-hidden`],children:i?r:(0,M.jsx)(`span`,{children:`\xA0`})}),(0,M.jsx)(`span`,{className:D[`visually-hidden`],children:r}),a]})}var A,j,M,N;function P(){return(P=t((()=>{A=e(i(),1),j=n(),a(),u(),O(),M=r(),N=({steps:e,activeStep:t,orientation:n=`auto`,ref:r})=>{let i=(0,j.useRef)(null),a=r||i,[o,s]=(0,j.useState)(n===`vertical`),c=(0,j.useRef)(null),u=e.findIndex(e=>e.id===t);return(0,j.useEffect)(()=>{c.current?.focus()},[t]),(0,j.useLayoutEffect)(()=>{if(n!==`auto`)return s(n===`vertical`),l;let t=a.current;if(!t)return l;let r=t=>{let n=e.length*80;s(t<n)},i=t.getBoundingClientRect();if(i.width>0&&r(i.width),typeof window<`u`&&`ResizeObserver`in window){let e=new window.ResizeObserver(e=>{for(let t of e){let e=t.contentRect.width;e>0&&r(e)}});return e.observe(t),()=>{e.disconnect()}}return l},[e.length,n,a]),(0,M.jsx)(`ol`,{ref:a,className:(0,A.default)(D.stepper,o?D.vertical:D.horizontal),children:e.map((t,n)=>{let r=`disabled`;n<u?r=`done`:n===u&&(r=`current`);let i=r===`done`,a=i?t.url:void 0,o=i&&!t.url&&!!t.onClick,s=!!a||o,l={done:`terminée`,current:`active`,disabled:`à venir`}[r],d=`Étape ${n+1} sur ${e.length}, ${l}, ${t.label}`,f=(0,M.jsxs)(`div`,{className:D[`step-content`],"aria-hidden":`true`,children:[(0,M.jsxs)(`div`,{className:D.indicator,children:[(0,M.jsx)(`span`,{className:D.number,children:(n+1).toString()}),(0,M.jsx)(`div`,{className:(0,A.default)(D.connector,{[D.active]:r===`done`})})]}),(0,M.jsxs)(`div`,{className:D[`text-container`],children:[(0,M.jsx)(`span`,{className:D.label,children:t.label}),t.sublabel&&(0,M.jsx)(`span`,{className:D.sublabel,children:t.sublabel})]})]});return(0,M.jsx)(`li`,{"aria-current":r===`current`?`step`:void 0,className:(0,A.default)(D[`step-item`],D[r],{[D.clickable]:s}),children:(0,M.jsx)(k,{ref:r===`current`?c:void 0,linkUrl:a,hasButton:o,onClick:t.onClick,voiceOverText:d,isActive:r===`current`,children:f})},t.id)})})},N.displayName=`Stepper`;try{N.displayName=`Stepper`,N.__docgenInfo={description:``,displayName:`Stepper`,filePath:`/home/runner/work/pass-culture-main/pass-culture-main/pro/src/design-system/Stepper/Stepper.tsx`,methods:[],props:{steps:{defaultValue:null,declarations:[{fileName:`pro/src/design-system/Stepper/Stepper.tsx`,name:`StepperProps`}],description:``,name:`steps`,parent:{fileName:`pro/src/design-system/Stepper/Stepper.tsx`,name:`StepperProps`},required:!0,tags:{},type:{name:`StepItem[]`}},activeStep:{defaultValue:null,declarations:[{fileName:`pro/src/design-system/Stepper/Stepper.tsx`,name:`StepperProps`}],description:``,name:`activeStep`,parent:{fileName:`pro/src/design-system/Stepper/Stepper.tsx`,name:`StepperProps`},required:!0,tags:{},type:{name:`string`}},orientation:{defaultValue:{value:`auto`},declarations:[{fileName:`pro/src/design-system/Stepper/Stepper.tsx`,name:`StepperProps`}],description:`Layout direction of the stepper.
