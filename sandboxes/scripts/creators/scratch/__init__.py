...
from sandboxes.scripts.creators.scratch.create_scratch_deposits import *
...
def save_scratch_sandbox():
    ...
    create_scratch_deposits(scratch_users_by_name)
    ...
    scratch_event_occurrences_by_name = create_scratch_event_occurrences(
        scratch_event_offers_by_name
    )

    scratch_event_stocks = create_scratch_event_stocks(
        scratch_event_occurrences_by_name
    )

    scratch_thing_stocks = create_scratch_thing_stocks(
        scratch_thing_offers_by_name
    )
    ...
    scratch_mediations_by_name = create_scratch_mediations(
