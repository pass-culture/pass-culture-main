import {Box, Button, Card, CardActions, CardContent, Grid, List, Typography} from "@mui/material";
import {Form, ReferenceField, SearchInput, ShowButton, useAuthenticated} from "react-admin";
    ...
    return (
        <Card sx={{minWidth: 275}}>
            ...
            <CardActions>
                ...
                <Button href={`/public_accounts/user/${record.id}`} variant={"text"} color={"secondary"}>Consulter ce
                    profil</Button>
            </CardActions>
        </Card>
    )
    ...
    const formSubmit = async (params: FieldValues) => {
        if (params && params.search) {
            ...
            try {
                ...
                const response = await dataProvider.searchList('public_accounts/search', String(params.search), {
