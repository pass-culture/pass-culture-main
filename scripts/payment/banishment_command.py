...
@app.manager.option(
    ...
    dest='transaction_id',
    required=True,
    help='Identifiant de la transaction (virement SEPA) ciblée'
)
@app.manager.option(
    '-p',
    '--payments',
...
def ban_payments(message_id: str, transaction_id: str, raw_payment_ids_to_ban: str):
    try:
        ...
        do_ban_payments(message_id, transaction_id, payment_ids_to_ban)
