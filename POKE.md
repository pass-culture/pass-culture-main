...
TIMESCALEDB_DATABASE_URL=postgresql://pass_culture:passq@localhost:5435/pass_culture alembic upgrade pre@head
TIMESCALEDB_DATABASE_URL=postgresql://pass_culture:passq@localhost:5435/pass_culture alembic upgrade post@head
